...
.method public static a(Landroid/content/Context;Landroidx/work/impl/k;Ljava/lang/String;)V
    ...
    invoke-virtual {p1}, Landroidx/work/impl/k;->g()Landroidx/work/impl/WorkDatabase;

    move-result-object p1

    invoke-virtual {p1}, Landroidx/work/impl/WorkDatabase;->n()Landroidx/work/impl/c/f;

    move-result-object p1

    invoke-interface {p1, p2}, Landroidx/work/impl/c/f;->a(Ljava/lang/String;)Landroidx/work/impl/c/e;

    move-result-object v0

    if-eqz v0, :cond_0

    iget v0, v0, Landroidx/work/impl/c/e;->b:I
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroidx/work/g;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

    invoke-interface {p1, p2}, Landroidx/work/impl/c/f;->b(Ljava/lang/String;)V
...
.method public static a(Landroid/content/Context;Landroidx/work/impl/k;Ljava/lang/String;J)V
    ...
    iget p1, v0, Landroidx/work/impl/c/e;->b:I
    ...
    invoke-direct {v0, p0}, Landroidx/work/impl/utils/a;-><init>(Landroid/content/Context;)V

    invoke-virtual {v0}, Landroidx/work/impl/utils/a;->a()I

    move-result v0

    new-instance v1, Landroidx/work/impl/c/e;

    invoke-direct {v1, p2, v0}, Landroidx/work/impl/c/e;-><init>(Ljava/lang/String;I)V

    invoke-interface {p1, v1}, Landroidx/work/impl/c/f;->a(Landroidx/work/impl/c/e;)V
