...
.method private b(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/f;)V
    .locals 4
    ...
    invoke-direct {p1, v0, p2, p3}, Landroidx/work/impl/background/systemalarm/c;-><init>(Landroid/content/Context;ILandroidx/work/impl/background/systemalarm/f;)V
...
.method private c(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/f;)V
    .locals 7
    ...
    invoke-direct {v1, v2, p2, p1, p3}, Landroidx/work/impl/background/systemalarm/d;-><init>(Landroid/content/Context;ILjava/lang/String;Landroidx/work/impl/background/systemalarm/f;)V
    ...
    invoke-virtual {p2, p3, p1, v1}, Landroidx/work/g;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
...
.method private d(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/f;)V
    .locals 5
...
.method private e(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/f;)V
    .locals 4
    ...
    invoke-virtual {v0, v1, p1, p2}, Landroidx/work/g;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

    invoke-virtual {p3}, Landroidx/work/impl/background/systemalarm/f;->c()Landroidx/work/impl/k;

    move-result-object p1

    invoke-virtual {p1}, Landroidx/work/impl/k;->j()V

    return-void
.end method

.method private f(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/f;)V
    .locals 10
    ...
    invoke-virtual {v0, v1, v3, v5}, Landroidx/work/g;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    invoke-interface {v1, p1}, Landroidx/work/impl/c/l;->b(Ljava/lang/String;)Landroidx/work/impl/c/k;
    ...
    invoke-virtual {p2, p3, p1, v1}, Landroidx/work/g;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    :try_end_1
    ...
    :cond_0
    :try_start_2
    iget-object v5, v1, Landroidx/work/impl/c/k;->d:Landroidx/work/j;

    invoke-virtual {v5}, Landroidx/work/j;->a()Z
    ...
    :cond_1
    :try_start_3
    invoke-virtual {v1}, Landroidx/work/impl/c/k;->a()J

    move-result-wide v5

    invoke-virtual {v1}, Landroidx/work/impl/c/k;->b()Z
    ...
    invoke-virtual {p2, v1, v2, v3}, Landroidx/work/g;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    sget-object v7, Landroidx/work/impl/background/systemalarm/b;->a:Ljava/lang/String;
    ...
    invoke-virtual {v1, v7, v2, v3}, Landroidx/work/g;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    new-instance v1, Landroidx/work/impl/background/systemalarm/f$a;

    invoke-direct {v1, p3, p1, p2}, Landroidx/work/impl/background/systemalarm/f$a;-><init>(Landroidx/work/impl/background/systemalarm/f;Landroid/content/Intent;I)V

    invoke-virtual {p3, v1}, Landroidx/work/impl/background/systemalarm/f;->a(Ljava/lang/Runnable;)V
...
.method private g(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/f;)V
    .locals 4
    ...
    invoke-virtual {p2, v0, v1, v3}, Landroidx/work/g;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

    invoke-virtual {p3}, Landroidx/work/impl/background/systemalarm/f;->c()Landroidx/work/impl/k;

    move-result-object p2

    invoke-virtual {p2, p1}, Landroidx/work/impl/k;->b(Ljava/lang/String;)V
    ...
    invoke-virtual {p3, p1, v2}, Landroidx/work/impl/background/systemalarm/f;->a(Ljava/lang/String;Z)V
...
# virtual methods
.method a(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/f;)V
    .locals 5
    ...
    invoke-direct {p0, p1, p2, p3}, Landroidx/work/impl/background/systemalarm/b;->b(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/f;)V
    ...
    invoke-direct {p0, p1, p2, p3}, Landroidx/work/impl/background/systemalarm/b;->e(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/f;)V
    ...
    invoke-virtual {p1, p2, p3, v0}, Landroidx/work/g;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    invoke-direct {p0, p1, p2, p3}, Landroidx/work/impl/background/systemalarm/b;->f(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/f;)V
    ...
    invoke-direct {p0, p1, p2, p3}, Landroidx/work/impl/background/systemalarm/b;->c(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/f;)V
    ...
    invoke-direct {p0, p1, p2, p3}, Landroidx/work/impl/background/systemalarm/b;->g(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/f;)V
    ...
    invoke-direct {p0, p1, p2, p3}, Landroidx/work/impl/background/systemalarm/b;->d(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/f;)V
    ...
    invoke-virtual {p2, p3, p1, v0}, Landroidx/work/g;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
