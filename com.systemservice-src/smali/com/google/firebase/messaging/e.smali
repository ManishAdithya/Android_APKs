...
.method final a()Z
    ...
    invoke-static {v0}, Lcom/google/firebase/messaging/h;->d(Ljava/lang/String;)Lcom/google/firebase/messaging/h;
    ...
    iget-object v4, v3, Lcom/google/firebase/messaging/f;->a:Landroid/support/v4/app/Y$d;
    ...
    :try_start_0
    invoke-virtual {v0}, Lcom/google/firebase/messaging/h;->h()Lb/b/a/a/f/h;
    ...
    invoke-static {v6, v7, v8, v9}, Lb/b/a/a/f/k;->a(Lb/b/a/a/f/h;JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Landroid/graphics/Bitmap;

    invoke-virtual {v4, v6}, Landroid/support/v4/app/Y$d;->a(Landroid/graphics/Bitmap;)Landroid/support/v4/app/Y$d;

    new-instance v7, Landroid/support/v4/app/Y$b;

    invoke-direct {v7}, Landroid/support/v4/app/Y$b;-><init>()V

    invoke-virtual {v7, v6}, Landroid/support/v4/app/Y$b;->b(Landroid/graphics/Bitmap;)Landroid/support/v4/app/Y$b;

    const/4 v6, 0x0

    invoke-virtual {v7, v6}, Landroid/support/v4/app/Y$b;->a(Landroid/graphics/Bitmap;)Landroid/support/v4/app/Y$b;

    invoke-virtual {v4, v7}, Landroid/support/v4/app/Y$d;->a(Landroid/support/v4/app/Y$e;)Landroid/support/v4/app/Y$d;
    :try_end_0
    ...
    iget-object v3, v3, Lcom/google/firebase/messaging/f;->a:Landroid/support/v4/app/Y$d;
