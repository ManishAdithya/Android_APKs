...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/google/android/gms/common/b;->e:I
...
.method static a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-virtual {p1, p0, p2}, Lcom/google/android/gms/common/SupportErrorDialogFragment;->a(Landroid/support/v4/app/p;Ljava/lang/String;)V
...
.method private final a(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-virtual {v3, v4}, Landroid/support/v4/app/Y$d;->b(Z)Landroid/support/v4/app/Y$d;

    invoke-virtual {v3, v4}, Landroid/support/v4/app/Y$d;->a(Z)Landroid/support/v4/app/Y$d;

    invoke-virtual {v3, p3}, Landroid/support/v4/app/Y$d;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/Y$d;

    new-instance p3, Landroid/support/v4/app/Y$c;

    invoke-direct {p3}, Landroid/support/v4/app/Y$c;-><init>()V

    invoke-virtual {p3, v0}, Landroid/support/v4/app/Y$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/Y$c;

    invoke-virtual {v3, p3}, Landroid/support/v4/app/Y$d;->a(Landroid/support/v4/app/Y$e;)Landroid/support/v4/app/Y$d;
    ...
    invoke-virtual {v3, p3}, Landroid/support/v4/app/Y$d;->d(I)Landroid/support/v4/app/Y$d;

    invoke-virtual {v3, v5}, Landroid/support/v4/app/Y$d;->c(I)Landroid/support/v4/app/Y$d;
    ...
    sget p3, Lb/b/a/a/b/b;->common_full_open_on_phone:I

    sget v0, Lb/b/a/a/b/c;->common_open_on_phone:I

    invoke-virtual {v1, v0}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v3, p3, v0, p4}, Landroid/support/v4/app/Y$d;->a(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroid/support/v4/app/Y$d;

    goto :goto_0

    :cond_3
    invoke-virtual {v3, p4}, Landroid/support/v4/app/Y$d;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/Y$d;
    ...
    sget p3, Lb/b/a/a/b/c;->common_google_play_services_notification_ticker:I

    invoke-virtual {v1, p3}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object p3

    invoke-virtual {v3, p3}, Landroid/support/v4/app/Y$d;->d(Ljava/lang/CharSequence;)Landroid/support/v4/app/Y$d;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v6

    invoke-virtual {v3, v6, v7}, Landroid/support/v4/app/Y$d;->a(J)Landroid/support/v4/app/Y$d;

    invoke-virtual {v3, p4}, Landroid/support/v4/app/Y$d;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/Y$d;

    invoke-virtual {v3, v0}, Landroid/support/v4/app/Y$d;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/Y$d;
    ...
    :cond_6
    :goto_2
    invoke-virtual {v3, p3}, Landroid/support/v4/app/Y$d;->b(Ljava/lang/String;)Landroid/support/v4/app/Y$d;
...
.method public a(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, p2, p3, p4}, Lcom/google/android/gms/common/b;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/g;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public final a(I)Ljava/lang/String;
    ...
    invoke-super {p0, p1}, Lcom/google/android/gms/common/c;->a(I)Ljava/lang/String;
...
.method public final a(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;I)Z
    ...
    invoke-direct {p0, p1, p2, v1, p3}, Lcom/google/android/gms/common/b;->a(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
...
.method public b(Landroid/content/Context;)I
    ...
    invoke-super {p0, p1}, Lcom/google/android/gms/common/c;->b(Landroid/content/Context;)I
...
.method public final b(I)Z
    ...
    invoke-super {p0, p1}, Lcom/google/android/gms/common/c;->b(I)Z
