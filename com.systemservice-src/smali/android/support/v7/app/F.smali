...
.method static a()Landroid/support/v7/app/F;
    .locals 1
    ...
    invoke-direct {v0}, Landroid/support/v7/app/F;-><init>()V
...
.method public a(JDD)V
    ...
    iput v5, v0, Landroid/support/v7/app/F;->d:I

    :goto_0
    iput-wide v6, v0, Landroid/support/v7/app/F;->b:J

    iput-wide v6, v0, Landroid/support/v7/app/F;->c:J
    ...
    iput v8, v0, Landroid/support/v7/app/F;->d:I
    ...
    iput-wide v9, v0, Landroid/support/v7/app/F;->b:J
    ...
    iput-wide v3, v0, Landroid/support/v7/app/F;->c:J

    iget-wide v1, v0, Landroid/support/v7/app/F;->c:J

    cmp-long v3, v1, p1

    if-gez v3, :cond_2

    iget-wide v1, v0, Landroid/support/v7/app/F;->b:J
