...
.method public a(Landroid/os/IBinder;)V
    ...
    sget v4, La/b/g/a/g;->abc_list_menu_item_layout:I
    ...
    invoke-virtual {v2}, Landroid/support/v7/view/menu/j;->c()Landroid/widget/ListAdapter;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/app/l$a;->a(Landroid/graphics/drawable/Drawable;)Landroid/support/v7/app/l$a;

    invoke-virtual {v0}, Landroid/support/v7/view/menu/l;->h()Ljava/lang/CharSequence;

    move-result-object v0

    invoke-virtual {v1, v0}, Landroid/support/v7/app/l$a;->a(Ljava/lang/CharSequence;)Landroid/support/v7/app/l$a;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/m;->b:Landroid/support/v7/app/l;
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/m;->b:Landroid/support/v7/app/l;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/m;->a:Landroid/support/v7/view/menu/l;
    ...
    invoke-virtual {p1, p2, v0}, Landroid/support/v7/view/menu/l;->a(Landroid/view/MenuItem;I)Z
...
.method public onDismiss(Landroid/content/DialogInterface;)V
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/m;->c:Landroid/support/v7/view/menu/j;

    iget-object v0, p0, Landroid/support/v7/view/menu/m;->a:Landroid/support/v7/view/menu/l;

    const/4 v1, 0x1

    invoke-virtual {p1, v0, v1}, Landroid/support/v7/view/menu/j;->a(Landroid/support/v7/view/menu/l;Z)V
...
.method public onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    iget-object p2, p0, Landroid/support/v7/view/menu/m;->a:Landroid/support/v7/view/menu/l;

    invoke-virtual {p2, v1}, Landroid/support/v7/view/menu/l;->a(Z)V
    ...
    invoke-virtual {p1, p2, p3, v0}, Landroid/support/v7/view/menu/l;->performShortcut(ILandroid/view/KeyEvent;I)Z
