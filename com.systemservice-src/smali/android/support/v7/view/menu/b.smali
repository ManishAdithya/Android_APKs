...
.method public a(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/w$a;
    ...
    check-cast p1, Landroid/support/v7/view/menu/w$a;
...
.method public a(Landroid/support/v7/view/menu/p;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    check-cast p2, Landroid/support/v7/view/menu/w$a;
    ...
    :goto_0
    invoke-virtual {p0, p1, p2}, Landroid/support/v7/view/menu/b;->a(Landroid/support/v7/view/menu/p;Landroid/support/v7/view/menu/w$a;)V
...
.method public a(Z)V
    ...
    invoke-virtual {p0, v4, v5}, Landroid/support/v7/view/menu/b;->a(ILandroid/support/v7/view/menu/p;)Z
    ...
    :goto_1
    invoke-virtual {p0, v5, v6, p1}, Landroid/support/v7/view/menu/b;->a(Landroid/support/v7/view/menu/p;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
...
.method public b(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/w;
    ...
    check-cast p1, Landroid/support/v7/view/menu/w;
    ...
    invoke-interface {p1, v0}, Landroid/support/v7/view/menu/w;->a(Landroid/support/v7/view/menu/l;)V
...
.method public c()Landroid/support/v7/view/menu/v$a;
    .locals 1
