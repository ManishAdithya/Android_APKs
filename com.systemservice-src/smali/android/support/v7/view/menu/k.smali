...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object p2, p0, Landroid/support/v7/view/menu/k;->e:Landroid/view/LayoutInflater;

    iget v1, p0, Landroid/support/v7/view/menu/k;->f:I
    ...
    invoke-virtual {p3}, Landroid/support/v7/view/menu/p;->getGroupId()I
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/view/menu/k;->getItem(I)Landroid/support/v7/view/menu/p;
    ...
    iget-object v3, p0, Landroid/support/v7/view/menu/k;->a:Landroid/support/v7/view/menu/l;

    invoke-virtual {v3}, Landroid/support/v7/view/menu/l;->o()Z
    ...
    check-cast p3, Landroid/support/v7/view/menu/w$a;

    iget-boolean v1, p0, Landroid/support/v7/view/menu/k;->c:Z
    ...
    invoke-interface {p3, p1, v0}, Landroid/support/v7/view/menu/w$a;->a(Landroid/support/v7/view/menu/p;I)V
