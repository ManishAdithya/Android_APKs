...
.method static constructor <clinit>()V
    ...
    sget v0, La/b/g/a/g;->abc_popup_menu_item_layout:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/l;Landroid/view/View;IIZ)V
    ...
    iget-boolean v1, p0, Landroid/support/v7/view/menu/C;->f:Z

    sget v2, Landroid/support/v7/view/menu/C;->b:I

    invoke-direct {v0, p2, p6, v1, v2}, Landroid/support/v7/view/menu/k;-><init>(Landroid/support/v7/view/menu/l;Landroid/view/LayoutInflater;ZI)V

    iput-object v0, p0, Landroid/support/v7/view/menu/C;->e:Landroid/support/v7/view/menu/k;
    ...
    sget p6, La/b/g/a/d;->abc_config_prefDialogWidth:I
    ...
    iput p4, p0, Landroid/support/v7/view/menu/C;->g:I
    ...
    iget-object p4, p0, Landroid/support/v7/view/menu/C;->c:Landroid/content/Context;

    iget p5, p0, Landroid/support/v7/view/menu/C;->h:I

    iget p6, p0, Landroid/support/v7/view/menu/C;->i:I
    ...
    iput-object p3, p0, Landroid/support/v7/view/menu/C;->j:Landroid/support/v7/widget/MenuPopupWindow;
...
.method private h()Z
    ...
    invoke-virtual {p0}, Landroid/support/v7/view/menu/C;->d()Z
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/C;->j:Landroid/support/v7/widget/MenuPopupWindow;
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/C;->k:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;

    invoke-virtual {v3, v4}, Landroid/view/ViewTreeObserver;->addOnGlobalLayoutListener(Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    :cond_3
    iget-object v3, p0, Landroid/support/v7/view/menu/C;->l:Landroid/view/View$OnAttachStateChangeListener;

    invoke-virtual {v0, v3}, Landroid/view/View;->addOnAttachStateChangeListener(Landroid/view/View$OnAttachStateChangeListener;)V

    iget-object v3, p0, Landroid/support/v7/view/menu/C;->j:Landroid/support/v7/widget/MenuPopupWindow;

    invoke-virtual {v3, v0}, Landroid/support/v7/widget/ma;->a(Landroid/view/View;)V

    iget-object v0, p0, Landroid/support/v7/view/menu/C;->j:Landroid/support/v7/widget/MenuPopupWindow;

    iget v3, p0, Landroid/support/v7/view/menu/C;->u:I

    invoke-virtual {v0, v3}, Landroid/support/v7/widget/ma;->c(I)V

    iget-boolean v0, p0, Landroid/support/v7/view/menu/C;->s:Z
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/C;->c:Landroid/content/Context;

    iget v5, p0, Landroid/support/v7/view/menu/C;->g:I

    invoke-static {v0, v3, v4, v5}, Landroid/support/v7/view/menu/s;->a(Landroid/widget/ListAdapter;Landroid/view/ViewGroup;Landroid/content/Context;I)I

    move-result v0

    iput v0, p0, Landroid/support/v7/view/menu/C;->t:I
    ...
    iget v4, p0, Landroid/support/v7/view/menu/C;->t:I

    invoke-virtual {v0, v4}, Landroid/support/v7/widget/ma;->b(I)V

    iget-object v0, p0, Landroid/support/v7/view/menu/C;->j:Landroid/support/v7/widget/MenuPopupWindow;

    const/4 v4, 0x2

    invoke-virtual {v0, v4}, Landroid/support/v7/widget/ma;->e(I)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/ma;->a(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ma;->e()Landroid/widget/ListView;

    move-result-object v0

    invoke-virtual {v0, p0}, Landroid/widget/ListView;->setOnKeyListener(Landroid/view/View$OnKeyListener;)V

    iget-boolean v4, p0, Landroid/support/v7/view/menu/C;->v:Z

    if-eqz v4, :cond_6

    iget-object v4, p0, Landroid/support/v7/view/menu/C;->d:Landroid/support/v7/view/menu/l;

    invoke-virtual {v4}, Landroid/support/v7/view/menu/l;->h()Ljava/lang/CharSequence;
    ...
    sget v5, La/b/g/a/g;->abc_popup_menu_header_item_layout:I
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/C;->e:Landroid/support/v7/view/menu/k;

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/ma;->a(Landroid/widget/ListAdapter;)V
...
.method public a(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/v7/view/menu/C;->s:Z

    iget-object p1, p0, Landroid/support/v7/view/menu/C;->e:Landroid/support/v7/view/menu/k;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Landroid/support/v7/view/menu/k;->notifyDataSetChanged()V
...
.method public a(Landroid/support/v7/view/menu/D;)Z
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/C;->j:Landroid/support/v7/widget/MenuPopupWindow;

    invoke-virtual {v2}, Landroid/support/v7/widget/ma;->g()I

    move-result v2

    iget-object v3, p0, Landroid/support/v7/view/menu/C;->j:Landroid/support/v7/widget/MenuPopupWindow;

    invoke-virtual {v3}, Landroid/support/v7/widget/ma;->h()I
    ...
    invoke-static {v5}, Landroid/support/v4/view/x;->k(Landroid/view/View;)I
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/C;->n:Landroid/view/View;
...
.method public b(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ma;->d(I)V
...
.method public c()V
    ...
    invoke-direct {p0}, Landroid/support/v7/view/menu/C;->h()Z
...
.method public c(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ma;->h(I)V
