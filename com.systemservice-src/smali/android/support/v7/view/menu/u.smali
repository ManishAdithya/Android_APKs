...
.method private a(IIZZ)V
    ...
    iget p3, p0, Landroid/support/v7/view/menu/u;->g:I

    iget-object p4, p0, Landroid/support/v7/view/menu/u;->f:Landroid/view/View;

    invoke-static {p4}, Landroid/support/v4/view/x;->k(Landroid/view/View;)I
    ...
    iget-object p3, p0, Landroid/support/v7/view/menu/u;->f:Landroid/view/View;
    ...
    iget-object p3, p0, Landroid/support/v7/view/menu/u;->a:Landroid/content/Context;
    ...
    invoke-virtual {v0, p4}, Landroid/support/v7/view/menu/s;->a(Landroid/graphics/Rect;)V
...
.method private g()Landroid/support/v7/view/menu/s;
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/u;->a:Landroid/content/Context;

    invoke-virtual {v1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    sget v2, La/b/g/a/d;->abc_cascading_menus_min_smallest_width:I
    ...
    iget-object v3, p0, Landroid/support/v7/view/menu/u;->f:Landroid/view/View;

    iget v4, p0, Landroid/support/v7/view/menu/u;->d:I

    iget v5, p0, Landroid/support/v7/view/menu/u;->e:I

    iget-boolean v6, p0, Landroid/support/v7/view/menu/u;->c:Z

    move-object v1, v0

    invoke-direct/range {v1 .. v6}, Landroid/support/v7/view/menu/i;-><init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    :goto_2
    iget-object v1, p0, Landroid/support/v7/view/menu/u;->b:Landroid/support/v7/view/menu/l;

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/s;->a(Landroid/support/v7/view/menu/l;)V

    iget-object v1, p0, Landroid/support/v7/view/menu/u;->l:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/s;->a(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroid/support/v7/view/menu/u;->f:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/s;->a(Landroid/view/View;)V

    iget-object v1, p0, Landroid/support/v7/view/menu/u;->i:Landroid/support/v7/view/menu/v$a;

    invoke-interface {v0, v1}, Landroid/support/v7/view/menu/v;->a(Landroid/support/v7/view/menu/v$a;)V

    iget-boolean v1, p0, Landroid/support/v7/view/menu/u;->h:Z

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/s;->b(Z)V

    iget v1, p0, Landroid/support/v7/view/menu/u;->g:I

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/s;->a(I)V
