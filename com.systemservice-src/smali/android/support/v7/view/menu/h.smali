...
.method public a(Landroid/support/v7/view/menu/l;Landroid/view/MenuItem;)V
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/h;->a:Landroid/support/v7/view/menu/i;

    iget-object v4, v4, Landroid/support/v7/view/menu/i;->j:Ljava/util/List;

    invoke-interface {v4, v2}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Landroid/support/v7/view/menu/i$a;

    iget-object v4, v4, Landroid/support/v7/view/menu/i$a;->b:Landroid/support/v7/view/menu/l;
    ...
    invoke-direct {v0, p0, v1, p2, p1}, Landroid/support/v7/view/menu/g;-><init>(Landroid/support/v7/view/menu/h;Landroid/support/v7/view/menu/i$a;Landroid/view/MenuItem;Landroid/support/v7/view/menu/l;)V
    ...
    iget-object p2, p0, Landroid/support/v7/view/menu/h;->a:Landroid/support/v7/view/menu/i;

    iget-object p2, p2, Landroid/support/v7/view/menu/i;->h:Landroid/os/Handler;
