...
.field j:Landroid/support/v7/widget/RecyclerView$w;
...
.field o:Landroid/support/v7/widget/RecyclerView$p;
...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput-wide v1, p0, Landroid/support/v7/widget/RecyclerView$w;->f:J
    ...
    iput-object v1, p0, Landroid/support/v7/widget/RecyclerView$w;->j:Landroid/support/v7/widget/RecyclerView$w;

    iput-object v1, p0, Landroid/support/v7/widget/RecyclerView$w;->l:Ljava/util/List;

    iput-object v1, p0, Landroid/support/v7/widget/RecyclerView$w;->m:Ljava/util/List;

    const/4 v2, 0x0

    iput v2, p0, Landroid/support/v7/widget/RecyclerView$w;->n:I

    iput-object v1, p0, Landroid/support/v7/widget/RecyclerView$w;->o:Landroid/support/v7/widget/RecyclerView$p;

    iput-boolean v2, p0, Landroid/support/v7/widget/RecyclerView$w;->p:Z

    iput v2, p0, Landroid/support/v7/widget/RecyclerView$w;->q:I

    iput v0, p0, Landroid/support/v7/widget/RecyclerView$w;->r:I

    if-eqz p1, :cond_0

    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView$w;->b:Landroid/view/View;
...
.method private A()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$w;->m:Ljava/util/List;
...
.method a(I)V
    ...
    iget v0, p0, Landroid/support/v7/widget/RecyclerView$w;->k:I

    or-int/2addr p1, v0

    iput p1, p0, Landroid/support/v7/widget/RecyclerView$w;->k:I
...
.method a(IZ)V
    ...
    iget p2, p0, Landroid/support/v7/widget/RecyclerView$w;->h:I

    add-int/2addr p2, p1

    iput p2, p0, Landroid/support/v7/widget/RecyclerView$w;->h:I

    :cond_2
    iget p2, p0, Landroid/support/v7/widget/RecyclerView$w;->d:I

    add-int/2addr p2, p1

    iput p2, p0, Landroid/support/v7/widget/RecyclerView$w;->d:I

    iget-object p1, p0, Landroid/support/v7/widget/RecyclerView$w;->b:Landroid/view/View;
...
.method a(Landroid/support/v7/widget/RecyclerView$p;Z)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView$w;->o:Landroid/support/v7/widget/RecyclerView$p;

    iput-boolean p2, p0, Landroid/support/v7/widget/RecyclerView$w;->p:Z
...
.method a(Landroid/support/v7/widget/RecyclerView;)V
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$w;->b:Landroid/view/View;
...
.method a(Ljava/lang/Object;)V
    ...
    :cond_0
    iget v1, p0, Landroid/support/v7/widget/RecyclerView$w;->k:I
...
.method public final a(Z)V
    ...
    :goto_0
    iput v1, p0, Landroid/support/v7/widget/RecyclerView$w;->n:I
    ...
    iget p1, p0, Landroid/support/v7/widget/RecyclerView$w;->k:I
...
.method b()V
    ...
    iput v0, p0, Landroid/support/v7/widget/RecyclerView$w;->k:I
...
.method b(Landroid/support/v7/widget/RecyclerView;)V
    ...
    iput p1, p0, Landroid/support/v7/widget/RecyclerView$w;->q:I
...
.method e()Z
    ...
    invoke-static {v0}, Landroid/support/v4/view/x;->w(Landroid/view/View;)Z
...
.method public final f()I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$w;->s:Landroid/support/v7/widget/RecyclerView;
...
.method public final g()J
    ...
    iget-wide v0, p0, Landroid/support/v7/widget/RecyclerView$w;->f:J
...
.method k()Ljava/util/List;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$w;->m:Ljava/util/List;
...
.method q()Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$w;->o:Landroid/support/v7/widget/RecyclerView$p;
...
.method public toString()Ljava/lang/String;
    ...
    iget-wide v2, p0, Landroid/support/v7/widget/RecyclerView$w;->f:J
    ...
    iget v2, p0, Landroid/support/v7/widget/RecyclerView$w;->h:I
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/RecyclerView$w;->p:Z
    ...
    :cond_5
    invoke-virtual {p0}, Landroid/support/v7/widget/RecyclerView$w;->x()Z
    ...
    iget v2, p0, Landroid/support/v7/widget/RecyclerView$w;->n:I
    ...
    :cond_9
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$w;->b:Landroid/view/View;
...
.method u()V
    ...
    iput-wide v2, p0, Landroid/support/v7/widget/RecyclerView$w;->f:J

    iput v1, p0, Landroid/support/v7/widget/RecyclerView$w;->h:I
    ...
    iput-object v2, p0, Landroid/support/v7/widget/RecyclerView$w;->j:Landroid/support/v7/widget/RecyclerView$w;

    invoke-virtual {p0}, Landroid/support/v7/widget/RecyclerView$w;->b()V

    iput v0, p0, Landroid/support/v7/widget/RecyclerView$w;->q:I

    iput v1, p0, Landroid/support/v7/widget/RecyclerView$w;->r:I
