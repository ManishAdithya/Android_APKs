...
.field private I:Landroid/support/v7/widget/lb;
...
.field private t:Landroid/support/v7/widget/Fa;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, La/b/g/a/a;->toolbarStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    new-instance p1, Landroid/support/v7/widget/fb;

    invoke-direct {p1, p0}, Landroid/support/v7/widget/fb;-><init>(Landroid/support/v7/widget/Toolbar;)V

    iput-object p1, p0, Landroid/support/v7/widget/Toolbar;->H:Landroid/support/v7/widget/ActionMenuView$e;

    new-instance p1, Landroid/support/v7/widget/gb;

    invoke-direct {p1, p0}, Landroid/support/v7/widget/gb;-><init>(Landroid/support/v7/widget/Toolbar;)V
    ...
    sget-object v0, La/b/g/a/j;->Toolbar:[I
    ...
    sget p2, La/b/g/a/j;->Toolbar_titleTextAppearance:I

    invoke-virtual {p1, p2, v1}, Landroid/support/v7/widget/eb;->g(II)I

    move-result p2

    iput p2, p0, Landroid/support/v7/widget/Toolbar;->l:I

    sget p2, La/b/g/a/j;->Toolbar_subtitleTextAppearance:I
    ...
    sget p2, La/b/g/a/j;->Toolbar_android_gravity:I

    iget p3, p0, Landroid/support/v7/widget/Toolbar;->w:I

    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/eb;->e(II)I

    move-result p2

    iput p2, p0, Landroid/support/v7/widget/Toolbar;->w:I

    sget p2, La/b/g/a/j;->Toolbar_buttonGravity:I
    ...
    sget p2, La/b/g/a/j;->Toolbar_titleMargin:I

    invoke-virtual {p1, p2, v1}, Landroid/support/v7/widget/eb;->b(II)I

    move-result p2

    sget p3, La/b/g/a/j;->Toolbar_titleMargins:I

    invoke-virtual {p1, p3}, Landroid/support/v7/widget/eb;->g(I)Z
    ...
    invoke-virtual {p1, p3, p2}, Landroid/support/v7/widget/eb;->b(II)I
    ...
    sget p2, La/b/g/a/j;->Toolbar_titleMarginStart:I

    const/4 p3, -0x1

    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/eb;->b(II)I
    ...
    :cond_1
    sget p2, La/b/g/a/j;->Toolbar_titleMarginEnd:I
    ...
    :cond_2
    sget p2, La/b/g/a/j;->Toolbar_titleMarginTop:I
    ...
    :cond_3
    sget p2, La/b/g/a/j;->Toolbar_titleMarginBottom:I
    ...
    :cond_4
    sget p2, La/b/g/a/j;->Toolbar_maxButtonHeight:I

    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/eb;->c(II)I

    move-result p2

    iput p2, p0, Landroid/support/v7/widget/Toolbar;->o:I

    sget p2, La/b/g/a/j;->Toolbar_contentInsetStart:I
    ...
    sget v2, La/b/g/a/j;->Toolbar_contentInsetEnd:I

    invoke-virtual {p1, v2, v0}, Landroid/support/v7/widget/eb;->b(II)I

    move-result v2

    sget v3, La/b/g/a/j;->Toolbar_contentInsetLeft:I

    invoke-virtual {p1, v3, v1}, Landroid/support/v7/widget/eb;->c(II)I

    move-result v3

    sget v4, La/b/g/a/j;->Toolbar_contentInsetRight:I

    invoke-virtual {p1, v4, v1}, Landroid/support/v7/widget/eb;->c(II)I
    ...
    invoke-virtual {v5, v3, v4}, Landroid/support/v7/widget/Fa;->a(II)V
    ...
    invoke-virtual {v3, p2, v2}, Landroid/support/v7/widget/Fa;->b(II)V

    :cond_6
    sget p2, La/b/g/a/j;->Toolbar_contentInsetStartWithNavigation:I
    ...
    sget p2, La/b/g/a/j;->Toolbar_contentInsetEndWithActions:I
    ...
    sget p2, La/b/g/a/j;->Toolbar_collapseIcon:I
    ...
    sget p2, La/b/g/a/j;->Toolbar_collapseContentDescription:I
    ...
    sget p2, La/b/g/a/j;->Toolbar_title:I
    ...
    :cond_7
    sget p2, La/b/g/a/j;->Toolbar_subtitle:I
    ...
    sget p2, La/b/g/a/j;->Toolbar_popupTheme:I
    ...
    sget p2, La/b/g/a/j;->Toolbar_navigationIcon:I
    ...
    :cond_9
    sget p2, La/b/g/a/j;->Toolbar_navigationContentDescription:I
    ...
    :cond_a
    sget p2, La/b/g/a/j;->Toolbar_logo:I
    ...
    :cond_b
    sget p2, La/b/g/a/j;->Toolbar_logoDescription:I
    ...
    :cond_c
    sget p2, La/b/g/a/j;->Toolbar_titleTextColor:I
    ...
    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/eb;->a(II)I
    ...
    :cond_d
    sget p2, La/b/g/a/j;->Toolbar_subtitleTextColor:I
...
.method private a(Landroid/view/View;)I
    ...
    invoke-static {p1}, Landroid/support/v4/view/g;->b(Landroid/view/ViewGroup$MarginLayoutParams;)I

    move-result v0

    invoke-static {p1}, Landroid/support/v4/view/g;->a(Landroid/view/ViewGroup$MarginLayoutParams;)I
...
.method private n()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ActionMenuView;->h()Landroid/support/v7/view/menu/l;
...
.method private p()V
    ...
    sget v3, La/b/g/a/a;->toolbarNavigationButtonStyle:I
...
.method public a(II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/Fa;->b(II)V
...
.method public a(Landroid/support/v7/view/menu/l;Landroid/support/v7/widget/ActionMenuPresenter;)V
    .locals 3
    ...
    invoke-virtual {p2, v0}, Landroid/support/v7/widget/ActionMenuPresenter;->c(Z)V

    if-eqz p1, :cond_4

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->j:Landroid/content/Context;

    invoke-virtual {p1, p2, v0}, Landroid/support/v7/view/menu/l;->a(Landroid/support/v7/view/menu/v;Landroid/content/Context;)V

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->K:Landroid/support/v7/widget/Toolbar$a;

    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->j:Landroid/content/Context;

    invoke-virtual {p1, v0, v1}, Landroid/support/v7/view/menu/l;->a(Landroid/support/v7/view/menu/v;Landroid/content/Context;)V
    ...
    invoke-virtual {p2, p1, v1}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Landroid/content/Context;Landroid/support/v7/view/menu/l;)V

    iget-object p1, p0, Landroid/support/v7/widget/Toolbar;->K:Landroid/support/v7/widget/Toolbar$a;

    iget-object v2, p0, Landroid/support/v7/widget/Toolbar;->j:Landroid/content/Context;

    invoke-virtual {p1, v2, v1}, Landroid/support/v7/widget/Toolbar$a;->a(Landroid/content/Context;Landroid/support/v7/view/menu/l;)V
...
.method public a(Landroid/support/v7/view/menu/v$a;Landroid/support/v7/view/menu/l$a;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/Toolbar;->L:Landroid/support/v7/view/menu/v$a;

    iput-object p2, p0, Landroid/support/v7/widget/Toolbar;->M:Landroid/support/v7/view/menu/l$a;

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->a:Landroid/support/v7/widget/ActionMenuView;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/support/v7/view/menu/v$a;Landroid/support/v7/view/menu/l$a;)V
...
.method e()V
    ...
    invoke-direct {v1, p0}, Landroid/support/v7/widget/hb;-><init>(Landroid/support/v7/widget/Toolbar;)V
...
.method public getCurrentContentInsetEnd()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/l;->hasVisibleItems()Z
...
.method public getWrapper()Landroid/support/v7/widget/O;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/lb;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/lb;-><init>(Landroid/support/v7/widget/Toolbar;Z)V

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/lb;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/x;->l(Landroid/view/View;)I
...
.method protected onMeasure(II)V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v7/widget/ub;->a(Landroid/view/View;)Z
...
.method public onRtlPropertiesChanged(I)V
    ...
    :goto_0
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/Fa;->a(Z)V
