...
.field private p:Landroid/support/v7/view/menu/l;
...
.field private t:Landroid/support/v7/widget/ActionMenuPresenter;

.field private u:Landroid/support/v7/view/menu/v$a;

.field v:Landroid/support/v7/view/menu/l$a;
...
.method private e(II)V
    ...
    iput-boolean v13, v9, Landroid/support/v7/widget/ActionMenuView$c;->h:Z

    iput v13, v9, Landroid/support/v7/widget/ActionMenuView$c;->e:I

    iput v13, v9, Landroid/support/v7/widget/ActionMenuView$c;->d:I
    ...
    iget-boolean v15, v9, Landroid/support/v7/widget/ActionMenuView$c;->f:Z
    ...
    iget-boolean v10, v7, Landroid/support/v7/widget/ActionMenuView$c;->f:Z
    ...
    :cond_a
    iget v7, v7, Landroid/support/v7/widget/ActionMenuView$c;->d:I
    ...
    iget v2, v0, Landroid/support/v7/widget/ActionMenuView;->z:I
    ...
    iput v9, v3, Landroid/support/v7/widget/ActionMenuView$c;->e:I
...
.method public a(Landroid/support/v7/view/menu/l;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->p:Landroid/support/v7/view/menu/l;
...
.method public a(Landroid/support/v7/view/menu/v$a;Landroid/support/v7/view/menu/l$a;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->u:Landroid/support/v7/view/menu/v$a;

    iput-object p2, p0, Landroid/support/v7/widget/ActionMenuView;->v:Landroid/support/v7/view/menu/l$a;
...
.method public a(Landroid/support/v7/view/menu/p;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->p:Landroid/support/v7/view/menu/l;
...
.method public b()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->t:Landroid/support/v7/widget/ActionMenuPresenter;
...
.method protected generateDefaultLayoutParams()Landroid/support/v7/widget/ActionMenuView$c;
    ...
    iput v1, v0, Landroid/support/v7/widget/LinearLayoutCompat$a;->b:I

    return-object v0
.end method

.method protected bridge synthetic generateDefaultLayoutParams()Landroid/support/v7/widget/LinearLayoutCompat$a;
    .locals 1
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/ActionMenuView$c;
    ...
    :goto_0
    iget p1, v0, Landroid/support/v7/widget/LinearLayoutCompat$a;->b:I

    if-gtz p1, :cond_1

    const/16 p1, 0x10

    iput p1, v0, Landroid/support/v7/widget/LinearLayoutCompat$a;->b:I
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/support/v7/widget/LinearLayoutCompat$a;
    .locals 0
...
.method protected bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/LinearLayoutCompat$a;
    .locals 0
...
.method public getMenu()Landroid/view/Menu;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->p:Landroid/support/v7/view/menu/l;

    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->p:Landroid/support/v7/view/menu/l;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/view/menu/l;->a(Landroid/support/v7/view/menu/l$a;)V

    new-instance v1, Landroid/support/v7/widget/ActionMenuPresenter;

    invoke-direct {v1, v0}, Landroid/support/v7/widget/ActionMenuPresenter;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->t:Landroid/support/v7/widget/ActionMenuPresenter;

    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->t:Landroid/support/v7/widget/ActionMenuPresenter;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ActionMenuPresenter;->d(Z)V

    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->t:Landroid/support/v7/widget/ActionMenuPresenter;

    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->u:Landroid/support/v7/view/menu/v$a;
    ...
    :goto_0
    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/b;->a(Landroid/support/v7/view/menu/v$a;)V

    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->p:Landroid/support/v7/view/menu/l;

    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->t:Landroid/support/v7/widget/ActionMenuPresenter;
...
.method public h()Landroid/support/v7/view/menu/l;
    .locals 1
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->t:Landroid/support/v7/widget/ActionMenuPresenter;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v0, v5}, Landroid/support/v7/widget/ActionMenuView;->d(I)Z
...
.method protected onMeasure(II)V
    ...
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/ActionMenuView;->e(II)V
...
.method public setPresenter(Landroid/support/v7/widget/ActionMenuPresenter;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->t:Landroid/support/v7/widget/ActionMenuPresenter;
