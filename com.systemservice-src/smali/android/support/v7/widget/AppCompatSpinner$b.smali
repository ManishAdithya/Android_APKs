...
.super Landroid/support/v7/widget/ma;
.source ""
...
.method public constructor <init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p2, p3, p4}, Landroid/support/v7/widget/ma;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ma;->a(Landroid/view/View;)V

    const/4 p2, 0x1

    invoke-virtual {p0, p2}, Landroid/support/v7/widget/ma;->a(Z)V

    const/4 p2, 0x0

    invoke-virtual {p0, p2}, Landroid/support/v7/widget/ma;->f(I)V

    new-instance p2, Landroid/support/v7/widget/y;

    invoke-direct {p2, p0, p1}, Landroid/support/v7/widget/y;-><init>(Landroid/support/v7/widget/AppCompatSpinner$b;Landroid/support/v7/widget/AppCompatSpinner;)V

    invoke-virtual {p0, p2}, Landroid/support/v7/widget/ma;->a(Landroid/widget/AdapterView$OnItemClickListener;)V
...
.method static synthetic a(Landroid/support/v7/widget/AppCompatSpinner$b;)V
    ...
    invoke-super {p0}, Landroid/support/v7/widget/ma;->c()V
...
.method public a(Landroid/widget/ListAdapter;)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/widget/ma;->a(Landroid/widget/ListAdapter;)V
...
.method public c()V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/AppCompatSpinner$b;->l()V

    const/4 v1, 0x2

    invoke-virtual {p0, v1}, Landroid/support/v7/widget/ma;->e(I)V

    invoke-super {p0}, Landroid/support/v7/widget/ma;->c()V

    invoke-virtual {p0}, Landroid/support/v7/widget/ma;->e()Landroid/widget/ListView;
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/ma;->g(I)V
    ...
    invoke-direct {v1, p0}, Landroid/support/v7/widget/z;-><init>(Landroid/support/v7/widget/AppCompatSpinner$b;)V

    invoke-virtual {v0, v1}, Landroid/view/ViewTreeObserver;->addOnGlobalLayoutListener(Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    new-instance v0, Landroid/support/v7/widget/A;

    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/A;-><init>(Landroid/support/v7/widget/AppCompatSpinner$b;Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ma;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method l()V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/ma;->f()Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0}, Landroid/support/v7/widget/ub;->a(Landroid/view/View;)Z
    ...
    :goto_2
    invoke-virtual {p0, v4}, Landroid/support/v7/widget/ma;->b(I)V

    goto :goto_3

    :cond_4
    invoke-virtual {p0, v5}, Landroid/support/v7/widget/ma;->b(I)V

    :goto_3
    iget-object v4, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->N:Landroid/support/v7/widget/AppCompatSpinner;

    invoke-static {v4}, Landroid/support/v7/widget/ub;->a(Landroid/view/View;)Z
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/ma;->i()I
    ...
    :goto_4
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/ma;->d(I)V
