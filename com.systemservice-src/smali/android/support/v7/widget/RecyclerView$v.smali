...
.method constructor <init>(Landroid/support/v7/widget/RecyclerView;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView$v;->g:Landroid/support/v7/widget/RecyclerView;
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/RecyclerView$v;->e:Z
...
.method private a(IIII)I
    ...
    iget-object p2, p0, Landroid/support/v7/widget/RecyclerView$v;->g:Landroid/support/v7/widget/RecyclerView;
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/RecyclerView$v;->a(F)F
...
.method a()V
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/RecyclerView$v;->e:Z
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$v;->g:Landroid/support/v7/widget/RecyclerView;
...
.method public a(II)V
    ...
    iput v0, p0, Landroid/support/v7/widget/RecyclerView$v;->a:I

    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$v;->c:Landroid/widget/OverScroller;
...
.method public a(IIILandroid/view/animation/Interpolator;)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$v;->g:Landroid/support/v7/widget/RecyclerView;
    ...
    :cond_0
    iget-object p4, p0, Landroid/support/v7/widget/RecyclerView$v;->g:Landroid/support/v7/widget/RecyclerView;
...
.method public a(IILandroid/view/animation/Interpolator;)V
    ...
    invoke-direct {p0, p1, p2, v0, v0}, Landroid/support/v7/widget/RecyclerView$v;->a(IIII)I
...
.method public run()V
    ...
    iget-object v1, v0, Landroid/support/v7/widget/RecyclerView$v;->g:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v1, v0, Landroid/support/v7/widget/RecyclerView$v;->c:Landroid/widget/OverScroller;

    iget-object v2, v0, Landroid/support/v7/widget/RecyclerView$v;->g:Landroid/support/v7/widget/RecyclerView;

    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->w:Landroid/support/v7/widget/RecyclerView$i;

    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView$i;->g:Landroid/support/v7/widget/RecyclerView$s;
    ...
    iget-object v3, v0, Landroid/support/v7/widget/RecyclerView$v;->g:Landroid/support/v7/widget/RecyclerView;
    ...
    iget v5, v0, Landroid/support/v7/widget/RecyclerView$v;->a:I

    sub-int v13, v11, v5

    iget v5, v0, Landroid/support/v7/widget/RecyclerView$v;->b:I

    sub-int v14, v12, v5

    iput v11, v0, Landroid/support/v7/widget/RecyclerView$v;->a:I

    iput v12, v0, Landroid/support/v7/widget/RecyclerView$v;->b:I

    iget-object v5, v0, Landroid/support/v7/widget/RecyclerView$v;->g:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v5, v3, Landroid/support/v7/widget/RecyclerView;->v:Landroid/support/v7/widget/RecyclerView$a;
    ...
    iget-object v9, v0, Landroid/support/v7/widget/RecyclerView$v;->g:Landroid/support/v7/widget/RecyclerView;

    iget-object v9, v9, Landroid/support/v7/widget/RecyclerView;->ra:Landroid/support/v7/widget/RecyclerView$t;
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$s;->d()V
    ...
    invoke-virtual {v2, v9}, Landroid/support/v7/widget/RecyclerView$s;->a(I)V
    ...
    invoke-virtual {v2, v9, v10}, Landroid/support/v7/widget/RecyclerView$s;->a(II)V
    ...
    :cond_7
    iget-object v15, v0, Landroid/support/v7/widget/RecyclerView$v;->g:Landroid/support/v7/widget/RecyclerView;
    ...
    :goto_2
    iget-object v4, v0, Landroid/support/v7/widget/RecyclerView$v;->g:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v4, v4, Landroid/support/v7/widget/RecyclerView;->w:Landroid/support/v7/widget/RecyclerView$i;

    invoke-virtual {v4}, Landroid/support/v7/widget/RecyclerView$i;->b()Z
    ...
    invoke-virtual {v4}, Landroid/support/v7/widget/RecyclerView$i;->a()Z
    ...
    invoke-virtual {v1, v6}, Landroid/support/v7/widget/RecyclerView;->d(I)Z
    ...
    iget-object v3, v1, Landroid/support/v7/widget/RecyclerView;->pa:Landroid/support/v7/widget/ha;

    if-eqz v3, :cond_1c

    invoke-virtual {v3, v1, v13, v14}, Landroid/support/v7/widget/ha;->a(Landroid/support/v7/widget/RecyclerView;II)V
    ...
    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->qa:Landroid/support/v7/widget/ha$a;

    invoke-virtual {v1}, Landroid/support/v7/widget/ha$a;->a()V
    ...
    invoke-virtual {v2, v1, v1}, Landroid/support/v7/widget/RecyclerView$s;->a(II)V

    :cond_1d
    iget-boolean v1, v0, Landroid/support/v7/widget/RecyclerView$v;->f:Z
