...
.field private L:Landroid/support/v7/widget/SearchView$c;

.field private M:Landroid/support/v7/widget/SearchView$b;

.field N:Landroid/view/View$OnFocusChangeListener;

.field private O:Landroid/support/v7/widget/SearchView$d;
...
.field S:Landroid/support/v4/widget/j;
...
.field private z:Landroid/support/v7/widget/SearchView$e;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, La/b/g/a/a;->searchViewStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->ia:Ljava/lang/Runnable;

    new-instance v0, Landroid/support/v7/widget/Ka;

    invoke-direct {v0, p0}, Landroid/support/v7/widget/Ka;-><init>(Landroid/support/v7/widget/SearchView;)V

    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->ja:Ljava/lang/Runnable;

    new-instance v0, Ljava/util/WeakHashMap;

    invoke-direct {v0}, Ljava/util/WeakHashMap;-><init>()V

    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->ka:Ljava/util/WeakHashMap;

    new-instance v0, Landroid/support/v7/widget/Na;

    invoke-direct {v0, p0}, Landroid/support/v7/widget/Na;-><init>(Landroid/support/v7/widget/SearchView;)V

    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->la:Landroid/view/View$OnClickListener;

    new-instance v0, Landroid/support/v7/widget/Oa;

    invoke-direct {v0, p0}, Landroid/support/v7/widget/Oa;-><init>(Landroid/support/v7/widget/SearchView;)V

    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->ma:Landroid/view/View$OnKeyListener;

    new-instance v0, Landroid/support/v7/widget/Pa;

    invoke-direct {v0, p0}, Landroid/support/v7/widget/Pa;-><init>(Landroid/support/v7/widget/SearchView;)V

    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->na:Landroid/widget/TextView$OnEditorActionListener;

    new-instance v0, Landroid/support/v7/widget/Qa;

    invoke-direct {v0, p0}, Landroid/support/v7/widget/Qa;-><init>(Landroid/support/v7/widget/SearchView;)V

    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->oa:Landroid/widget/AdapterView$OnItemClickListener;

    new-instance v0, Landroid/support/v7/widget/Ra;

    invoke-direct {v0, p0}, Landroid/support/v7/widget/Ra;-><init>(Landroid/support/v7/widget/SearchView;)V

    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->pa:Landroid/widget/AdapterView$OnItemSelectedListener;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->qa:Landroid/text/TextWatcher;

    sget-object v0, La/b/g/a/j;->SearchView:[I

    const/4 v1, 0x0

    invoke-static {p1, p2, v0, p3, v1}, Landroid/support/v7/widget/eb;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/eb;
    ...
    sget p3, La/b/g/a/j;->SearchView_layout:I

    sget v0, La/b/g/a/g;->abc_search_view:I

    invoke-virtual {p2, p3, v0}, Landroid/support/v7/widget/eb;->g(II)I
    ...
    sget p1, La/b/g/a/f;->search_src_text:I
    ...
    sget p1, La/b/g/a/f;->search_edit_frame:I
    ...
    sget p1, La/b/g/a/f;->search_plate:I
    ...
    sget p1, La/b/g/a/f;->submit_area:I
    ...
    sget p1, La/b/g/a/f;->search_button:I
    ...
    sget p1, La/b/g/a/f;->search_go_btn:I
    ...
    sget p1, La/b/g/a/f;->search_close_btn:I
    ...
    sget p1, La/b/g/a/f;->search_voice_btn:I
    ...
    sget p1, La/b/g/a/f;->search_mag_icon:I
    ...
    sget p3, La/b/g/a/j;->SearchView_queryBackground:I

    invoke-virtual {p2, p3}, Landroid/support/v7/widget/eb;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object p3

    invoke-static {p1, p3}, Landroid/support/v4/view/x;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->t:Landroid/view/View;

    sget p3, La/b/g/a/j;->SearchView_submitBackground:I
    ...
    sget p3, La/b/g/a/j;->SearchView_searchIcon:I
    ...
    sget p3, La/b/g/a/j;->SearchView_goIcon:I
    ...
    sget p3, La/b/g/a/j;->SearchView_closeIcon:I
    ...
    sget p3, La/b/g/a/j;->SearchView_voiceIcon:I
    ...
    sget p1, La/b/g/a/j;->SearchView_searchHintIcon:I

    invoke-virtual {p2, p1}, Landroid/support/v7/widget/eb;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    sget v2, La/b/g/a/h;->abc_searchview_description_search:I

    invoke-virtual {p3, v2}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object p3

    invoke-static {p1, p3}, Landroid/support/v7/widget/mb;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    sget p1, La/b/g/a/j;->SearchView_suggestionRowLayout:I

    sget p3, La/b/g/a/g;->abc_search_dropdown_item_icons_2line:I
    ...
    sget p1, La/b/g/a/j;->SearchView_commitIcon:I
    ...
    iget-object p3, p0, Landroid/support/v7/widget/SearchView;->la:Landroid/view/View$OnClickListener;
    ...
    iget-object p3, p0, Landroid/support/v7/widget/SearchView;->qa:Landroid/text/TextWatcher;

    invoke-virtual {p1, p3}, Landroid/widget/AutoCompleteTextView;->addTextChangedListener(Landroid/text/TextWatcher;)V

    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->q:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    iget-object p3, p0, Landroid/support/v7/widget/SearchView;->na:Landroid/widget/TextView$OnEditorActionListener;
    ...
    iget-object p3, p0, Landroid/support/v7/widget/SearchView;->oa:Landroid/widget/AdapterView$OnItemClickListener;
    ...
    iget-object p3, p0, Landroid/support/v7/widget/SearchView;->pa:Landroid/widget/AdapterView$OnItemSelectedListener;
    ...
    iget-object p3, p0, Landroid/support/v7/widget/SearchView;->ma:Landroid/view/View$OnKeyListener;

    invoke-virtual {p1, p3}, Landroid/widget/AutoCompleteTextView;->setOnKeyListener(Landroid/view/View$OnKeyListener;)V

    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->q:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    new-instance p3, Landroid/support/v7/widget/La;

    invoke-direct {p3, p0}, Landroid/support/v7/widget/La;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    sget p1, La/b/g/a/j;->SearchView_iconifiedByDefault:I

    invoke-virtual {p2, p1, v0}, Landroid/support/v7/widget/eb;->a(IZ)Z

    move-result p1

    invoke-virtual {p0, p1}, Landroid/support/v7/widget/SearchView;->setIconifiedByDefault(Z)V

    sget p1, La/b/g/a/j;->SearchView_android_maxWidth:I

    const/4 p3, -0x1

    invoke-virtual {p2, p1, p3}, Landroid/support/v7/widget/eb;->c(II)I
    ...
    :cond_0
    sget p1, La/b/g/a/j;->SearchView_defaultQueryHint:I

    invoke-virtual {p2, p1}, Landroid/support/v7/widget/eb;->e(I)Ljava/lang/CharSequence;

    move-result-object p1

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->K:Ljava/lang/CharSequence;

    sget p1, La/b/g/a/j;->SearchView_queryHint:I
    ...
    sget p1, La/b/g/a/j;->SearchView_android_imeOptions:I

    invoke-virtual {p2, p1, p3}, Landroid/support/v7/widget/eb;->d(II)I
    ...
    :cond_1
    sget p1, La/b/g/a/j;->SearchView_android_inputType:I
    ...
    :cond_2
    sget p1, La/b/g/a/j;->SearchView_android_focusable:I
    ...
    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->J:Landroid/content/Intent;
    ...
    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->y:Landroid/view/View;

    if-eqz p1, :cond_3

    new-instance p2, Landroid/support/v7/widget/Ma;

    invoke-direct {p2, p0}, Landroid/support/v7/widget/Ma;-><init>(Landroid/support/v7/widget/SearchView;)V
...
.method private a(Landroid/content/Intent;Landroid/app/SearchableInfo;)Landroid/content/Intent;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/SearchView;->ha:Landroid/os/Bundle;
...
.method private a(Landroid/database/Cursor;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p1, v1}, Landroid/support/v7/widget/Ya;->a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    if-nez v1, :cond_0

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->ga:Landroid/app/SearchableInfo;
    ...
    invoke-static {p1, v3}, Landroid/support/v7/widget/Ya;->a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
...
.method private a(Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Landroid/content/Intent;
    ...
    :cond_0
    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->da:Ljava/lang/CharSequence;
    ...
    :cond_2
    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->ha:Landroid/os/Bundle;
    ...
    :cond_4
    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->ga:Landroid/app/SearchableInfo;
...
.method private a(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    iget-object v3, p0, Landroid/support/v7/widget/SearchView;->D:[I
...
.method private a(Z)V
    ...
    iget-boolean p1, p0, Landroid/support/v7/widget/SearchView;->ba:Z
...
.method private b(IILjava/lang/String;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->S:Landroid/support/v4/widget/j;

    invoke-virtual {v0}, Landroid/support/v4/widget/j;->a()Landroid/database/Cursor;
...
.method private e(I)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->S:Landroid/support/v4/widget/j;

    invoke-virtual {v1}, Landroid/support/v4/widget/j;->a()Landroid/database/Cursor;
    ...
    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->S:Landroid/support/v4/widget/j;

    invoke-virtual {p1, v1}, Landroid/support/v4/widget/j;->convertToString(Landroid/database/Cursor;)Ljava/lang/CharSequence;
...
.method private getPreferredHeight()I
    ...
    sget v1, La/b/g/a/d;->abc_search_view_preferred_height:I
...
.method private getPreferredWidth()I
    ...
    sget v1, La/b/g/a/d;->abc_search_view_preferred_width:I
...
.method private l()Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->ga:Landroid/app/SearchableInfo;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/SearchView;->ga:Landroid/app/SearchableInfo;
...
.method private n()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->ia:Ljava/lang/Runnable;
...
.method private o()V
    ...
    iget-boolean v3, p0, Landroid/support/v7/widget/SearchView;->ea:Z
...
.method private q()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/widget/j;->a(Landroid/database/Cursor;)V
    ...
    new-instance v0, Landroid/support/v7/widget/Ya;

    invoke-virtual {p0}, Landroid/view/ViewGroup;->getContext()Landroid/content/Context;

    move-result-object v1

    iget-object v3, p0, Landroid/support/v7/widget/SearchView;->ga:Landroid/app/SearchableInfo;

    iget-object v4, p0, Landroid/support/v7/widget/SearchView;->ka:Ljava/util/WeakHashMap;

    invoke-direct {v0, v1, p0, v3, v4}, Landroid/support/v7/widget/Ya;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V

    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->S:Landroid/support/v4/widget/j;
    ...
    check-cast v0, Landroid/support/v7/widget/Ya;
    ...
    :cond_2
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/Ya;->a(I)V
...
.method public a(Ljava/lang/CharSequence;Z)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->da:Ljava/lang/CharSequence;
...
.method a(IILjava/lang/String;)Z
    ...
    iget-object p2, p0, Landroid/support/v7/widget/SearchView;->O:Landroid/support/v7/widget/SearchView$d;
...
.method a(Landroid/view/View;ILandroid/view/KeyEvent;)Z
    ...
    sget-object p1, Landroid/support/v7/widget/SearchView;->p:Landroid/support/v7/widget/SearchView$a;
...
.method b()V
    ...
    invoke-static {p0}, Landroid/support/v7/widget/ub;->a(Landroid/view/View;)Z

    move-result v3

    iget-boolean v4, p0, Landroid/support/v7/widget/SearchView;->Q:Z

    if-eqz v4, :cond_0

    sget v4, La/b/g/a/d;->abc_dropdownitem_icon_width:I

    invoke-virtual {v0, v4}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v4

    sget v5, La/b/g/a/d;->abc_dropdownitem_text_padding_left:I
...
.method b(Ljava/lang/CharSequence;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->da:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->L:Landroid/support/v7/widget/SearchView$c;

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->ca:Ljava/lang/CharSequence;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->ca:Ljava/lang/CharSequence;
...
.method d(I)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->O:Landroid/support/v7/widget/SearchView$d;
...
.method e()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->M:Landroid/support/v7/widget/SearchView$b;
...
.method g()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->L:Landroid/support/v7/widget/SearchView$c;
...
.method public getMaxWidth()I
    ...
    iget v0, p0, Landroid/support/v7/widget/SearchView;->aa:I
...
.method public getSuggestionsAdapter()Landroid/support/v4/widget/j;
    .locals 1
...
.method public onActionViewCollapsed()V
    ...
    iget v2, p0, Landroid/support/v7/widget/SearchView;->fa:I

    invoke-virtual {v1, v2}, Landroid/widget/AutoCompleteTextView;->setImeOptions(I)V

    iput-boolean v0, p0, Landroid/support/v7/widget/SearchView;->ea:Z
...
.method public onActionViewExpanded()V
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/SearchView;->ea:Z
    ...
    iput v0, p0, Landroid/support/v7/widget/SearchView;->fa:I

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->q:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    iget v1, p0, Landroid/support/v7/widget/SearchView;->fa:I
...
.method protected onDetachedFromWindow()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->ja:Ljava/lang/Runnable;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->z:Landroid/support/v7/widget/SearchView$e;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->z:Landroid/support/v7/widget/SearchView$e;
...
.method protected onMeasure(II)V
    ...
    :cond_2
    iget p1, p0, Landroid/support/v7/widget/SearchView;->aa:I
...
.method public setAppSearchData(Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->ha:Landroid/os/Bundle;
...
.method public setMaxWidth(I)V
    ...
    iput p1, p0, Landroid/support/v7/widget/SearchView;->aa:I
...
.method public setOnCloseListener(Landroid/support/v7/widget/SearchView$b;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->M:Landroid/support/v7/widget/SearchView$b;
...
.method public setOnQueryTextListener(Landroid/support/v7/widget/SearchView$c;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->L:Landroid/support/v7/widget/SearchView$c;
...
.method public setOnSuggestionListener(Landroid/support/v7/widget/SearchView$d;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->O:Landroid/support/v7/widget/SearchView$d;
...
.method public setQueryRefinementEnabled(Z)V
    ...
    instance-of v1, v0, Landroid/support/v7/widget/Ya;
    ...
    :goto_0
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/Ya;->a(I)V
...
.method public setSearchableInfo(Landroid/app/SearchableInfo;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->ga:Landroid/app/SearchableInfo;
    ...
    iput-boolean p1, p0, Landroid/support/v7/widget/SearchView;->ba:Z
...
.method public setSuggestionsAdapter(Landroid/support/v4/widget/j;)V
    .locals 1

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->S:Landroid/support/v4/widget/j;
