...
.field private d:Landroid/support/v7/widget/fa;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, La/b/g/a/a;->spinnerStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    sget-object v0, La/b/g/a/j;->Spinner:[I
    ...
    new-instance v3, La/b/g/g/d;

    invoke-direct {v3, p1, p5}, La/b/g/g/d;-><init>(Landroid/content/Context;Landroid/content/res/Resources$Theme;)V
    ...
    :cond_0
    sget p5, La/b/g/a/j;->Spinner_popupTheme:I

    invoke-virtual {v0, p5, v1}, Landroid/support/v7/widget/eb;->g(II)I
    ...
    invoke-direct {v3, p1, p5}, La/b/g/g/d;-><init>(Landroid/content/Context;I)V
    ...
    sget-object v4, La/b/g/a/j;->Spinner:[I

    invoke-static {p5, p2, v4, p3, v1}, Landroid/support/v7/widget/eb;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/eb;

    move-result-object p5

    sget v1, La/b/g/a/j;->Spinner_android_dropDownWidth:I

    const/4 v4, -0x2

    invoke-virtual {p5, v1, v4}, Landroid/support/v7/widget/eb;->f(II)I

    move-result v1

    iput v1, p0, Landroid/support/v7/widget/AppCompatSpinner;->h:I

    sget v1, La/b/g/a/j;->Spinner_android_popupBackground:I

    invoke-virtual {p5, v1}, Landroid/support/v7/widget/eb;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    invoke-virtual {p4, v1}, Landroid/support/v7/widget/ma;->a(Landroid/graphics/drawable/Drawable;)V

    sget v1, La/b/g/a/j;->Spinner_android_prompt:I

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/eb;->d(I)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p4, v1}, Landroid/support/v7/widget/AppCompatSpinner$b;->a(Ljava/lang/CharSequence;)V

    invoke-virtual {p5}, Landroid/support/v7/widget/eb;->a()V
    ...
    invoke-direct {p5, p0, p0, p4}, Landroid/support/v7/widget/x;-><init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/view/View;Landroid/support/v7/widget/AppCompatSpinner$b;)V

    iput-object p5, p0, Landroid/support/v7/widget/AppCompatSpinner;->d:Landroid/support/v7/widget/fa;

    :cond_6
    sget p4, La/b/g/a/j;->Spinner_android_entries:I

    invoke-virtual {v0, p4}, Landroid/support/v7/widget/eb;->f(I)[Ljava/lang/CharSequence;
    ...
    sget p1, La/b/g/a/g;->support_simple_spinner_dropdown_item:I
...
.method public getDropDownHorizontalOffset()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ma;->g()I
...
.method public getDropDownVerticalOffset()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ma;->h()I
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ma;->f()Landroid/graphics/drawable/Drawable;
...
.method public getPrompt()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/AppCompatSpinner$b;->m()Ljava/lang/CharSequence;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->d:Landroid/support/v7/widget/fa;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0, p1}, Landroid/support/v7/widget/fa;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public setPopupBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ma;->a(Landroid/graphics/drawable/Drawable;)V
