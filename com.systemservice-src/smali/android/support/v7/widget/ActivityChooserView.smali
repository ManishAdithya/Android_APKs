...
.field j:Landroid/support/v4/view/c;
...
.field private m:Landroid/support/v7/widget/ma;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, La/b/g/a/j;->ActivityChooserView:[I
    ...
    sget p3, La/b/g/a/j;->ActivityChooserView_initialActivityCount:I
    ...
    sget p3, La/b/g/a/j;->ActivityChooserView_expandActivityOverflowButtonDrawable:I
    ...
    sget v0, La/b/g/a/g;->abc_activity_chooser_view:I
    ...
    sget p2, La/b/g/a/f;->activity_chooser_view_content:I
    ...
    sget p2, La/b/g/a/f;->default_activity_button:I
    ...
    sget p2, La/b/g/a/f;->expand_activities_button:I
...
.method a(I)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/ma;

    move-result-object p1

    invoke-virtual {p1}, Landroid/support/v7/widget/ma;->d()Z
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/ma;->b(I)V

    invoke-virtual {p1}, Landroid/support/v7/widget/ma;->c()V

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->j:Landroid/support/v4/view/c;
    ...
    :cond_4
    invoke-virtual {p1}, Landroid/support/v7/widget/ma;->e()Landroid/widget/ListView;
    ...
    sget v3, La/b/g/a/h;->abc_activitychooserview_choose_application:I
...
.method public getDataModel()Landroid/support/v7/widget/i;
    .locals 1
...
.method getListPopupWindow()Landroid/support/v7/widget/ma;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->m:Landroid/support/v7/widget/ma;
    ...
    invoke-direct {v0, v1}, Landroid/support/v7/widget/ma;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->m:Landroid/support/v7/widget/ma;

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->m:Landroid/support/v7/widget/ma;

    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Landroid/support/v7/widget/ActivityChooserView$a;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ma;->a(Landroid/widget/ListAdapter;)V

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->m:Landroid/support/v7/widget/ma;

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/ma;->a(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ma;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->m:Landroid/support/v7/widget/ma;

    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->b:Landroid/support/v7/widget/ActivityChooserView$b;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ma;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method public setActivityChooserModel(Landroid/support/v7/widget/i;)V
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Landroid/support/v7/widget/ActivityChooserView$a;

    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ActivityChooserView$a;->a(Landroid/support/v7/widget/i;)V
...
.method public setProvider(Landroid/support/v4/view/c;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ActivityChooserView;->j:Landroid/support/v4/view/c;
