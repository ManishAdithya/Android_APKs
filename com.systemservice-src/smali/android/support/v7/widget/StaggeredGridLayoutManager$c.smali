...
.method a(IIZZZ)I
    ...
    iget-object v0, v0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->u:Landroid/support/v7/widget/ra;
    ...
    iget-object v1, v1, Landroid/support/v7/widget/StaggeredGridLayoutManager;->u:Landroid/support/v7/widget/ra;
    ...
    iget-object v6, v6, Landroid/support/v7/widget/StaggeredGridLayoutManager;->u:Landroid/support/v7/widget/ra;
    ...
    iget-object v7, v7, Landroid/support/v7/widget/StaggeredGridLayoutManager;->u:Landroid/support/v7/widget/ra;
    ...
    invoke-virtual {p1, v5}, Landroid/support/v7/widget/RecyclerView$i;->l(Landroid/view/View;)I
...
.method public a(II)Landroid/view/View;
    ...
    invoke-virtual {v3, v2}, Landroid/support/v7/widget/RecyclerView$i;->l(Landroid/view/View;)I
    ...
    invoke-virtual {v2, v0}, Landroid/support/v7/widget/RecyclerView$i;->l(Landroid/view/View;)I
...
.method a()V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/StaggeredGridLayoutManager$c;->b(Landroid/view/View;)Landroid/support/v7/widget/StaggeredGridLayoutManager$b;

    move-result-object v1

    iget-object v3, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager$c;->f:Landroid/support/v7/widget/StaggeredGridLayoutManager;

    iget-object v3, v3, Landroid/support/v7/widget/StaggeredGridLayoutManager;->u:Landroid/support/v7/widget/ra;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->E:Landroid/support/v7/widget/StaggeredGridLayoutManager$LazySpanLookup;

    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$j;->a()I

    move-result v1

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/StaggeredGridLayoutManager$LazySpanLookup;->c(I)Landroid/support/v7/widget/StaggeredGridLayoutManager$LazySpanLookup$FullSpanItem;
...
.method a(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/StaggeredGridLayoutManager$c;->b(Landroid/view/View;)Landroid/support/v7/widget/StaggeredGridLayoutManager$b;
...
.method a(ZI)V
    ...
    iget-object v2, v2, Landroid/support/v7/widget/StaggeredGridLayoutManager;->u:Landroid/support/v7/widget/ra;
    ...
    iget-object p1, p1, Landroid/support/v7/widget/StaggeredGridLayoutManager;->u:Landroid/support/v7/widget/ra;
...
.method b(Landroid/view/View;)Landroid/support/v7/widget/StaggeredGridLayoutManager$b;
    .locals 0
...
.method b()V
    ...
    invoke-virtual {v2, v0}, Landroid/support/v7/widget/ra;->d(Landroid/view/View;)I
...
.method c()V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/StaggeredGridLayoutManager$c;->i()V
...
.method j()V
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/StaggeredGridLayoutManager$c;->b(Landroid/view/View;)Landroid/support/v7/widget/StaggeredGridLayoutManager$b;
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$j;->c()Z

    move-result v3

    if-nez v3, :cond_0

    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$j;->b()Z
    ...
    invoke-virtual {v3, v1}, Landroid/support/v7/widget/ra;->b(Landroid/view/View;)I
...
.method k()V
    ...
    :cond_0
    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$j;->c()Z

    move-result v2

    if-nez v2, :cond_1

    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$j;->b()Z
    ...
    invoke-virtual {v2, v0}, Landroid/support/v7/widget/ra;->b(Landroid/view/View;)I
