...
# instance fields
.field a:Landroid/support/v7/widget/ra;
...
.method a()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/LinearLayoutManager$a;->a:Landroid/support/v7/widget/ra;
...
.method public a(Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ra;->a(Landroid/view/View;)I

    move-result p1

    iget-object v0, p0, Landroid/support/v7/widget/LinearLayoutManager$a;->a:Landroid/support/v7/widget/ra;

    invoke-virtual {v0}, Landroid/support/v7/widget/ra;->h()I
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ra;->d(Landroid/view/View;)I
...
.method a(Landroid/view/View;Landroid/support/v7/widget/RecyclerView$t;)Z
    ...
    invoke-virtual {p1}, Landroid/support/v7/widget/RecyclerView$j;->c()Z
...
.method public b(Landroid/view/View;I)V
    ...
    iget-object p2, p0, Landroid/support/v7/widget/LinearLayoutManager$a;->a:Landroid/support/v7/widget/ra;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/LinearLayoutManager$a;->a:Landroid/support/v7/widget/ra;

    invoke-virtual {v3, p1}, Landroid/support/v7/widget/ra;->d(Landroid/view/View;)I
    ...
    iget-object v2, p0, Landroid/support/v7/widget/LinearLayoutManager$a;->a:Landroid/support/v7/widget/ra;
    ...
    invoke-virtual {v3, p1}, Landroid/support/v7/widget/ra;->b(Landroid/view/View;)I
    ...
    iget-object p1, p0, Landroid/support/v7/widget/LinearLayoutManager$a;->a:Landroid/support/v7/widget/ra;
