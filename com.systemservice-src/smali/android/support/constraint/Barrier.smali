...
.field private i:Landroid/support/constraint/a/a/b;
...
.method protected a(Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/constraint/Barrier;->i:Landroid/support/constraint/a/a/b;
    ...
    sget v4, Landroid/support/constraint/d;->ConstraintLayout_Layout_barrierDirection:I
    ...
    :cond_0
    sget v4, Landroid/support/constraint/d;->ConstraintLayout_Layout_barrierAllowsGoneWidgets:I

    if-ne v3, v4, :cond_1

    iget-object v4, p0, Landroid/support/constraint/Barrier;->i:Landroid/support/constraint/a/a/b;
    ...
    invoke-virtual {v4, v3}, Landroid/support/constraint/a/a/b;->c(Z)V
    ...
    :cond_2
    iget-object p1, p0, Landroid/support/constraint/Barrier;->i:Landroid/support/constraint/a/a/b;

    iput-object p1, p0, Landroid/support/constraint/ConstraintHelper;->d:Landroid/support/constraint/a/a/m;
...
.method public setAllowsGoneWidget(Z)V
    ...
    iget-object v0, p0, Landroid/support/constraint/Barrier;->i:Landroid/support/constraint/a/a/b;

    invoke-virtual {v0, p1}, Landroid/support/constraint/a/a/b;->c(Z)V
...
.method public setType(I)V
    ...
    iget p1, p0, Landroid/support/constraint/Barrier;->g:I

    if-ne p1, v1, :cond_0

    :goto_0
    iput v2, p0, Landroid/support/constraint/Barrier;->h:I
    ...
    :goto_1
    iput v3, p0, Landroid/support/constraint/Barrier;->h:I
    ...
    invoke-virtual {p1, v0}, Landroid/support/constraint/a/a/b;->t(I)V
