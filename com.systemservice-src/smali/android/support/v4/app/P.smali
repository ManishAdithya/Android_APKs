...
.method protected static a(Ljava/util/List;Landroid/view/View;)V
    ...
    invoke-static {p0, p1, v0}, Landroid/support/v4/app/P;->a(Ljava/util/List;Landroid/view/View;I)Z
    ...
    invoke-static {p0, v4, v0}, Landroid/support/v4/app/P;->a(Ljava/util/List;Landroid/view/View;I)Z
...
.method a(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Landroid/support/v4/view/x;->q(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-static {v3, v4}, Landroid/support/v4/view/x;->a(Landroid/view/View;Ljava/lang/String;)V
...
.method a(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-static {v3, v5}, Landroid/support/v4/view/x;->a(Landroid/view/View;Ljava/lang/String;)V
    ...
    :cond_3
    new-instance p5, Landroid/support/v4/app/M;
    ...
    invoke-direct/range {v0 .. v6}, Landroid/support/v4/app/M;-><init>(Landroid/support/v4/app/P;ILjava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    invoke-static {p1, p5}, Landroid/support/v4/app/ba;->a(Landroid/view/View;Ljava/lang/Runnable;)Landroid/support/v4/app/ba;
...
.method a(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-direct {v0, p0, p2, p3}, Landroid/support/v4/app/N;-><init>(Landroid/support/v4/app/P;Ljava/util/ArrayList;Ljava/util/Map;)V

    invoke-static {p1, v0}, Landroid/support/v4/app/ba;->a(Landroid/view/View;Ljava/lang/Runnable;)Landroid/support/v4/app/ba;
...
.method a(Landroid/view/ViewGroup;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-direct {v0, p0, p2, p3}, Landroid/support/v4/app/O;-><init>(Landroid/support/v4/app/P;Ljava/util/ArrayList;Ljava/util/Map;)V
...
.method a(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {p2}, Landroid/support/v4/view/z;->a(Landroid/view/ViewGroup;)Z
    ...
    invoke-virtual {p0, p1, v2}, Landroid/support/v4/app/P;->a(Ljava/util/ArrayList;Landroid/view/View;)V
...
.method a(Ljava/util/Map;Landroid/view/View;)V
    ...
    invoke-static {p2}, Landroid/support/v4/view/x;->q(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v2}, Landroid/support/v4/app/P;->a(Ljava/util/Map;Landroid/view/View;)V
