...
.method private a(Ljava/lang/String;Landroid/support/v4/app/B;)Landroid/support/v4/app/B;
    .locals 3
    ...
    iget-object p2, p0, Landroid/support/v4/app/FragmentTabHost;->c:Landroid/support/v4/app/p;

    invoke-virtual {p2}, Landroid/support/v4/app/p;->a()Landroid/support/v4/app/B;
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/app/B;->b(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/B;
    ...
    invoke-virtual {p2, v0, v1, v2}, Landroid/support/v4/app/B;->a(ILandroid/support/v4/app/Fragment;Ljava/lang/String;)Landroid/support/v4/app/B;

    goto :goto_0

    :cond_2
    invoke-virtual {p2, v0}, Landroid/support/v4/app/B;->a(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/B;
...
.method protected onAttachedToWindow()V
    ...
    iget-object v5, p0, Landroid/support/v4/app/FragmentTabHost;->c:Landroid/support/v4/app/p;

    iget-object v6, v4, Landroid/support/v4/app/FragmentTabHost$a;->a:Ljava/lang/String;

    invoke-virtual {v5, v6}, Landroid/support/v4/app/p;->a(Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {v5}, Landroid/support/v4/app/Fragment;->D()Z
    ...
    iget-object v2, p0, Landroid/support/v4/app/FragmentTabHost;->c:Landroid/support/v4/app/p;

    invoke-virtual {v2}, Landroid/support/v4/app/p;->a()Landroid/support/v4/app/B;
    ...
    invoke-virtual {v2, v4}, Landroid/support/v4/app/B;->b(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/B;
    ...
    invoke-direct {p0, v0, v2}, Landroid/support/v4/app/FragmentTabHost;->a(Ljava/lang/String;Landroid/support/v4/app/B;)Landroid/support/v4/app/B;
    ...
    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->c:Landroid/support/v4/app/p;
...
.method public onTabChanged(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/v4/app/FragmentTabHost;->a(Ljava/lang/String;Landroid/support/v4/app/B;)Landroid/support/v4/app/B;
