...
.method constructor <init>(Landroid/support/v4/app/Y$d;)V
    ...
    iget-object v2, p1, Landroid/support/v4/app/Y$d;->a:Landroid/content/Context;

    iget-object v3, p1, Landroid/support/v4/app/Y$d;->I:Ljava/lang/String;
    ...
    iget-object v0, p1, Landroid/support/v4/app/Y$d;->N:Landroid/app/Notification;
    ...
    iget-object v4, p1, Landroid/support/v4/app/Y$d;->h:Landroid/widget/RemoteViews;
    ...
    iget-object v3, p1, Landroid/support/v4/app/Y$d;->d:Ljava/lang/CharSequence;

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setContentTitle(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v2

    iget-object v3, p1, Landroid/support/v4/app/Y$d;->e:Ljava/lang/CharSequence;

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v2

    iget-object v3, p1, Landroid/support/v4/app/Y$d;->j:Ljava/lang/CharSequence;

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setContentInfo(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v2

    iget-object v3, p1, Landroid/support/v4/app/Y$d;->f:Landroid/app/PendingIntent;
    ...
    iget-object v3, p1, Landroid/support/v4/app/Y$d;->g:Landroid/app/PendingIntent;
    ...
    iget-object v3, p1, Landroid/support/v4/app/Y$d;->i:Landroid/graphics/Bitmap;

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setLargeIcon(Landroid/graphics/Bitmap;)Landroid/app/Notification$Builder;

    move-result-object v2

    iget v3, p1, Landroid/support/v4/app/Y$d;->k:I
    ...
    iget v7, p1, Landroid/support/v4/app/Y$d;->s:I

    iget-boolean v8, p1, Landroid/support/v4/app/Y$d;->t:Z
    ...
    iget-object v6, p1, Landroid/support/v4/app/Y$d;->p:Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, v6}, Landroid/support/v4/app/Z;->a(Landroid/support/v4/app/Y$a;)V

    goto :goto_5

    :cond_6
    iget-object v2, p1, Landroid/support/v4/app/Y$d;->B:Landroid/os/Bundle;

    if-eqz v2, :cond_7

    iget-object v6, p0, Landroid/support/v4/app/Z;->f:Landroid/os/Bundle;
    ...
    iget-boolean v2, p1, Landroid/support/v4/app/Y$d;->x:Z

    if-eqz v2, :cond_8

    iget-object v2, p0, Landroid/support/v4/app/Z;->f:Landroid/os/Bundle;
    ...
    :cond_8
    iget-object v2, p1, Landroid/support/v4/app/Y$d;->u:Ljava/lang/String;
    ...
    iget-boolean v2, p1, Landroid/support/v4/app/Y$d;->v:Z
    ...
    :cond_a
    iget-object v2, p1, Landroid/support/v4/app/Y$d;->w:Ljava/lang/String;

    if-eqz v2, :cond_b

    iget-object v4, p0, Landroid/support/v4/app/Z;->f:Landroid/os/Bundle;
    ...
    :cond_b
    iget-object v2, p1, Landroid/support/v4/app/Y$d;->F:Landroid/widget/RemoteViews;

    iput-object v2, p0, Landroid/support/v4/app/Z;->c:Landroid/widget/RemoteViews;

    iget-object v2, p1, Landroid/support/v4/app/Y$d;->G:Landroid/widget/RemoteViews;

    iput-object v2, p0, Landroid/support/v4/app/Z;->d:Landroid/widget/RemoteViews;
    ...
    iget-boolean v4, p1, Landroid/support/v4/app/Y$d;->m:Z
    ...
    iget-object v2, p1, Landroid/support/v4/app/Y$d;->O:Ljava/util/ArrayList;
    ...
    iget-object v4, p1, Landroid/support/v4/app/Y$d;->O:Ljava/util/ArrayList;
    ...
    iget-object v3, p1, Landroid/support/v4/app/Y$d;->A:Ljava/lang/String;

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setCategory(Ljava/lang/String;)Landroid/app/Notification$Builder;

    move-result-object v2

    iget v3, p1, Landroid/support/v4/app/Y$d;->C:I

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setColor(I)Landroid/app/Notification$Builder;

    move-result-object v2

    iget v3, p1, Landroid/support/v4/app/Y$d;->D:I

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setVisibility(I)Landroid/app/Notification$Builder;

    move-result-object v2

    iget-object v3, p1, Landroid/support/v4/app/Y$d;->E:Landroid/app/Notification;
    ...
    iget-object v0, p1, Landroid/support/v4/app/Y$d;->O:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Landroid/support/v4/app/Z;->a:Landroid/app/Notification$Builder;
    ...
    :cond_f
    iget-object v0, p1, Landroid/support/v4/app/Y$d;->H:Landroid/widget/RemoteViews;

    iput-object v0, p0, Landroid/support/v4/app/Z;->h:Landroid/widget/RemoteViews;

    iget-object v0, p1, Landroid/support/v4/app/Y$d;->c:Ljava/util/ArrayList;
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/Y$d;->b()Landroid/os/Bundle;
    ...
    :goto_8
    iget-object v6, p1, Landroid/support/v4/app/Y$d;->c:Ljava/util/ArrayList;
    ...
    iget-object v7, p1, Landroid/support/v4/app/Y$d;->c:Ljava/util/ArrayList;

    invoke-virtual {v7, v4}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v7

    check-cast v7, Landroid/support/v4/app/Y$a;

    invoke-static {v7}, Landroid/support/v4/app/aa;->a(Landroid/support/v4/app/Y$a;)Landroid/os/Bundle;
    ...
    iget-object v3, p0, Landroid/support/v4/app/Z;->f:Landroid/os/Bundle;
    ...
    iget-object v2, p1, Landroid/support/v4/app/Y$d;->q:[Ljava/lang/CharSequence;
    ...
    iget-object v1, p1, Landroid/support/v4/app/Y$d;->K:Ljava/lang/String;

    invoke-virtual {v0, v1}, Landroid/app/Notification$Builder;->setShortcutId(Ljava/lang/String;)Landroid/app/Notification$Builder;

    move-result-object v0

    iget-wide v1, p1, Landroid/support/v4/app/Y$d;->L:J

    invoke-virtual {v0, v1, v2}, Landroid/app/Notification$Builder;->setTimeoutAfter(J)Landroid/app/Notification$Builder;

    move-result-object v0

    iget v1, p1, Landroid/support/v4/app/Y$d;->M:I

    invoke-virtual {v0, v1}, Landroid/app/Notification$Builder;->setGroupAlertBehavior(I)Landroid/app/Notification$Builder;

    iget-boolean v0, p1, Landroid/support/v4/app/Y$d;->z:Z

    if-eqz v0, :cond_16

    iget-object v0, p0, Landroid/support/v4/app/Z;->a:Landroid/app/Notification$Builder;

    iget-boolean v1, p1, Landroid/support/v4/app/Y$d;->y:Z

    invoke-virtual {v0, v1}, Landroid/app/Notification$Builder;->setColorized(Z)Landroid/app/Notification$Builder;

    :cond_16
    iget-object p1, p1, Landroid/support/v4/app/Y$d;->I:Ljava/lang/String;
    ...
    iget-object p1, p0, Landroid/support/v4/app/Z;->a:Landroid/app/Notification$Builder;
...
.method private a(Landroid/support/v4/app/Y$a;)V
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/Y$a;->f()[Landroid/support/v4/app/ca;
    ...
    invoke-static {v1}, Landroid/support/v4/app/ca;->a([Landroid/support/v4/app/ca;)[Landroid/app/RemoteInput;
    ...
    :goto_1
    invoke-virtual {p1}, Landroid/support/v4/app/Y$a;->b()Z
    ...
    :cond_2
    invoke-virtual {p1}, Landroid/support/v4/app/Y$a;->g()I
    ...
    :cond_3
    invoke-virtual {p1}, Landroid/support/v4/app/Y$a;->h()Z
...
.method public b()Landroid/app/Notification;
    ...
    iget-object v0, v0, Landroid/support/v4/app/Y$d;->o:Landroid/support/v4/app/Y$e;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0}, Landroid/support/v4/app/Y$e;->a(Landroid/support/v4/app/X;)V

    :cond_0
    if-eqz v0, :cond_1

    invoke-virtual {v0, p0}, Landroid/support/v4/app/Y$e;->c(Landroid/support/v4/app/X;)Landroid/widget/RemoteViews;
    ...
    :cond_2
    iget-object v1, p0, Landroid/support/v4/app/Z;->b:Landroid/support/v4/app/Y$d;

    iget-object v1, v1, Landroid/support/v4/app/Y$d;->F:Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/app/Y$e;->b(Landroid/support/v4/app/X;)Landroid/widget/RemoteViews;
    ...
    iget-object v1, v1, Landroid/support/v4/app/Y$d;->o:Landroid/support/v4/app/Y$e;

    invoke-virtual {v1, p0}, Landroid/support/v4/app/Y$e;->d(Landroid/support/v4/app/X;)Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/app/Y$e;->a(Landroid/os/Bundle;)V
...
.method protected c()Landroid/app/Notification;
    ...
    invoke-static {v0}, Landroid/support/v4/app/Y;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    iget-object v1, p0, Landroid/support/v4/app/Z;->e:Ljava/util/List;

    invoke-static {v1}, Landroid/support/v4/app/aa;->a(Ljava/util/List;)Landroid/util/SparseArray;
