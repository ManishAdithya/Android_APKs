...
.method public onTransitionStart(Landroid/transition/Transition;)V
    ...
    iget-object p1, p0, Landroid/support/v4/app/J;->a:Ljava/lang/Object;

    const/4 v0, 0x0

    if-eqz p1, :cond_0

    iget-object v1, p0, Landroid/support/v4/app/J;->g:Landroid/support/v4/app/L;

    iget-object v2, p0, Landroid/support/v4/app/J;->b:Ljava/util/ArrayList;

    invoke-virtual {v1, p1, v2, v0}, Landroid/support/v4/app/L;->a(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    :cond_0
    iget-object p1, p0, Landroid/support/v4/app/J;->c:Ljava/lang/Object;

    if-eqz p1, :cond_1

    iget-object v1, p0, Landroid/support/v4/app/J;->g:Landroid/support/v4/app/L;

    iget-object v2, p0, Landroid/support/v4/app/J;->d:Ljava/util/ArrayList;

    invoke-virtual {v1, p1, v2, v0}, Landroid/support/v4/app/L;->a(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    :cond_1
    iget-object p1, p0, Landroid/support/v4/app/J;->e:Ljava/lang/Object;

    if-eqz p1, :cond_2

    iget-object v1, p0, Landroid/support/v4/app/J;->g:Landroid/support/v4/app/L;

    iget-object v2, p0, Landroid/support/v4/app/J;->f:Ljava/util/ArrayList;
