...
.field private final k:Landroid/support/v4/widget/O;

.field private final l:Landroid/support/v4/widget/O;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p0, v3, p3}, Landroid/support/v4/widget/O;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/O$a;)Landroid/support/v4/widget/O;

    move-result-object p3

    iput-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/O;

    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/O;

    invoke-virtual {p3, p2}, Landroid/support/v4/widget/O;->d(I)V

    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/O;

    invoke-virtual {p3, v2}, Landroid/support/v4/widget/O;->a(F)V

    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/DrawerLayout$e;

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/O;

    invoke-virtual {p3, v4}, Landroid/support/v4/widget/DrawerLayout$e;->a(Landroid/support/v4/widget/O;)V
    ...
    iput-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/O;

    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/O;

    const/4 v3, 0x2

    invoke-virtual {p3, v3}, Landroid/support/v4/widget/O;->d(I)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/O;

    invoke-virtual {p3, v2}, Landroid/support/v4/widget/DrawerLayout$e;->a(Landroid/support/v4/widget/O;)V

    invoke-virtual {p0, p2}, Landroid/view/ViewGroup;->setFocusableInTouchMode(Z)V

    invoke-static {p0, p2}, Landroid/support/v4/view/x;->d(Landroid/view/View;I)V
    ...
    new-instance p3, Landroid/support/v4/widget/m;

    invoke-direct {p3, p0}, Landroid/support/v4/widget/m;-><init>(Landroid/support/v4/widget/DrawerLayout;)V
...
.method private a(Landroid/graphics/drawable/Drawable;I)Z
    ...
    invoke-static {p1}, Landroid/support/v4/graphics/drawable/a;->f(Landroid/graphics/drawable/Drawable;)Z
...
.method private c(Landroid/view/View;Z)V
    ...
    invoke-virtual {p0, v2}, Landroid/support/v4/widget/DrawerLayout;->j(Landroid/view/View;)Z
    ...
    :goto_1
    invoke-static {v2, v3}, Landroid/support/v4/view/x;->d(Landroid/view/View;I)V
...
.method public a(II)V
    ...
    iget-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/O;

    goto :goto_1

    :cond_4
    iget-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/O;

    :goto_1
    invoke-virtual {p2}, Landroid/support/v4/widget/O;->b()V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/DrawerLayout;->l(Landroid/view/View;)V
...
.method a(IILandroid/view/View;)V
    ...
    iget-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/O;

    invoke-virtual {p1}, Landroid/support/v4/widget/O;->f()I

    move-result p1

    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/O;

    invoke-virtual {v0}, Landroid/support/v4/widget/O;->f()I
...
.method public a(Landroid/view/View;Z)V
    ...
    invoke-virtual {p2, p1, v0, v1}, Landroid/support/v4/widget/O;->b(Landroid/view/View;II)Z
...
.method a(Z)V
    ...
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/O;
    ...
    invoke-virtual {v7, v4, v6, v8}, Landroid/support/v4/widget/O;->b(Landroid/view/View;II)Z
    ...
    :cond_1
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/O;
    ...
    invoke-virtual {v6, v4, v7, v8}, Landroid/support/v4/widget/O;->b(Landroid/view/View;II)Z
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    invoke-virtual {p0, v4}, Landroid/support/v4/widget/DrawerLayout;->i(Landroid/view/View;)Z
...
.method b(Landroid/view/View;F)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/DrawerLayout;->f(Landroid/view/View;)F
...
.method public b(Landroid/view/View;Z)V
    ...
    invoke-virtual {p2, p1, v1, v0}, Landroid/support/v4/widget/O;->b(Landroid/view/View;II)Z
...
.method public computeScroll()V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/O;
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/widget/O;->a(Z)Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-virtual {p0, v2}, Landroid/support/v4/widget/DrawerLayout;->h(Landroid/view/View;)Z
    ...
    invoke-virtual {p0, v12}, Landroid/support/v4/widget/DrawerLayout;->j(Landroid/view/View;)Z
    ...
    iget-object v8, v0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/O;

    invoke-virtual {v8}, Landroid/support/v4/widget/O;->d()I
    ...
    iget-object v10, v0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/O;

    invoke-virtual {v10}, Landroid/support/v4/widget/O;->d()I
...
.method j(Landroid/view/View;)Z
    ...
    invoke-static {p1}, Landroid/support/v4/view/x;->k(Landroid/view/View;)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/O;

    invoke-virtual {v1, p1}, Landroid/support/v4/widget/O;->b(Landroid/view/MotionEvent;)Z

    move-result v1

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/O;

    invoke-virtual {v2, p1}, Landroid/support/v4/widget/O;->b(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p1, v4}, Landroid/support/v4/widget/O;->a(I)Z
    ...
    invoke-virtual {v4, v0, p1}, Landroid/support/v4/widget/O;->b(II)Landroid/view/View;

    move-result-object p1

    if-eqz p1, :cond_4

    invoke-virtual {p0, p1}, Landroid/support/v4/widget/DrawerLayout;->h(Landroid/view/View;)Z
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v4/widget/DrawerLayout;->h(Landroid/view/View;)Z
...
.method protected onMeasure(II)V
    ...
    invoke-static {v12}, Landroid/support/v4/view/x;->h(Landroid/view/View;)Z
    ...
    :cond_c
    :goto_6
    invoke-virtual {v0, v12}, Landroid/support/v4/widget/DrawerLayout;->h(Landroid/view/View;)Z
    ...
    invoke-virtual {v0, v12}, Landroid/support/v4/widget/DrawerLayout;->j(Landroid/view/View;)Z
    ...
    invoke-static {v12}, Landroid/support/v4/view/x;->g(Landroid/view/View;)F
    ...
    invoke-static {v12, v14}, Landroid/support/v4/view/x;->a(Landroid/view/View;F)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/widget/DrawerLayout;->l(Landroid/view/View;)V
...
.method public onRtlPropertiesChanged(I)V
    ...
    invoke-direct {p0}, Landroid/support/v4/widget/DrawerLayout;->i()V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/O;->a(Landroid/view/MotionEvent;)V
    ...
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/O;

    float-to-int v4, v0

    float-to-int v5, p1

    invoke-virtual {v3, v4, v5}, Landroid/support/v4/widget/O;->b(II)Landroid/view/View;

    move-result-object v3

    if-eqz v3, :cond_3

    invoke-virtual {p0, v3}, Landroid/support/v4/widget/DrawerLayout;->h(Landroid/view/View;)Z
    ...
    invoke-virtual {v3}, Landroid/support/v4/widget/O;->e()I
