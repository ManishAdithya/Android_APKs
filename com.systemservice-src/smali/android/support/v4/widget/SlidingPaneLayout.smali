...
.field private o:Landroid/support/v4/widget/SlidingPaneLayout$e;

.field final p:Landroid/support/v4/widget/O;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p0, p3}, Landroid/support/v4/view/x;->a(Landroid/view/View;Landroid/support/v4/view/b;)V
    ...
    invoke-static {p0, v0, p2}, Landroid/support/v4/widget/O;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/O$a;)Landroid/support/v4/widget/O;

    move-result-object p2

    iput-object p2, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:Landroid/support/v4/widget/O;

    iget-object p2, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:Landroid/support/v4/widget/O;

    const/high16 p3, 0x43c80000    # 400.0f

    mul-float p1, p1, p3

    invoke-virtual {p2, p1}, Landroid/support/v4/widget/O;->a(F)V
...
.method private a(F)V
    ...
    iget-boolean v2, v1, Landroid/support/v4/widget/SlidingPaneLayout$d;->d:Z
...
.method private a(Landroid/view/View;FI)V
    ...
    iget-object p3, v0, Landroid/support/v4/widget/SlidingPaneLayout$d;->e:Landroid/graphics/Paint;
    ...
    iput-object p3, v0, Landroid/support/v4/widget/SlidingPaneLayout$d;->e:Landroid/graphics/Paint;
    ...
    iget-object p2, v0, Landroid/support/v4/widget/SlidingPaneLayout$d;->e:Landroid/graphics/Paint;
    ...
    invoke-static {p0, p2}, Landroid/support/v4/view/x;->a(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method a(I)V
    ...
    :cond_4
    iget-boolean p1, v1, Landroid/support/v4/widget/SlidingPaneLayout$d;->d:Z
...
.method a(Landroid/view/View;)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->o:Landroid/support/v4/widget/SlidingPaneLayout$e;
...
.method a(FI)Z
    ...
    invoke-virtual {p2, v1, p1, v2}, Landroid/support/v4/widget/O;->b(Landroid/view/View;II)Z
...
.method public computeScroll()V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:Landroid/support/v4/widget/O;
...
.method d(Landroid/view/View;)V
    ...
    iget-object v0, v0, Landroid/support/v4/widget/SlidingPaneLayout$d;->e:Landroid/graphics/Paint;

    invoke-static {p1, v0}, Landroid/support/v4/view/x;->a(Landroid/view/View;Landroid/graphics/Paint;)V
    ...
    invoke-static {p0, v0, v1, v2, p1}, Landroid/support/v4/view/x;->a(Landroid/view/View;IIII)V
...
.method e(Landroid/view/View;)Z
    ...
    iget-boolean p1, p1, Landroid/support/v4/widget/SlidingPaneLayout$d;->d:Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v3, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:Landroid/support/v4/widget/O;
    ...
    invoke-virtual {v3, v1, v4, v5}, Landroid/support/v4/widget/O;->a(Landroid/view/View;II)Z
    ...
    iget-object v4, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:Landroid/support/v4/widget/O;

    invoke-virtual {v4}, Landroid/support/v4/widget/O;->e()I
    ...
    iget-object p1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:Landroid/support/v4/widget/O;

    invoke-virtual {p1}, Landroid/support/v4/widget/O;->b()V
    ...
    invoke-virtual {v4, v5, v0, v1}, Landroid/support/v4/widget/O;->a(Landroid/view/View;II)Z
    ...
    :goto_1
    iget-object v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:Landroid/support/v4/widget/O;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v3, v0, Landroid/support/v4/widget/SlidingPaneLayout;->p:Landroid/support/v4/widget/O;

    const/4 v4, 0x2

    invoke-virtual {v3, v4}, Landroid/support/v4/widget/O;->d(I)V
    ...
    invoke-virtual {v3, v2}, Landroid/support/v4/widget/O;->d(I)V
    ...
    iget-boolean v2, v14, Landroid/support/v4/widget/SlidingPaneLayout$d;->c:Z
    ...
    :goto_6
    iput-boolean v8, v14, Landroid/support/v4/widget/SlidingPaneLayout$d;->d:Z
    ...
    iget-boolean v1, v1, Landroid/support/v4/widget/SlidingPaneLayout$d;->d:Z
...
.method protected onMeasure(II)V
    ...
    iput-boolean v1, v7, Landroid/support/v4/widget/SlidingPaneLayout$d;->d:Z

    goto/16 :goto_8

    :cond_8
    iget v10, v7, Landroid/support/v4/widget/SlidingPaneLayout$d;->b:F
    ...
    iget-boolean v7, v7, Landroid/support/v4/widget/SlidingPaneLayout$d;->c:Z
    ...
    iget v7, v6, Landroid/support/v4/widget/SlidingPaneLayout$d;->b:F
    ...
    iget v10, v6, Landroid/support/v4/widget/SlidingPaneLayout$d;->b:F
    ...
    iget v6, v6, Landroid/support/v4/widget/SlidingPaneLayout$d;->b:F
    ...
    iget-object v1, v0, Landroid/support/v4/widget/SlidingPaneLayout;->p:Landroid/support/v4/widget/O;

    invoke-virtual {v1}, Landroid/support/v4/widget/O;->f()I
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/O;->a()V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:Landroid/support/v4/widget/O;
    ...
    invoke-virtual {v2, v3, v0, p1}, Landroid/support/v4/widget/O;->a(Landroid/view/View;II)Z
...
.method public setPanelSlideListener(Landroid/support/v4/widget/SlidingPaneLayout$e;)V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->o:Landroid/support/v4/widget/SlidingPaneLayout$e;
