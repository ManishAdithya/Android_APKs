...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserServiceCompat$j;Landroid/support/v4/media/MediaBrowserServiceCompat$k;Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/ResultReceiver;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/A;->e:Landroid/support/v4/media/MediaBrowserServiceCompat$j;

    iput-object p2, p0, Landroid/support/v4/media/A;->a:Landroid/support/v4/media/MediaBrowserServiceCompat$k;

    iput-object p3, p0, Landroid/support/v4/media/A;->b:Ljava/lang/String;

    iput-object p4, p0, Landroid/support/v4/media/A;->c:Landroid/os/Bundle;

    iput-object p5, p0, Landroid/support/v4/media/A;->d:Landroid/support/v4/os/ResultReceiver;
...
.method public run()V
    ...
    iget-object v0, p0, Landroid/support/v4/media/A;->a:Landroid/support/v4/media/MediaBrowserServiceCompat$k;

    invoke-interface {v0}, Landroid/support/v4/media/MediaBrowserServiceCompat$k;->asBinder()Landroid/os/IBinder;

    move-result-object v0

    iget-object v1, p0, Landroid/support/v4/media/A;->e:Landroid/support/v4/media/MediaBrowserServiceCompat$j;
    ...
    iget-object v1, p0, Landroid/support/v4/media/A;->b:Ljava/lang/String;
    ...
    iget-object v2, p0, Landroid/support/v4/media/A;->b:Ljava/lang/String;

    iget-object v3, p0, Landroid/support/v4/media/A;->c:Landroid/os/Bundle;

    iget-object v4, p0, Landroid/support/v4/media/A;->d:Landroid/support/v4/os/ResultReceiver;
