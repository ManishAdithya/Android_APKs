...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserCompat$i;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/d;->a:Landroid/support/v4/media/MediaBrowserCompat$i;
...
.method public run()V
    ...
    iget-object v1, p0, Landroid/support/v4/media/d;->a:Landroid/support/v4/media/MediaBrowserCompat$i;
    ...
    iget-object v1, v1, Landroid/support/v4/media/MediaBrowserCompat$i;->h:Landroid/support/v4/media/MediaBrowserCompat$i$a;
    ...
    iget-object v2, p0, Landroid/support/v4/media/d;->a:Landroid/support/v4/media/MediaBrowserCompat$i;

    iget-object v2, v2, Landroid/support/v4/media/MediaBrowserCompat$i;->h:Landroid/support/v4/media/MediaBrowserCompat$i$a;
    ...
    iput-object v3, v2, Landroid/support/v4/media/MediaBrowserCompat$i;->h:Landroid/support/v4/media/MediaBrowserCompat$i$a;

    const/4 v2, 0x0

    :try_start_0
    iget-object v3, p0, Landroid/support/v4/media/d;->a:Landroid/support/v4/media/MediaBrowserCompat$i;

    iget-object v3, v3, Landroid/support/v4/media/MediaBrowserCompat$i;->a:Landroid/content/Context;

    iget-object v4, p0, Landroid/support/v4/media/d;->a:Landroid/support/v4/media/MediaBrowserCompat$i;

    iget-object v4, v4, Landroid/support/v4/media/MediaBrowserCompat$i;->h:Landroid/support/v4/media/MediaBrowserCompat$i$a;
    ...
    iget-object v0, p0, Landroid/support/v4/media/d;->a:Landroid/support/v4/media/MediaBrowserCompat$i;
