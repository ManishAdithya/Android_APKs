...
.field m:Landroid/support/v4/widget/O;
...
.field private final z:Landroid/support/v4/widget/O$a;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/design/widget/BottomSheetBehavior;->z:Landroid/support/v4/widget/O$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v1, p0, Landroid/support/design/widget/BottomSheetBehavior;->z:Landroid/support/v4/widget/O$a;
...
.method a(Landroid/view/View;)Landroid/view/View;
    ...
    invoke-static {p1}, Landroid/support/v4/view/x;->z(Landroid/view/View;)Z
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;I)V
    ...
    :goto_0
    iget-object p4, p0, Landroid/support/design/widget/BottomSheetBehavior;->m:Landroid/support/v4/widget/O;

    invoke-virtual {p2}, Landroid/view/View;->getLeft()I

    move-result v1

    invoke-virtual {p4, p2, v1, p1}, Landroid/support/v4/widget/O;->b(Landroid/view/View;II)Z
    ...
    invoke-static {p2, p1}, Landroid/support/v4/view/x;->a(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;II[II)V
    ...
    invoke-static {p2, p3}, Landroid/support/v4/view/x;->b(Landroid/view/View;I)V
...
.method a(Landroid/view/View;I)V
    ...
    :goto_0
    iget-object v1, p0, Landroid/support/design/widget/BottomSheetBehavior;->m:Landroid/support/v4/widget/O;

    invoke-virtual {p1}, Landroid/view/View;->getLeft()I

    move-result v2

    invoke-virtual {v1, p1, v2, v0}, Landroid/support/v4/widget/O;->b(Landroid/view/View;II)Z
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    invoke-static {p2}, Landroid/support/v4/view/x;->h(Landroid/view/View;)Z
    ...
    invoke-static {p2, v0}, Landroid/support/v4/view/x;->b(Landroid/view/View;I)V

    :cond_8
    :goto_2
    iget-object p3, p0, Landroid/support/design/widget/BottomSheetBehavior;->m:Landroid/support/v4/widget/O;

    if-nez p3, :cond_9

    iget-object p3, p0, Landroid/support/design/widget/BottomSheetBehavior;->z:Landroid/support/v4/widget/O$a;

    invoke-static {p1, p3}, Landroid/support/v4/widget/O;->a(Landroid/view/ViewGroup;Landroid/support/v4/widget/O$a;)Landroid/support/v4/widget/O;

    move-result-object p1

    iput-object p1, p0, Landroid/support/design/widget/BottomSheetBehavior;->m:Landroid/support/v4/widget/O;
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-object p2, p0, Landroid/support/design/widget/BottomSheetBehavior;->m:Landroid/support/v4/widget/O;

    if-eqz p2, :cond_9

    invoke-virtual {p2, p3}, Landroid/support/v4/widget/O;->b(Landroid/view/MotionEvent;)Z
    ...
    iget-object p1, p0, Landroid/support/design/widget/BottomSheetBehavior;->m:Landroid/support/v4/widget/O;
    ...
    invoke-virtual {p2}, Landroid/support/v4/widget/O;->e()I
...
.method public b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/design/widget/BottomSheetBehavior;->m:Landroid/support/v4/widget/O;

    if-eqz v0, :cond_2

    invoke-virtual {v0, p3}, Landroid/support/v4/widget/O;->a(Landroid/view/MotionEvent;)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/O;->e()I
    ...
    invoke-virtual {p1, p2, p3}, Landroid/support/v4/widget/O;->a(Landroid/view/View;I)V
