...
.method constructor <init>(Landroid/support/design/widget/SwipeDismissBehavior;)V
    ...
    iput-object p1, p0, Landroid/support/design/widget/ga;->c:Landroid/support/design/widget/SwipeDismissBehavior;

    invoke-direct {p0}, Landroid/support/v4/widget/O$a;-><init>()V

    const/4 p1, -0x1

    iput p1, p0, Landroid/support/design/widget/ga;->b:I
...
.method private a(Landroid/view/View;F)Z
    ...
    :goto_0
    iget-object v4, p0, Landroid/support/design/widget/ga;->c:Landroid/support/design/widget/SwipeDismissBehavior;
    ...
    iget v0, p0, Landroid/support/design/widget/ga;->a:I
    ...
    iget-object v0, p0, Landroid/support/design/widget/ga;->c:Landroid/support/design/widget/SwipeDismissBehavior;
...
.method public a(Landroid/view/View;II)I
    ...
    :goto_0
    iget-object v1, p0, Landroid/support/design/widget/ga;->c:Landroid/support/design/widget/SwipeDismissBehavior;
    ...
    :cond_1
    iget p3, p0, Landroid/support/design/widget/ga;->a:I
    ...
    iget p1, p0, Landroid/support/design/widget/ga;->a:I
...
.method public a(Landroid/view/View;FF)V
    ...
    iput p3, p0, Landroid/support/design/widget/ga;->b:I

    invoke-virtual {p1}, Landroid/view/View;->getWidth()I

    move-result p3

    invoke-direct {p0, p1, p2}, Landroid/support/design/widget/ga;->a(Landroid/view/View;F)Z
    ...
    :goto_1
    iget-object p3, p0, Landroid/support/design/widget/ga;->c:Landroid/support/design/widget/SwipeDismissBehavior;

    iget-object p3, p3, Landroid/support/design/widget/SwipeDismissBehavior;->a:Landroid/support/v4/widget/O;

    invoke-virtual {p1}, Landroid/view/View;->getTop()I

    move-result v1

    invoke-virtual {p3, v0, v1}, Landroid/support/v4/widget/O;->d(II)Z
    ...
    invoke-static {p1, p3}, Landroid/support/v4/view/x;->a(Landroid/view/View;Ljava/lang/Runnable;)V
    ...
    iget-object p2, p0, Landroid/support/design/widget/ga;->c:Landroid/support/design/widget/SwipeDismissBehavior;
...
.method public a(Landroid/view/View;I)V
    ...
    iput p2, p0, Landroid/support/design/widget/ga;->b:I

    invoke-virtual {p1}, Landroid/view/View;->getLeft()I

    move-result p2

    iput p2, p0, Landroid/support/design/widget/ga;->a:I
...
.method public a(Landroid/view/View;IIII)V
    ...
    iget-object p5, p0, Landroid/support/design/widget/ga;->c:Landroid/support/design/widget/SwipeDismissBehavior;
    ...
    iget p4, p0, Landroid/support/design/widget/ga;->a:I
...
.method public b(Landroid/view/View;I)Z
    ...
    iget p2, p0, Landroid/support/design/widget/ga;->b:I
