...
.method private b(Ljava/lang/CharSequence;)Z
    ...
    sget-object v0, La/b/f/f/e;->d:La/b/f/f/d;
    ...
    invoke-interface {v0, p1, v1, v2}, La/b/f/f/d;->isRtl(Ljava/lang/CharSequence;II)Z
...
.method public a(I)V
    ...
    sget-object v1, La/b/g/a/j;->TextAppearance:[I

    invoke-static {v0, p1, v1}, Landroid/support/v7/widget/eb;->a(Landroid/content/Context;I[I)Landroid/support/v7/widget/eb;

    move-result-object v0

    sget v1, La/b/g/a/j;->TextAppearance_android_textColor:I

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/eb;->g(I)Z
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/eb;->a(I)Landroid/content/res/ColorStateList;
    ...
    :cond_0
    sget v1, La/b/g/a/j;->TextAppearance_android_textSize:I
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/eb;->c(II)I
    ...
    :cond_1
    sget v1, La/b/g/a/j;->TextAppearance_android_shadowColor:I

    const/4 v2, 0x0

    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/eb;->d(II)I

    move-result v1

    iput v1, p0, Landroid/support/design/widget/E;->Q:I

    sget v1, La/b/g/a/j;->TextAppearance_android_shadowDx:I

    const/4 v2, 0x0

    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/eb;->b(IF)F

    move-result v1

    iput v1, p0, Landroid/support/design/widget/E;->O:F

    sget v1, La/b/g/a/j;->TextAppearance_android_shadowDy:I
    ...
    sget v1, La/b/g/a/j;->TextAppearance_android_shadowRadius:I
...
.method public b(F)V
    ...
    invoke-static {p1, v0, v1}, La/b/f/c/a;->a(FFF)F
