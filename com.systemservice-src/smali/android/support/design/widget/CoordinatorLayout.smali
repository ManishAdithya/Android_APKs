...
.field private static final e:La/b/f/g/m;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "La/b/f/g/m<",
...
.field private s:Landroid/support/v4/view/M;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/design/widget/CoordinatorLayout;->e:La/b/f/g/m;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->g:Landroid/support/v4/widget/l;
    ...
    iput-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->x:Landroid/support/v4/view/o;
    ...
    invoke-direct {p0}, Landroid/support/design/widget/CoordinatorLayout;->i()V
...
.method private static a(Landroid/graphics/Rect;)V
    ...
    sget-object v0, Landroid/support/design/widget/CoordinatorLayout;->e:La/b/f/g/m;
...
.method private a(Landroid/view/View;Landroid/graphics/Rect;I)V
    ...
    invoke-static {p1}, Landroid/support/v4/view/x;->y(Landroid/view/View;)Z
    ...
    invoke-static {}, Landroid/support/design/widget/CoordinatorLayout;->g()Landroid/graphics/Rect;
...
.method private a(Z)V
    ...
    invoke-virtual {v4}, Landroid/support/design/widget/CoordinatorLayout$e;->d()Landroid/support/design/widget/CoordinatorLayout$b;
...
.method private a(Landroid/view/MotionEvent;I)Z
    ...
    invoke-virtual {v12}, Landroid/support/design/widget/CoordinatorLayout$e;->d()Landroid/support/design/widget/CoordinatorLayout$b;
    ...
    :cond_2
    invoke-virtual {v13, v0, v11, v10}, Landroid/support/design/widget/CoordinatorLayout$b;->b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z

    goto :goto_3

    :cond_3
    invoke-virtual {v13, v0, v11, v10}, Landroid/support/design/widget/CoordinatorLayout$b;->a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :cond_5
    invoke-virtual {v13, v0, v11, v1}, Landroid/support/design/widget/CoordinatorLayout$b;->b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :cond_6
    invoke-virtual {v13, v0, v11, v1}, Landroid/support/design/widget/CoordinatorLayout$b;->a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :cond_7
    invoke-virtual {v12}, Landroid/support/design/widget/CoordinatorLayout$e;->b()Z

    move-result v9

    invoke-virtual {v12, v0, v11}, Landroid/support/design/widget/CoordinatorLayout$e;->b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Z
...
.method private b(Landroid/support/v4/view/M;)Landroid/support/v4/view/M;
    .locals 4
    ...
    invoke-static {v2}, Landroid/support/v4/view/x;->h(Landroid/view/View;)Z
    ...
    invoke-virtual {v3}, Landroid/support/design/widget/CoordinatorLayout$e;->d()Landroid/support/design/widget/CoordinatorLayout$b;

    move-result-object v3

    if-eqz v3, :cond_1

    invoke-virtual {v3, p0, v2, p1}, Landroid/support/design/widget/CoordinatorLayout$b;->a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/support/v4/view/M;)Landroid/support/v4/view/M;
...
.method private d(Landroid/view/View;I)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/CoordinatorLayout;->s:Landroid/support/v4/view/M;

    if-eqz v1, :cond_0

    invoke-static {p0}, Landroid/support/v4/view/x;->h(Landroid/view/View;)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-static {p1}, Landroid/support/v4/view/x;->h(Landroid/view/View;)Z
    ...
    iget-object v2, p0, Landroid/support/design/widget/CoordinatorLayout;->s:Landroid/support/v4/view/M;
...
.method private e(Landroid/view/View;I)V
    ...
    invoke-static {p1, v1}, Landroid/support/v4/view/x;->a(Landroid/view/View;I)V
...
.method private e(Landroid/view/View;)Z
    ...
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->g:Landroid/support/v4/widget/l;

    invoke-virtual {v0, p1}, Landroid/support/v4/widget/l;->e(Ljava/lang/Object;)Z
...
.method private h()V
    ...
    invoke-virtual {p0, v3}, Landroid/support/design/widget/CoordinatorLayout;->d(Landroid/view/View;)Landroid/support/design/widget/CoordinatorLayout$e;

    move-result-object v4

    invoke-virtual {v4, p0, v3}, Landroid/support/design/widget/CoordinatorLayout$e;->a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Landroid/view/View;

    iget-object v5, p0, Landroid/support/design/widget/CoordinatorLayout;->g:Landroid/support/v4/widget/l;

    invoke-virtual {v5, v3}, Landroid/support/v4/widget/l;->a(Ljava/lang/Object;)V
    ...
    iget-object v7, p0, Landroid/support/design/widget/CoordinatorLayout;->g:Landroid/support/v4/widget/l;

    invoke-virtual {v7, v6}, Landroid/support/v4/widget/l;->b(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v7, v6}, Landroid/support/v4/widget/l;->a(Ljava/lang/Object;)V

    :cond_1
    iget-object v7, p0, Landroid/support/design/widget/CoordinatorLayout;->g:Landroid/support/v4/widget/l;

    invoke-virtual {v7, v6, v3}, Landroid/support/v4/widget/l;->a(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/CoordinatorLayout;->g:Landroid/support/v4/widget/l;

    invoke-virtual {v1}, Landroid/support/v4/widget/l;->b()Ljava/util/ArrayList;
...
# virtual methods
.method final a(Landroid/support/v4/view/M;)Landroid/support/v4/view/M;
    .locals 3

    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->s:Landroid/support/v4/view/M;

    invoke-static {v0, p1}, La/b/f/g/k;->a(Ljava/lang/Object;Ljava/lang/Object;)Z

    move-result v0

    if-nez v0, :cond_2

    iput-object p1, p0, Landroid/support/design/widget/CoordinatorLayout;->s:Landroid/support/v4/view/M;
    ...
    invoke-direct {p0, p1}, Landroid/support/design/widget/CoordinatorLayout;->b(Landroid/support/v4/view/M;)Landroid/support/v4/view/M;
...
.method final a(I)V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/x;->k(Landroid/view/View;)I
    ...
    invoke-virtual {v14}, Landroid/support/design/widget/CoordinatorLayout$e;->d()Landroid/support/design/widget/CoordinatorLayout$b;
    ...
    invoke-virtual {v14}, Landroid/support/design/widget/CoordinatorLayout$e;->e()Z

    move-result v16

    if-eqz v16, :cond_b

    invoke-virtual {v14}, Landroid/support/design/widget/CoordinatorLayout$e;->g()V
...
.method public a(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/l;->c(Ljava/lang/Object;)Ljava/util/List;
...
.method public a(Landroid/view/View;I)V
    ...
    invoke-virtual {v3, p2}, Landroid/support/design/widget/CoordinatorLayout$e;->a(I)Z
    ...
    :cond_1
    invoke-virtual {v3, p2}, Landroid/support/design/widget/CoordinatorLayout$e;->b(I)V

    invoke-virtual {v3}, Landroid/support/design/widget/CoordinatorLayout$e;->g()V
...
.method public a(Landroid/view/View;IIIII)V
    ...
    invoke-virtual {v1, v13}, Landroid/support/design/widget/CoordinatorLayout$e;->a(I)Z
    ...
    :cond_1
    invoke-virtual {v1}, Landroid/support/design/widget/CoordinatorLayout$e;->d()Landroid/support/design/widget/CoordinatorLayout$b;
...
.method public a(Landroid/view/View;II[II)V
    ...
    invoke-virtual {v1, v15}, Landroid/support/design/widget/CoordinatorLayout$e;->a(I)Z
...
.method a(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-static {p0, p1, p2}, Landroid/support/v4/widget/P;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method public a(Landroid/view/View;Landroid/view/View;II)Z
    ...
    invoke-virtual {v13}, Landroid/support/design/widget/CoordinatorLayout$e;->d()Landroid/support/design/widget/CoordinatorLayout$b;
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/support/design/widget/CoordinatorLayout$b;->b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;Landroid/view/View;II)Z
...
.method public b(Landroid/view/View;)Ljava/util/List;
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/l;->d(Ljava/lang/Object;)Ljava/util/List;
...
.method b(Landroid/view/View;I)V
    ...
    invoke-static {v9, v0}, Landroid/support/v4/view/x;->a(Landroid/view/View;I)V

    :cond_2
    if-eqz v1, :cond_3

    invoke-static {v9, v1}, Landroid/support/v4/view/x;->b(Landroid/view/View;I)V

    :cond_3
    if-eqz v14, :cond_4

    invoke-virtual {v10}, Landroid/support/design/widget/CoordinatorLayout$e;->d()Landroid/support/design/widget/CoordinatorLayout$b;
...
.method b(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p1}, Landroid/support/design/widget/CoordinatorLayout$e;->f()Landroid/graphics/Rect;
...
.method public b(Landroid/view/View;Landroid/view/View;II)V
    ...
    invoke-virtual {v2, p4}, Landroid/support/design/widget/CoordinatorLayout$e;->a(I)Z
    ...
    :cond_0
    invoke-virtual {v2}, Landroid/support/design/widget/CoordinatorLayout$e;->d()Landroid/support/design/widget/CoordinatorLayout$b;
    ...
    invoke-virtual/range {v2 .. v8}, Landroid/support/design/widget/CoordinatorLayout$b;->a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;Landroid/view/View;II)V
...
.method d(Landroid/view/View;)Landroid/support/design/widget/CoordinatorLayout$e;
    .locals 6
    ...
    :cond_1
    :goto_0
    iput-boolean v3, v0, Landroid/support/design/widget/CoordinatorLayout$e;->b:Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-virtual {v1, p0, p2}, Landroid/support/design/widget/CoordinatorLayout$b;->c(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)F
    ...
    invoke-virtual {v0, p0, p2}, Landroid/support/design/widget/CoordinatorLayout$b;->b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)I
...
.method e()V
    ...
    :cond_2
    invoke-virtual {p0}, Landroid/support/design/widget/CoordinatorLayout;->f()V
...
.method protected generateDefaultLayoutParams()Landroid/support/design/widget/CoordinatorLayout$e;
    .locals 2
...
.method protected bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, Landroid/support/design/widget/CoordinatorLayout;->generateDefaultLayoutParams()Landroid/support/design/widget/CoordinatorLayout$e;
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/support/design/widget/CoordinatorLayout$e;
    .locals 2
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/design/widget/CoordinatorLayout$e;
    .locals 1
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroid/support/design/widget/CoordinatorLayout;->generateLayoutParams(Landroid/util/AttributeSet;)Landroid/support/design/widget/CoordinatorLayout$e;
...
.method protected bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroid/support/design/widget/CoordinatorLayout;->generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/design/widget/CoordinatorLayout$e;
...
.method public final getLastWindowInsets()Landroid/support/v4/view/M;
    .locals 1
...
.method public onDetachedFromWindow()V
    ...
    iget-object v2, p0, Landroid/support/design/widget/CoordinatorLayout;->q:Landroid/support/design/widget/CoordinatorLayout$f;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/view/M;->e()I
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {p5}, Landroid/support/design/widget/CoordinatorLayout$e;->d()Landroid/support/design/widget/CoordinatorLayout$b;
    ...
    :cond_1
    invoke-virtual {p0, p4, p1}, Landroid/support/design/widget/CoordinatorLayout;->c(Landroid/view/View;I)V
...
.method protected onMeasure(II)V
    ...
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/CoordinatorLayout;->h()V
    ...
    iget-object v3, v7, Landroid/support/design/widget/CoordinatorLayout;->s:Landroid/support/v4/view/M;

    if-eqz v3, :cond_1

    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/x;->h(Landroid/view/View;)Z
    ...
    invoke-static {v11, v10}, Landroid/support/v4/view/d;->a(II)I
    ...
    invoke-static/range {v20 .. v20}, Landroid/support/v4/view/x;->h(Landroid/view/View;)Z

    move-result v0

    if-nez v0, :cond_a

    iget-object v0, v7, Landroid/support/design/widget/CoordinatorLayout;->s:Landroid/support/v4/view/M;

    invoke-virtual {v0}, Landroid/support/v4/view/M;->c()I

    move-result v0

    iget-object v2, v7, Landroid/support/design/widget/CoordinatorLayout;->s:Landroid/support/v4/view/M;
    ...
    iget-object v11, v7, Landroid/support/design/widget/CoordinatorLayout;->s:Landroid/support/v4/view/M;

    invoke-virtual {v11}, Landroid/support/v4/view/M;->b()I
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, v2}, Landroid/support/design/widget/CoordinatorLayout;->d(Landroid/view/View;)Landroid/support/design/widget/CoordinatorLayout$e;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual {v6}, Landroid/support/design/widget/CoordinatorLayout$e;->d()Landroid/support/design/widget/CoordinatorLayout$b;
    ...
    invoke-virtual {v6, p0, v4}, Landroid/support/design/widget/CoordinatorLayout$b;->d(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Landroid/os/Parcelable;
