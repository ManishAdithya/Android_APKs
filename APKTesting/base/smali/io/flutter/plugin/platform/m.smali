...
.field private q:Lio/flutter/plugin/platform/l;

.field private r:Landroid/view/ViewTreeObserver$OnGlobalFocusChangeListener;
...
.method public constructor <init>(Landroid/content/Context;Lio/flutter/plugin/platform/l;)V
    ...
    iput-object p2, p0, Lio/flutter/plugin/platform/m;->q:Lio/flutter/plugin/platform/l;
...
.method public a()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/m;->q:Lio/flutter/plugin/platform/l;
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/m;->q:Lio/flutter/plugin/platform/l;
...
.method public b(II)V
    ...
    invoke-interface {v0, p1, p2}, Lio/flutter/plugin/platform/l;->b(II)V
...
.method public c()V
    ...
    iget-object v1, p0, Lio/flutter/plugin/platform/m;->r:Landroid/view/ViewTreeObserver$OnGlobalFocusChangeListener;

    if-eqz v1, :cond_0

    const/4 v2, 0x0

    iput-object v2, p0, Lio/flutter/plugin/platform/m;->r:Landroid/view/ViewTreeObserver$OnGlobalFocusChangeListener;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Lio/flutter/plugin/platform/m;->q:Lio/flutter/plugin/platform/l;
    ...
    iget-object v2, p0, Lio/flutter/plugin/platform/m;->q:Lio/flutter/plugin/platform/l;
...
.method public getActiveFocusListener()Landroid/view/ViewTreeObserver$OnGlobalFocusChangeListener;
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/m;->r:Landroid/view/ViewTreeObserver$OnGlobalFocusChangeListener;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/m;->p:Lio/flutter/embedding/android/a;
    ...
    iget v2, p0, Lio/flutter/plugin/platform/m;->o:I

    goto :goto_0

    :cond_1
    iget v1, p0, Lio/flutter/plugin/platform/m;->l:I

    int-to-float v1, v1

    iget v2, p0, Lio/flutter/plugin/platform/m;->m:I
    ...
    iput v1, p0, Lio/flutter/plugin/platform/m;->l:I

    iget v1, p0, Lio/flutter/plugin/platform/m;->o:I

    iput v1, p0, Lio/flutter/plugin/platform/m;->m:I
    ...
    iput v2, p0, Lio/flutter/plugin/platform/m;->m:I
    ...
    :goto_1
    iget-object v1, p0, Lio/flutter/plugin/platform/m;->p:Lio/flutter/embedding/android/a;
...
.method public setLayoutParams(Landroid/widget/FrameLayout$LayoutParams;)V
    ...
    iput v0, p0, Lio/flutter/plugin/platform/m;->n:I

    iget p1, p1, Landroid/widget/FrameLayout$LayoutParams;->topMargin:I

    iput p1, p0, Lio/flutter/plugin/platform/m;->o:I
...
.method public setOnDescendantFocusChangeListener(Landroid/view/View$OnFocusChangeListener;)V
    ...
    iput-object v1, p0, Lio/flutter/plugin/platform/m;->r:Landroid/view/ViewTreeObserver$OnGlobalFocusChangeListener;
...
.method public setTouchProcessor(Lio/flutter/embedding/android/a;)V
    ...
    iput-object p1, p0, Lio/flutter/plugin/platform/m;->p:Lio/flutter/embedding/android/a;
