...
.method public constructor <init>(Landroid/content/Context;Landroid/view/Display;Lio/flutter/plugin/platform/g;Lio/flutter/plugin/platform/a;ILandroid/view/View$OnFocusChangeListener;)V
    ...
    invoke-static {p1, p3}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->b(Lio/flutter/plugin/platform/SingleViewPresentation$d;Lio/flutter/plugin/platform/g;)Lio/flutter/plugin/platform/g;
...
.method public getView()Lio/flutter/plugin/platform/g;
    ...
    invoke-static {v0}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->a(Lio/flutter/plugin/platform/SingleViewPresentation$d;)Lio/flutter/plugin/platform/g;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {p1}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->c(Lio/flutter/plugin/platform/SingleViewPresentation$d;)Lio/flutter/plugin/platform/u;
    ...
    invoke-direct {v0, v1}, Lio/flutter/plugin/platform/u;-><init>(Landroid/content/Context;)V

    invoke-static {p1, v0}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->d(Lio/flutter/plugin/platform/SingleViewPresentation$d;Lio/flutter/plugin/platform/u;)Lio/flutter/plugin/platform/u;
    ...
    invoke-static {v0}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->c(Lio/flutter/plugin/platform/SingleViewPresentation$d;)Lio/flutter/plugin/platform/u;

    move-result-object v2

    invoke-direct {v1, p1, v2}, Lio/flutter/plugin/platform/z;-><init>(Landroid/view/WindowManager;Lio/flutter/plugin/platform/u;)V
    ...
    invoke-static {v1}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->c(Lio/flutter/plugin/platform/SingleViewPresentation$d;)Lio/flutter/plugin/platform/u;
