...
.method constructor <init>(Lio/flutter/embedding/android/e$c;Lio/flutter/embedding/engine/d;)V
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/e;->l:Lio/flutter/embedding/engine/renderer/d;
...
.method private g(Lio/flutter/embedding/engine/d$b;)Lio/flutter/embedding/engine/d$b;
    ...
    invoke-virtual {v0}, La8/f;->k()Ljava/lang/String;
    ...
    invoke-direct {v1, v0, v2}, Ly7/a$c;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, Lio/flutter/embedding/android/e;->q(Landroid/content/Intent;)Ljava/lang/String;
    ...
    :cond_2
    invoke-virtual {p1, v1}, Lio/flutter/embedding/engine/d$b;->i(Ly7/a$c;)Lio/flutter/embedding/engine/d$b;
...
.method private j(Lio/flutter/embedding/android/k;)V
    .locals 2
...
.method private k()V
    ...
    invoke-static {v3, v2}, Lx7/b;->f(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, p0, Lio/flutter/embedding/android/e;->b:Lio/flutter/embedding/engine/a;

    invoke-virtual {v2}, Lio/flutter/embedding/engine/a;->o()Lj8/j;

    move-result-object v2

    invoke-virtual {v2, v0}, Lj8/j;->c(Ljava/lang/String;)V
    ...
    invoke-direct {v2, v0, v1, v3}, Ly7/a$c;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, v2}, Ly7/a;->k(Ly7/a$c;Ljava/util/List;)V
...
.method A(I[Ljava/lang/String;[I)V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->i()Ld8/b;

    move-result-object v0

    invoke-interface {v0, p1, p2, p3}, Ld8/b;->onRequestPermissionsResult(I[Ljava/lang/String;[I)Z
...
.method B(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1}, Lio/flutter/embedding/engine/a;->u()Lj8/o;

    move-result-object v1

    invoke-virtual {v1, v0}, Lj8/o;->j([B)V
    ...
    invoke-interface {v0, p1}, Ld8/b;->q(Landroid/os/Bundle;)V
...
.method C()V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->l()Lj8/g;
...
.method D(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->u()Lj8/o;

    move-result-object v0

    invoke-virtual {v0}, Lj8/o;->h()[B
    ...
    invoke-virtual {v1}, Lio/flutter/embedding/engine/a;->i()Ld8/b;

    move-result-object v1

    invoke-interface {v1, v0}, Ld8/b;->n(Landroid/os/Bundle;)V
...
.method G(I)V
    ...
    invoke-virtual {v0}, Ly7/a;->m()V

    iget-object v0, p0, Lio/flutter/embedding/android/e;->b:Lio/flutter/embedding/engine/a;

    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->x()Lj8/r;

    move-result-object v0

    invoke-virtual {v0}, Lj8/r;->a()V
...
.method J()V
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/e;->d:Lio/flutter/plugin/platform/d;
...
.method L(Landroid/window/BackEvent;)V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->j()Lj8/b;

    move-result-object v0

    invoke-virtual {v0, p1}, Lj8/b;->d(Landroid/window/BackEvent;)V
...
.method M(Landroid/window/BackEvent;)V
    ...
    invoke-virtual {v0, p1}, Lj8/b;->e(Landroid/window/BackEvent;)V
...
.method N()V
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/e;->d:Lio/flutter/plugin/platform/d;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lio/flutter/plugin/platform/d;->E()V
...
.method public bridge synthetic f()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lio/flutter/embedding/android/e;->m()Landroid/app/Activity;
...
.method r(IILandroid/content/Intent;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Ld8/b;->o(IILandroid/content/Intent;)Z
...
.method s(Landroid/content/Context;)V
    ...
    invoke-virtual {p1}, Lio/flutter/embedding/engine/a;->i()Ld8/b;

    move-result-object p1

    iget-object v0, p0, Lio/flutter/embedding/android/e;->a:Lio/flutter/embedding/android/e$c;

    invoke-interface {v0}, Lio/flutter/embedding/android/e$c;->a()Landroidx/lifecycle/h;

    move-result-object v0

    invoke-interface {p1, p0, v0}, Ld8/b;->s(Lio/flutter/embedding/android/b;Landroidx/lifecycle/h;)V
    ...
    invoke-interface {p1, v0, v1}, Lio/flutter/embedding/android/e$c;->u(Landroid/app/Activity;Lio/flutter/embedding/engine/a;)Lio/flutter/plugin/platform/d;

    move-result-object p1

    iput-object p1, p0, Lio/flutter/embedding/android/e;->d:Lio/flutter/plugin/platform/d;
...
.method t()V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->o()Lj8/j;

    move-result-object v0

    invoke-virtual {v0}, Lj8/j;->a()V
...
.method u(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;IZ)Landroid/view/View;
    ...
    invoke-static {p1, p2}, Lx7/b;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object p3, Lio/flutter/embedding/android/v;->l:Lio/flutter/embedding/android/v;
    ...
    invoke-interface {v2}, Lio/flutter/embedding/android/e$c;->C()Lio/flutter/embedding/android/w;

    move-result-object v2

    sget-object v3, Lio/flutter/embedding/android/w;->m:Lio/flutter/embedding/android/w;
    ...
    invoke-interface {p3}, Lio/flutter/embedding/android/e$c;->C()Lio/flutter/embedding/android/w;

    move-result-object p3

    sget-object v2, Lio/flutter/embedding/android/w;->l:Lio/flutter/embedding/android/w;
    ...
    iget-object p3, p0, Lio/flutter/embedding/android/e;->l:Lio/flutter/embedding/engine/renderer/d;

    invoke-virtual {p2, p3}, Lio/flutter/embedding/android/k;->l(Lio/flutter/embedding/engine/renderer/d;)V

    iget-object p2, p0, Lio/flutter/embedding/android/e;->a:Lio/flutter/embedding/android/e$c;

    invoke-interface {p2}, Lio/flutter/embedding/android/e$c;->A()Z
    ...
    invoke-virtual {p1, p2}, Lio/flutter/embedding/android/k;->n(Lio/flutter/embedding/engine/a;)V
    ...
    invoke-direct {p0, p1}, Lio/flutter/embedding/android/e;->j(Lio/flutter/embedding/android/k;)V
...
.method v()V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/e;->l:Lio/flutter/embedding/engine/renderer/d;

    invoke-virtual {v0, v1}, Lio/flutter/embedding/android/k;->y(Lio/flutter/embedding/engine/renderer/d;)V
...
.method w()V
    ...
    invoke-virtual {v0}, Lio/flutter/plugin/platform/d;->q()V

    iput-object v1, p0, Lio/flutter/embedding/android/e;->d:Lio/flutter/plugin/platform/d;
...
.method x(Landroid/content/Intent;)V
    ...
    invoke-interface {v0, p1}, Ld8/b;->p(Landroid/content/Intent;)V

    invoke-direct {p0, p1}, Lio/flutter/embedding/android/e;->q(Landroid/content/Intent;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1}, Lj8/j;->b(Ljava/lang/String;)V
