...
.method public static b(Ljava/util/Comparator;Ljava/lang/Iterable;)Z
    ...
    invoke-static {p1}, Lg4/q0;->a(Ljava/util/SortedSet;)Ljava/util/Comparator;
    ...
    :cond_0
    instance-of v0, p1, Lg4/p0;

    if-eqz v0, :cond_1

    check-cast p1, Lg4/p0;

    invoke-interface {p1}, Lg4/p0;->comparator()Ljava/util/Comparator;
