...
.method private m(Landroid/content/Intent;)V
    ...
    invoke-direct {v1, v0}, Lcom/google/firebase/messaging/m0;-><init>(Landroid/os/Bundle;)V
    ...
    invoke-direct {v3, p0, v1, v2}, Lcom/google/firebase/messaging/e;-><init>(Landroid/content/Context;Lcom/google/firebase/messaging/m0;Ljava/util/concurrent/ExecutorService;)V
    ...
    :cond_1
    invoke-static {p1}, Lcom/google/firebase/messaging/k0;->B(Landroid/content/Intent;)Z

    move-result v1

    if-eqz v1, :cond_2

    invoke-static {p1}, Lcom/google/firebase/messaging/k0;->t(Landroid/content/Intent;)V
    ...
    invoke-direct {p1, v0}, Lcom/google/firebase/messaging/s0;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {p0, p1}, Lcom/google/firebase/messaging/FirebaseMessagingService;->r(Lcom/google/firebase/messaging/s0;)V
...
.method private o(Landroid/content/Context;)Lz2/d;
    .locals 1

    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->q:Lz2/d;
    ...
    invoke-direct {v0, p1}, Lz2/d;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->q:Lz2/d;

    :cond_0
    iget-object p1, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->q:Lz2/d;
...
.method private p(Landroid/content/Intent;)V
    ...
    :cond_0
    invoke-direct {p0, p0}, Lcom/google/firebase/messaging/FirebaseMessagingService;->o(Landroid/content/Context;)Lz2/d;

    move-result-object v0

    new-instance v1, Lz2/a;

    invoke-direct {v1, p1}, Lz2/a;-><init>(Landroid/content/Intent;)V

    invoke-virtual {v0, v1}, Lz2/d;->b(Lz2/a;)Le4/j;
...
.method private v(Landroid/content/Intent;)V
    ...
    invoke-direct {v1, p1}, Lcom/google/firebase/messaging/w0;-><init>(Ljava/lang/String;)V
...
.method protected e(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    invoke-virtual {p1}, Lcom/google/firebase/messaging/x0;->c()Landroid/content/Intent;
...
.method public r(Lcom/google/firebase/messaging/s0;)V
    .locals 0
