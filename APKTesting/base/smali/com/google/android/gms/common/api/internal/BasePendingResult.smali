...
.method private final e()Lb3/k;
    ...
    invoke-static {v1, v3}, Ld3/p;->p(ZLjava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lb3/k;

    const/4 v3, 0x0

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lb3/k;

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Lb3/l;
...
.method private final f(Lb3/k;)V
    .locals 4

    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lb3/k;

    invoke-interface {p1}, Lb3/k;->d()Lcom/google/android/gms/common/api/Status;
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->m:Ld3/k;
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Lb3/l;

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Lb3/l;

    if-nez v0, :cond_1

    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lb3/k;
    ...
    invoke-direct {v0, p0, p1}, Lcom/google/android/gms/common/api/internal/m0;-><init>(Lcom/google/android/gms/common/api/internal/BasePendingResult;Lc3/f0;)V

    iput-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->mResultGuardian:Lcom/google/android/gms/common/api/internal/m0;
    ...
    invoke-direct {p0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->e()Lb3/k;

    move-result-object v1

    invoke-virtual {p1, v0, v1}, Lcom/google/android/gms/common/api/internal/BasePendingResult$a;->a(Lb3/l;Lb3/k;)V
...
.method static bridge synthetic g(Lcom/google/android/gms/common/api/internal/BasePendingResult;)Lb3/k;
    .locals 0

    iget-object p0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lb3/k;

    return-object p0
.end method

.method public static h(Lb3/k;)V
    .locals 2
    ...
    invoke-interface {v0}, Lb3/h;->release()V
    :try_end_0
...
# virtual methods
.method protected abstract a(Lcom/google/android/gms/common/api/Status;)Lb3/k;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final b(Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->a(Lcom/google/android/gms/common/api/Status;)Lb3/k;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->d(Lb3/k;)V
...
.method public final d(Lb3/k;)V
    ...
    invoke-static {v1, v2}, Ld3/p;->p(ZLjava/lang/Object;)V
    ...
    invoke-direct {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f(Lb3/k;)V
    ...
    :cond_0
    invoke-static {p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h(Lb3/k;)V
