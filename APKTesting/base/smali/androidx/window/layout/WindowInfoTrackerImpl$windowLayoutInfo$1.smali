...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/window/layout/WindowInfoTrackerImpl;->windowLayoutInfo(Landroid/app/Activity;)Lbb/b;
.end annotation
...
# direct methods
.method constructor <init>(Landroidx/window/layout/WindowInfoTrackerImpl;Landroid/app/Activity;Lha/d;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static synthetic a(Lab/d;Landroidx/window/layout/WindowLayoutInfo;)V
    .locals 0

    invoke-static {p0, p1}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->invokeSuspend$lambda-0(Lab/d;Landroidx/window/layout/WindowLayoutInfo;)V

    return-void
.end method

.method private static final invokeSuspend$lambda-0(Lab/d;Landroidx/window/layout/WindowLayoutInfo;)V
    .locals 1
    ...
    invoke-interface {p0, p1}, Lab/n;->d(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final create(Ljava/lang/Object;Lha/d;)Lha/d;
    ...
    invoke-direct {v0, v1, v2, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;-><init>(Landroidx/window/layout/WindowInfoTrackerImpl;Landroid/app/Activity;Lha/d;)V
...
.method public final invoke(Lbb/c;Lha/d;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->create(Ljava/lang/Object;Lha/d;)Lha/d;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->invoke(Lbb/c;Lha/d;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v4, Lab/a;->m:Lab/a;

    const/4 v5, 0x4

    const/4 v6, 0x0

    invoke-static {v1, v4, v6, v5, v6}, Lab/f;->b(ILab/a;Loa/l;ILjava/lang/Object;)Lab/d;

    move-result-object v1

    new-instance v4, Landroidx/window/layout/c;

    invoke-direct {v4, v1}, Landroidx/window/layout/c;-><init>(Lab/d;)V
    ...
    sget-object v7, Landroidx/profileinstaller/g;->l:Landroidx/profileinstaller/g;

    invoke-interface {v5, v6, v7, v4}, Landroidx/window/layout/WindowBackend;->registerLayoutChangeCallback(Landroid/app/Activity;Ljava/util/concurrent/Executor;Lx/a;)V

    :try_start_2
    invoke-interface {v1}, Lab/m;->iterator()Lab/e;
    ...
    invoke-interface {v1, v5}, Lab/e;->a(Lha/d;)Ljava/lang/Object;
    ...
    invoke-interface {v1}, Lab/e;->next()Ljava/lang/Object;
    ...
    invoke-interface {v6, p1, v5}, Lbb/c;->emit(Ljava/lang/Object;Lha/d;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v4}, Landroidx/window/layout/WindowBackend;->unregisterLayoutChangeCallback(Lx/a;)V
    ...
    invoke-interface {v0, v4}, Landroidx/window/layout/WindowBackend;->unregisterLayoutChangeCallback(Lx/a;)V
