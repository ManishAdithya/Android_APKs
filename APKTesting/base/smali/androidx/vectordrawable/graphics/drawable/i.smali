...
# instance fields
.field private m:Landroidx/vectordrawable/graphics/drawable/i$h;
...
.field private r:Landroid/graphics/drawable/Drawable$ConstantState;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/vectordrawable/graphics/drawable/i;->v:Landroid/graphics/PorterDuff$Mode;
...
.method constructor <init>()V
    ...
    iput-boolean v0, p0, Landroidx/vectordrawable/graphics/drawable/i;->q:Z

    const/16 v0, 0x9

    new-array v0, v0, [F

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i;->s:[F

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i;->t:Landroid/graphics/Matrix;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i;->u:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i;->m:Landroidx/vectordrawable/graphics/drawable/i$h;
...
.method constructor <init>(Landroidx/vectordrawable/graphics/drawable/i$h;)V
    ...
    iput-object p1, p0, Landroidx/vectordrawable/graphics/drawable/i;->m:Landroidx/vectordrawable/graphics/drawable/i$h;

    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i;->n:Landroid/graphics/PorterDuffColorFilter;
    ...
    iput-object p1, p0, Landroidx/vectordrawable/graphics/drawable/i;->n:Landroid/graphics/PorterDuffColorFilter;
...
.method public static b(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroidx/vectordrawable/graphics/drawable/i;
    ...
    iput-object p0, v0, Landroidx/vectordrawable/graphics/drawable/h;->l:Landroid/graphics/drawable/Drawable;

    new-instance p0, Landroidx/vectordrawable/graphics/drawable/i$i;

    iget-object p1, v0, Landroidx/vectordrawable/graphics/drawable/h;->l:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p0, v0, Landroidx/vectordrawable/graphics/drawable/i;->r:Landroid/graphics/drawable/Drawable$ConstantState;
...
.method private e(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i;->m:Landroidx/vectordrawable/graphics/drawable/i$h;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i;->u:Landroid/graphics/Rect;
    ...
    :cond_1
    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i;->o:Landroid/graphics/ColorFilter;
    ...
    :cond_2
    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/i;->t:Landroid/graphics/Matrix;

    invoke-virtual {p1, v1}, Landroid/graphics/Canvas;->getMatrix(Landroid/graphics/Matrix;)V

    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/i;->t:Landroid/graphics/Matrix;

    iget-object v2, p0, Landroidx/vectordrawable/graphics/drawable/i;->s:[F

    invoke-virtual {v1, v2}, Landroid/graphics/Matrix;->getValues([F)V

    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/i;->s:[F
    ...
    iget-object v3, p0, Landroidx/vectordrawable/graphics/drawable/i;->s:[F
    ...
    iget-object v4, p0, Landroidx/vectordrawable/graphics/drawable/i;->s:[F
    ...
    iget-object v5, p0, Landroidx/vectordrawable/graphics/drawable/i;->s:[F
    ...
    :cond_4
    iget-object v4, p0, Landroidx/vectordrawable/graphics/drawable/i;->u:Landroid/graphics/Rect;
    ...
    iget-object v5, p0, Landroidx/vectordrawable/graphics/drawable/i;->u:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Landroidx/vectordrawable/graphics/drawable/i;->m:Landroidx/vectordrawable/graphics/drawable/i$h;

    invoke-virtual {v2, v1, v3}, Landroidx/vectordrawable/graphics/drawable/i$h;->c(II)V

    iget-boolean v2, p0, Landroidx/vectordrawable/graphics/drawable/i;->q:Z
    ...
    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/i;->m:Landroidx/vectordrawable/graphics/drawable/i$h;
    ...
    iget-object v2, p0, Landroidx/vectordrawable/graphics/drawable/i;->u:Landroid/graphics/Rect;
...
.method h(Z)V
    ...
    iput-boolean p1, p0, Landroidx/vectordrawable/graphics/drawable/i;->q:Z
...
.method public inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iget-object p1, p0, Landroidx/vectordrawable/graphics/drawable/i;->n:Landroid/graphics/PorterDuffColorFilter;
...
.method public mutate()Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-boolean v0, p0, Landroidx/vectordrawable/graphics/drawable/i;->p:Z
    ...
    iput-boolean v0, p0, Landroidx/vectordrawable/graphics/drawable/i;->p:Z
...
.method protected onStateChange([I)Z
    ...
    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i;->n:Landroid/graphics/PorterDuffColorFilter;
...
.method public setColorFilter(Landroid/graphics/ColorFilter;)V
    ...
    :cond_0
    iput-object p1, p0, Landroidx/vectordrawable/graphics/drawable/i;->o:Landroid/graphics/ColorFilter;
...
.method public setTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/i;->n:Landroid/graphics/PorterDuffColorFilter;
