...
# direct methods
.method constructor <init>(Landroid/content/Context;Lw/f;Landroidx/emoji2/text/j$a;)V
    .locals 1
    ...
    invoke-static {p2, v0}, Lx/h;->k(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object p2, p0, Landroidx/emoji2/text/j$b;->b:Lw/f;
...
.method private e()Lw/h$b;
    ...
    iget-object v2, p0, Landroidx/emoji2/text/j$b;->b:Lw/f;

    invoke-virtual {v0, v1, v2}, Landroidx/emoji2/text/j$a;->b(Landroid/content/Context;Lw/f;)Lw/h$a;

    move-result-object v0
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0

    invoke-virtual {v0}, Lw/h$a;->c()I

    move-result v1

    if-nez v1, :cond_1

    invoke-virtual {v0}, Lw/h$a;->b()[Lw/h$b;
...
.method c()V
    ...
    :try_start_1
    invoke-direct {p0}, Landroidx/emoji2/text/j$b;->e()Lw/h$b;

    move-result-object v0

    invoke-virtual {v0}, Lw/h$b;->b()I
    ...
    invoke-virtual {v1, v2, v0}, Landroidx/emoji2/text/j$a;->a(Landroid/content/Context;Lw/h$b;)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v0}, Lw/h$b;->d()Landroid/net/Uri;
