...
.field J:Landroid/view/ViewTreeObserver;
...
.field private final w:Landroidx/appcompat/widget/o0;
...
.method static constructor <clinit>()V
    ...
    sput v0, Landroidx/appcompat/view/menu/d;->M:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->s:Ljava/util/List;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->u:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->v:Landroid/view/View$OnAttachStateChangeListener;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->w:Landroidx/appcompat/widget/o0;
...
.method private A(Landroidx/appcompat/view/menu/g;)I
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/d;->t:Ljava/util/List;
...
.method private E(I)I
    ...
    iget-object v4, p0, Landroidx/appcompat/view/menu/d;->A:Landroid/view/View;

    invoke-virtual {v4, v3}, Landroid/view/View;->getWindowVisibleDisplayFrame(Landroid/graphics/Rect;)V

    iget v4, p0, Landroidx/appcompat/view/menu/d;->B:I
...
.method private F(Landroidx/appcompat/view/menu/g;)V
    ...
    iget-boolean v2, p0, Landroidx/appcompat/view/menu/d;->q:Z

    sget v3, Landroidx/appcompat/view/menu/d;->M:I
    ...
    :cond_1
    :goto_0
    iget-object v2, p0, Landroidx/appcompat/view/menu/d;->m:Landroid/content/Context;

    iget v4, p0, Landroidx/appcompat/view/menu/d;->n:I
    ...
    invoke-direct {p0}, Landroidx/appcompat/view/menu/d;->z()Landroidx/appcompat/widget/p0;

    move-result-object v4

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/n0;->p(Landroid/widget/ListAdapter;)V

    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/n0;->B(I)V

    iget v1, p0, Landroidx/appcompat/view/menu/d;->y:I

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/n0;->C(I)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->t:Ljava/util/List;
    ...
    invoke-virtual {v4, v7}, Landroidx/appcompat/widget/p0;->Q(Z)V

    invoke-virtual {v4, v5}, Landroidx/appcompat/widget/p0;->N(Ljava/lang/Object;)V
    ...
    :goto_2
    iput v8, p0, Landroidx/appcompat/view/menu/d;->B:I
    ...
    invoke-virtual {v4, v6}, Landroidx/appcompat/widget/n0;->z(Landroid/view/View;)V
    ...
    iget-object v12, p0, Landroidx/appcompat/view/menu/d;->z:Landroid/view/View;
    ...
    iget v12, p0, Landroidx/appcompat/view/menu/d;->y:I
    ...
    iget-object v13, p0, Landroidx/appcompat/view/menu/d;->z:Landroid/view/View;
    ...
    :goto_3
    iget v10, p0, Landroidx/appcompat/view/menu/d;->y:I
    ...
    :goto_6
    invoke-virtual {v4, v12}, Landroidx/appcompat/widget/n0;->l(I)V

    invoke-virtual {v4, v3}, Landroidx/appcompat/widget/n0;->I(Z)V

    invoke-virtual {v4, v8}, Landroidx/appcompat/widget/n0;->j(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/n0;->l(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/n0;->j(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/n0;->D(Landroid/graphics/Rect;)V

    :goto_7
    new-instance v2, Landroidx/appcompat/view/menu/d$d;

    iget v3, p0, Landroidx/appcompat/view/menu/d;->B:I
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/d;->t:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v4}, Landroidx/appcompat/widget/n0;->a()V

    invoke-virtual {v4}, Landroidx/appcompat/widget/n0;->g()Landroid/widget/ListView;
...
.method private z()Landroidx/appcompat/widget/p0;
    .locals 5

    new-instance v0, Landroidx/appcompat/widget/p0;

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->m:Landroid/content/Context;

    iget v2, p0, Landroidx/appcompat/view/menu/d;->o:I

    iget v3, p0, Landroidx/appcompat/view/menu/d;->p:I

    const/4 v4, 0x0

    invoke-direct {v0, v1, v4, v2, v3}, Landroidx/appcompat/widget/p0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->w:Landroidx/appcompat/widget/o0;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/p0;->P(Landroidx/appcompat/widget/o0;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/n0;->H(Landroid/widget/AdapterView$OnItemClickListener;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/n0;->G(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->z:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/n0;->z(Landroid/view/View;)V

    iget v1, p0, Landroidx/appcompat/view/menu/d;->y:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/n0;->C(I)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/n0;->E(I)V
...
.method public a()V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/appcompat/view/menu/d;->s:Ljava/util/List;
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->u:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->v:Landroid/view/View$OnAttachStateChangeListener;
...
.method public b(Landroidx/appcompat/view/menu/g;Z)V
    ...
    iget-boolean v1, p0, Landroidx/appcompat/view/menu/d;->L:Z
    ...
    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/p0;->O(Ljava/lang/Object;)V

    iget-object v1, v0, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/p0;

    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/n0;->A(I)V
    ...
    :goto_0
    iput v1, p0, Landroidx/appcompat/view/menu/d;->B:I

    if-nez v0, :cond_7

    invoke-virtual {p0}, Landroidx/appcompat/view/menu/d;->dismiss()V

    iget-object p2, p0, Landroidx/appcompat/view/menu/d;->I:Landroidx/appcompat/view/menu/m$a;
    ...
    iget-object p2, p0, Landroidx/appcompat/view/menu/d;->u:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;

    invoke-virtual {p1, p2}, Landroid/view/ViewTreeObserver;->removeGlobalOnLayoutListener(Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    :cond_5
    iput-object v2, p0, Landroidx/appcompat/view/menu/d;->J:Landroid/view/ViewTreeObserver;

    :cond_6
    iget-object p1, p0, Landroidx/appcompat/view/menu/d;->A:Landroid/view/View;

    iget-object p2, p0, Landroidx/appcompat/view/menu/d;->v:Landroid/view/View$OnAttachStateChangeListener;
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/d;->t:Ljava/util/List;
...
.method public dismiss()V
    ...
    invoke-virtual {v3}, Landroidx/appcompat/widget/n0;->c()Z
...
.method public e(Landroidx/appcompat/view/menu/r;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/d;->I:Landroidx/appcompat/view/menu/m$a;
...
.method public k(Landroidx/appcompat/view/menu/m$a;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/d;->I:Landroidx/appcompat/view/menu/m$a;
...
.method public p(Landroid/view/View;)V
    ...
    invoke-static {p1}, Landroidx/core/view/f0;->p(Landroid/view/View;)I
