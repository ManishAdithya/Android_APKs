...
.method private static d(Landroid/widget/TextView;)Landroid/text/TextDirectionHeuristic;
    ...
    invoke-static {p0}, Landroidx/core/widget/h$b;->a(Ljava/util/Locale;)Landroid/icu/text/DecimalFormatSymbols;

    move-result-object p0

    invoke-static {p0}, Landroidx/core/widget/h$c;->b(Landroid/icu/text/DecimalFormatSymbols;)[Ljava/lang/String;
...
.method public static e(Landroid/widget/TextView;)Landroidx/core/text/b$a;
    ...
    invoke-static {p0}, Landroidx/core/widget/h$c;->c(Landroid/widget/TextView;)Landroid/text/PrecomputedText$Params;
    ...
    invoke-static {p0}, Landroidx/core/widget/h$a;->a(Landroid/widget/TextView;)I

    move-result v0

    invoke-virtual {v1, v0}, Landroidx/core/text/b$a$a;->b(I)Landroidx/core/text/b$a$a;

    invoke-static {p0}, Landroidx/core/widget/h$a;->d(Landroid/widget/TextView;)I
...
.method public static f(Landroid/widget/TextView;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p0, p1}, Landroidx/core/widget/h$a;->f(Landroid/widget/TextView;Landroid/content/res/ColorStateList;)V
...
.method public static g(Landroid/widget/TextView;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p0, p1}, Landroidx/core/widget/h$a;->g(Landroid/widget/TextView;Landroid/graphics/PorterDuff$Mode;)V
...
.method public static h(Landroid/widget/TextView;I)V
    ...
    invoke-static {p0, p1}, Landroidx/core/widget/h$c;->d(Landroid/widget/TextView;I)V
...
.method public static k(Landroid/widget/TextView;Landroidx/core/text/b;)V
    .locals 2
    ...
    invoke-static {p1}, Landroidx/core/widget/h$c;->a(Landroid/text/PrecomputedText;)Ljava/lang/CharSequence;
...
.method public static l(Landroid/widget/TextView;Landroidx/core/text/b$a;)V
    .locals 2
    ...
    invoke-static {v0}, Landroidx/core/widget/h;->c(Landroid/text/TextDirectionHeuristic;)I
    ...
    invoke-static {p0, v0}, Landroidx/core/widget/h$a;->e(Landroid/widget/TextView;I)V

    invoke-virtual {p1}, Landroidx/core/text/b$a;->c()I

    move-result p1

    invoke-static {p0, p1}, Landroidx/core/widget/h$a;->h(Landroid/widget/TextView;I)V
...
.method public static m(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode$Callback;
    ...
    instance-of v0, p0, Landroidx/core/widget/h$d;
    ...
    check-cast p0, Landroidx/core/widget/h$d;

    invoke-virtual {p0}, Landroidx/core/widget/h$d;->d()Landroid/view/ActionMode$Callback;
...
.method public static n(Landroid/widget/TextView;Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode$Callback;
    ...
    instance-of v0, p1, Landroidx/core/widget/h$d;
    ...
    :cond_0
    new-instance v0, Landroidx/core/widget/h$d;

    invoke-direct {v0, p1, p0}, Landroidx/core/widget/h$d;-><init>(Landroid/view/ActionMode$Callback;Landroid/widget/TextView;)V
