...
.method public getAccessibilityNodeProvider(Landroid/view/View;)Landroid/view/accessibility/AccessibilityNodeProvider;
    ...
    invoke-virtual {v0, p1}, Landroidx/core/view/a;->b(Landroid/view/View;)Ly/c;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Ly/c;->a()Ljava/lang/Object;
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/View;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-static {p2}, Ly/b;->d0(Landroid/view/accessibility/AccessibilityNodeInfo;)Ly/b;
    ...
    invoke-virtual {v0, v1}, Ly/b;->Z(Z)V

    invoke-static {p1}, Landroidx/core/view/f0;->x(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v0, v1}, Ly/b;->X(Z)V

    invoke-static {p1}, Landroidx/core/view/f0;->l(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Ly/b;->Y(Ljava/lang/CharSequence;)V

    invoke-static {p1}, Landroidx/core/view/f0;->t(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Ly/b;->b0(Ljava/lang/CharSequence;)V

    iget-object v1, p0, Landroidx/core/view/a$a;->a:Landroidx/core/view/a;

    invoke-virtual {v1, p1, v0}, Landroidx/core/view/a;->g(Landroid/view/View;Ly/b;)V

    invoke-virtual {p2}, Landroid/view/accessibility/AccessibilityNodeInfo;->getText()Ljava/lang/CharSequence;

    move-result-object p2

    invoke-virtual {v0, p2, p1}, Ly/b;->c(Ljava/lang/CharSequence;Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Ly/b;->a(Ly/b$a;)V
