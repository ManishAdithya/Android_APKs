...
.method public constructor <init>(Landroid/widget/TextView;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/z;->i:Landroidx/appcompat/widget/c0;
...
.method public b()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/z;->b:Landroidx/appcompat/widget/x0;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/z;->c:Landroidx/appcompat/widget/x0;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/z;->d:Landroidx/appcompat/widget/x0;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/z;->e:Landroidx/appcompat/widget/x0;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/z;->b:Landroidx/appcompat/widget/x0;

    invoke-virtual {p0, v3, v4}, Landroidx/appcompat/widget/z;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/x0;)V

    const/4 v3, 0x1

    aget-object v3, v0, v3

    iget-object v4, p0, Landroidx/appcompat/widget/z;->c:Landroidx/appcompat/widget/x0;

    invoke-virtual {p0, v3, v4}, Landroidx/appcompat/widget/z;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/x0;)V

    aget-object v3, v0, v1

    iget-object v4, p0, Landroidx/appcompat/widget/z;->d:Landroidx/appcompat/widget/x0;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/z;->e:Landroidx/appcompat/widget/x0;

    invoke-virtual {p0, v0, v3}, Landroidx/appcompat/widget/z;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/x0;)V

    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/z;->f:Landroidx/appcompat/widget/x0;

    if-nez v0, :cond_2

    iget-object v0, p0, Landroidx/appcompat/widget/z;->g:Landroidx/appcompat/widget/x0;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/z;->f:Landroidx/appcompat/widget/x0;

    invoke-virtual {p0, v2, v3}, Landroidx/appcompat/widget/z;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/x0;)V

    aget-object v0, v0, v1

    iget-object v1, p0, Landroidx/appcompat/widget/z;->g:Landroidx/appcompat/widget/x0;

    invoke-virtual {p0, v0, v1}, Landroidx/appcompat/widget/z;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/x0;)V
...
.method public d()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/z;->i:Landroidx/appcompat/widget/c0;

    .line 1
    invoke-virtual {v0}, Landroidx/appcompat/widget/c0;->i()Z
...
.method public e(Landroid/util/AttributeSet;I)V
    ...
    iget-object v1, v0, Landroidx/appcompat/widget/z;->a:Landroid/widget/TextView;
    ...
    .line 2
    invoke-static/range {v1 .. v7}, Lg0/o;->s(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V
    ...
    invoke-static {v10, v11, v2}, Landroidx/appcompat/widget/z;->c(Landroid/content/Context;Landroidx/appcompat/widget/j;I)Landroidx/appcompat/widget/x0;

    move-result-object v2

    iput-object v2, v0, Landroidx/appcompat/widget/z;->b:Landroidx/appcompat/widget/x0;
    ...
    iput-object v2, v0, Landroidx/appcompat/widget/z;->c:Landroidx/appcompat/widget/x0;
    ...
    iput-object v2, v0, Landroidx/appcompat/widget/z;->d:Landroidx/appcompat/widget/x0;
    ...
    iput-object v2, v0, Landroidx/appcompat/widget/z;->e:Landroidx/appcompat/widget/x0;
    ...
    invoke-static {v10, v11, v3}, Landroidx/appcompat/widget/z;->c(Landroid/content/Context;Landroidx/appcompat/widget/j;I)Landroidx/appcompat/widget/x0;

    move-result-object v3

    iput-object v3, v0, Landroidx/appcompat/widget/z;->f:Landroidx/appcompat/widget/x0;
    ...
    invoke-static {v10, v11, v5}, Landroidx/appcompat/widget/z;->c(Landroid/content/Context;Landroidx/appcompat/widget/j;I)Landroidx/appcompat/widget/x0;

    move-result-object v5

    iput-object v5, v0, Landroidx/appcompat/widget/z;->g:Landroidx/appcompat/widget/x0;
    ...
    .line 4
    iget-object v5, v0, Landroidx/appcompat/widget/z;->a:Landroid/widget/TextView;
    ...
    invoke-direct {v14, v10, v1}, Landroidx/appcompat/widget/z0;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    if-nez v5, :cond_6

    .line 6
    invoke-virtual {v14, v3}, Landroidx/appcompat/widget/z0;->o(I)Z

    move-result v7

    if-eqz v7, :cond_6

    invoke-virtual {v14, v3, v12}, Landroidx/appcompat/widget/z0;->a(IZ)Z
    ...
    :goto_0
    invoke-virtual {v0, v10, v14}, Landroidx/appcompat/widget/z;->m(Landroid/content/Context;Landroidx/appcompat/widget/z0;)V

    if-ge v2, v13, :cond_9

    invoke-virtual {v14, v15}, Landroidx/appcompat/widget/z0;->o(I)Z

    move-result v22

    if-eqz v22, :cond_7

    invoke-virtual {v14, v15}, Landroidx/appcompat/widget/z0;->c(I)Landroid/content/res/ColorStateList;
    ...
    :goto_1
    invoke-virtual {v14, v6}, Landroidx/appcompat/widget/z0;->o(I)Z

    move-result v23

    if-eqz v23, :cond_8

    invoke-virtual {v14, v6}, Landroidx/appcompat/widget/z0;->c(I)Landroid/content/res/ColorStateList;
    ...
    :goto_2
    invoke-virtual {v14, v4}, Landroidx/appcompat/widget/z0;->o(I)Z

    move-result v24

    if-eqz v24, :cond_a

    invoke-virtual {v14, v4}, Landroidx/appcompat/widget/z0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v14, v4}, Landroidx/appcompat/widget/z0;->m(I)Ljava/lang/String;
    ...
    invoke-direct {v4, v10, v1}, Landroidx/appcompat/widget/z0;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    if-nez v5, :cond_e

    .line 10
    invoke-virtual {v4, v3}, Landroidx/appcompat/widget/z0;->o(I)Z

    move-result v27

    if-eqz v27, :cond_e

    invoke-virtual {v4, v3, v12}, Landroidx/appcompat/widget/z0;->a(IZ)Z
    ...
    invoke-virtual {v4, v15}, Landroidx/appcompat/widget/z0;->o(I)Z

    move-result v13

    if-eqz v13, :cond_f

    invoke-virtual {v4, v15}, Landroidx/appcompat/widget/z0;->c(I)Landroid/content/res/ColorStateList;

    move-result-object v22

    :cond_f
    invoke-virtual {v4, v6}, Landroidx/appcompat/widget/z0;->o(I)Z

    move-result v13

    if-eqz v13, :cond_10

    invoke-virtual {v4, v6}, Landroidx/appcompat/widget/z0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v4, v13}, Landroidx/appcompat/widget/z0;->o(I)Z

    move-result v25

    if-eqz v25, :cond_11

    invoke-virtual {v4, v13}, Landroidx/appcompat/widget/z0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v4, v15}, Landroidx/appcompat/widget/z0;->m(I)Ljava/lang/String;
    ...
    invoke-virtual {v4, v12}, Landroidx/appcompat/widget/z0;->o(I)Z

    move-result v20

    if-eqz v20, :cond_14

    invoke-virtual {v4, v12}, Landroidx/appcompat/widget/z0;->m(I)Ljava/lang/String;
    ...
    invoke-virtual {v4, v12, v11}, Landroidx/appcompat/widget/z0;->f(II)I

    move-result v18

    if-nez v18, :cond_16

    iget-object v11, v0, Landroidx/appcompat/widget/z;->a:Landroid/widget/TextView;
    ...
    :cond_16
    :goto_8
    invoke-virtual {v0, v10, v4}, Landroidx/appcompat/widget/z;->m(Landroid/content/Context;Landroidx/appcompat/widget/z0;)V
    ...
    .line 14
    :cond_1a
    iget-object v1, v0, Landroidx/appcompat/widget/z;->l:Landroid/graphics/Typeface;

    if-eqz v1, :cond_1c

    iget v3, v0, Landroidx/appcompat/widget/z;->k:I

    const/4 v4, -0x1

    if-ne v3, v4, :cond_1b

    iget-object v3, v0, Landroidx/appcompat/widget/z;->a:Landroid/widget/TextView;

    iget v4, v0, Landroidx/appcompat/widget/z;->j:I
    ...
    :goto_b
    iget-object v11, v0, Landroidx/appcompat/widget/z;->i:Landroidx/appcompat/widget/c0;

    .line 15
    iget-object v1, v11, Landroidx/appcompat/widget/c0;->j:Landroid/content/Context;

    sget-object v3, Lc/b;->i:[I
    ...
    iget-object v1, v11, Landroidx/appcompat/widget/c0;->i:Landroid/widget/TextView;
    ...
    iput v2, v11, Landroidx/appcompat/widget/c0;->a:I
    ...
    :cond_24
    invoke-virtual {v11, v7}, Landroidx/appcompat/widget/c0;->b([I)[I

    move-result-object v6

    iput-object v6, v11, Landroidx/appcompat/widget/c0;->f:[I

    invoke-virtual {v11}, Landroidx/appcompat/widget/c0;->h()Z
    ...
    invoke-virtual {v11}, Landroidx/appcompat/widget/c0;->i()Z

    move-result v5

    if-eqz v5, :cond_2b

    iget v5, v11, Landroidx/appcompat/widget/c0;->a:I

    if-ne v5, v9, :cond_2c

    iget-boolean v5, v11, Landroidx/appcompat/widget/c0;->g:Z

    if-nez v5, :cond_2a

    iget-object v5, v11, Landroidx/appcompat/widget/c0;->j:Landroid/content/Context;
    ...
    :cond_29
    invoke-virtual {v11, v3, v4, v1}, Landroidx/appcompat/widget/c0;->j(FFF)V

    :cond_2a
    invoke-virtual {v11}, Landroidx/appcompat/widget/c0;->g()Z
    ...
    iput v1, v11, Landroidx/appcompat/widget/c0;->a:I
    ...
    iget-object v1, v0, Landroidx/appcompat/widget/z;->i:Landroidx/appcompat/widget/c0;

    .line 19
    iget v3, v1, Landroidx/appcompat/widget/c0;->a:I

    if-eqz v3, :cond_2e

    .line 20
    iget-object v1, v1, Landroidx/appcompat/widget/c0;->f:[I
    ...
    iget-object v2, v0, Landroidx/appcompat/widget/z;->i:Landroidx/appcompat/widget/c0;

    .line 22
    iget v2, v2, Landroidx/appcompat/widget/c0;->d:F
    ...
    .line 23
    iget-object v3, v0, Landroidx/appcompat/widget/z;->i:Landroidx/appcompat/widget/c0;

    .line 24
    iget v3, v3, Landroidx/appcompat/widget/c0;->e:F
    ...
    .line 25
    iget-object v4, v0, Landroidx/appcompat/widget/z;->i:Landroidx/appcompat/widget/c0;

    .line 26
    iget v4, v4, Landroidx/appcompat/widget/c0;->c:F
    ...
    iget-object v2, v0, Landroidx/appcompat/widget/z;->a:Landroid/widget/TextView;

    invoke-virtual {v2, v1, v5}, Landroid/widget/TextView;->setAutoSizeTextTypeUniformWithPresetSizes([II)V

    :cond_2e
    :goto_11
    sget-object v1, Lc/b;->i:[I
    ...
    iget-object v8, v0, Landroidx/appcompat/widget/z;->a:Landroid/widget/TextView;
    ...
    :cond_3c
    :goto_1c
    iget-object v4, v0, Landroidx/appcompat/widget/z;->a:Landroid/widget/TextView;
    ...
    :cond_46
    instance-of v4, v2, Lj0/h;

    if-eqz v4, :cond_47

    check-cast v2, Lj0/h;

    invoke-interface {v2, v3}, Lj0/h;->setSupportCompoundDrawablesTintList(Landroid/content/res/ColorStateList;)V
    ...
    .line 49
    invoke-static {v2, v3}, Landroidx/appcompat/widget/g0;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_48
    instance-of v4, v3, Lj0/h;

    if-eqz v4, :cond_49

    check-cast v3, Lj0/h;

    invoke-interface {v3, v2}, Lj0/h;->setSupportCompoundDrawablesTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {v1, v2}, Lj0/f;->b(Landroid/widget/TextView;I)V
    ...
    invoke-static {v1, v4}, Lj0/f;->c(Landroid/widget/TextView;I)V
    ...
    invoke-static {v1, v5}, Lj0/f;->d(Landroid/widget/TextView;I)V
...
.method public f(Landroid/content/Context;I)V
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/z;->a:Landroid/widget/TextView;
    ...
    :cond_4
    invoke-virtual {p0, p1, v1}, Landroidx/appcompat/widget/z;->m(Landroid/content/Context;Landroidx/appcompat/widget/z0;)V
...
.method public h(IIII)V
    ...
    iget-object v1, v0, Landroidx/appcompat/widget/c0;->j:Landroid/content/Context;
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroidx/appcompat/widget/c0;->j(FFF)V

    invoke-virtual {v0}, Landroidx/appcompat/widget/c0;->g()Z
...
.method public i([II)V
    ...
    :cond_0
    iget-object v4, v0, Landroidx/appcompat/widget/c0;->j:Landroid/content/Context;
    ...
    :cond_1
    :goto_1
    invoke-virtual {v0, v3}, Landroidx/appcompat/widget/c0;->b([I)[I

    move-result-object p2

    iput-object p2, v0, Landroidx/appcompat/widget/c0;->f:[I

    invoke-virtual {v0}, Landroidx/appcompat/widget/c0;->h()Z
    ...
    :cond_3
    iput-boolean v2, v0, Landroidx/appcompat/widget/c0;->g:Z
...
.method public j(I)V
    ...
    iget-object p1, v0, Landroidx/appcompat/widget/c0;->j:Landroid/content/Context;
    ...
    invoke-virtual {v0, v1, p1, v2}, Landroidx/appcompat/widget/c0;->j(FFF)V
    ...
    iput v1, v0, Landroidx/appcompat/widget/c0;->d:F

    iput v1, v0, Landroidx/appcompat/widget/c0;->e:F

    iput v1, v0, Landroidx/appcompat/widget/c0;->c:F

    new-array v1, p1, [I

    iput-object v1, v0, Landroidx/appcompat/widget/c0;->f:[I

    iput-boolean p1, v0, Landroidx/appcompat/widget/c0;->b:Z
...
.method public k(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/z;->h:Landroidx/appcompat/widget/x0;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/z;->h:Landroidx/appcompat/widget/x0;
    ...
    .line 1
    iput-object v0, p0, Landroidx/appcompat/widget/z;->b:Landroidx/appcompat/widget/x0;

    iput-object v0, p0, Landroidx/appcompat/widget/z;->c:Landroidx/appcompat/widget/x0;

    iput-object v0, p0, Landroidx/appcompat/widget/z;->d:Landroidx/appcompat/widget/x0;

    iput-object v0, p0, Landroidx/appcompat/widget/z;->e:Landroidx/appcompat/widget/x0;

    iput-object v0, p0, Landroidx/appcompat/widget/z;->f:Landroidx/appcompat/widget/x0;

    iput-object v0, p0, Landroidx/appcompat/widget/z;->g:Landroidx/appcompat/widget/x0;
...
.method public final m(Landroid/content/Context;Landroidx/appcompat/widget/z0;)V
    ...
    invoke-virtual {p2, v5, v4}, Landroidx/appcompat/widget/z0;->j(II)I
    ...
    iput-boolean v2, p0, Landroidx/appcompat/widget/z;->m:Z
    ...
    invoke-direct {v9, p0, v6, v7, p1}, Landroidx/appcompat/widget/z$a;-><init>(Landroidx/appcompat/widget/z;IILjava/lang/ref/WeakReference;)V

    :try_start_0
    iget p1, p0, Landroidx/appcompat/widget/z;->j:I

    invoke-virtual {p2, v5, p1, v9}, Landroidx/appcompat/widget/z0;->i(IILy/e$a;)Landroid/graphics/Typeface;
