...
.method public final a(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    .line 4
    iget-object v7, v2, Ld/v;->i:Ld/v$d;

    if-eqz v7, :cond_1

    invoke-virtual {v7}, Ld/v$d;->c()V

    :cond_1
    iget-object v7, v2, Ld/v;->c:Landroidx/appcompat/widget/ActionBarOverlayLayout;
    ...
    new-instance v7, Ld/v$d;

    iget-object v8, v2, Ld/v;->f:Landroidx/appcompat/widget/ActionBarContextView;

    invoke-virtual {v8}, Landroid/view/ViewGroup;->getContext()Landroid/content/Context;

    move-result-object v8

    invoke-direct {v7, v2, v8, v1}, Ld/v$d;-><init>(Ld/v;Landroid/content/Context;Lh/a$a;)V

    .line 5
    iget-object v8, v7, Ld/v$d;->e:Landroidx/appcompat/view/menu/e;

    invoke-virtual {v8}, Landroidx/appcompat/view/menu/e;->y()V

    :try_start_0
    iget-object v8, v7, Ld/v$d;->f:Lh/a$a;

    iget-object v9, v7, Ld/v$d;->e:Landroidx/appcompat/view/menu/e;

    invoke-interface {v8, v7, v9}, Lh/a$a;->d(Lh/a;Landroid/view/Menu;)Z
    ...
    .line 6
    iput-object v7, v2, Ld/v;->i:Ld/v$d;

    invoke-virtual {v7}, Ld/v$d;->i()V

    iget-object v8, v2, Ld/v;->f:Landroidx/appcompat/widget/ActionBarContextView;

    invoke-virtual {v8, v7}, Landroidx/appcompat/widget/ActionBarContextView;->f(Lh/a;)V

    invoke-virtual {v2, v4}, Ld/v;->d(Z)V

    iget-object v2, v2, Ld/v;->f:Landroidx/appcompat/widget/ActionBarContextView;
    ...
    invoke-interface {v2, v7}, Ld/i;->e(Lh/a;)V
    ...
    .line 8
    iget-object v0, v7, Ld/v$d;->e:Landroidx/appcompat/view/menu/e;
    ...
    iget-object v9, p1, Ld/k;->e:Landroid/content/Context;

    invoke-direct {v7, v9, v5}, Lh/c;-><init>(Landroid/content/Context;I)V

    invoke-virtual {v7}, Lh/c;->getTheme()Landroid/content/res/Resources$Theme;
    ...
    .line 12
    iput-object v8, p1, Ld/k;->p:Landroidx/appcompat/widget/ActionBarContextView;
    ...
    iput-object v8, p1, Ld/k;->q:Landroid/widget/PopupWindow;

    const/4 v9, 0x2

    invoke-static {v8, v9}, Lj0/e;->b(Landroid/widget/PopupWindow;I)V

    iget-object v8, p1, Ld/k;->q:Landroid/widget/PopupWindow;

    iget-object v9, p1, Ld/k;->p:Landroidx/appcompat/widget/ActionBarContextView;
    ...
    iget-object v7, p1, Ld/k;->i:Ld/a;

    if-eqz v7, :cond_9

    .line 14
    invoke-virtual {v7}, Ld/a;->b()Landroid/content/Context;
    ...
    iget-object v9, p1, Ld/k;->q:Landroid/widget/PopupWindow;
    ...
    :goto_6
    invoke-direct {v2, v7, v8, v1, v4}, Lh/d;-><init>(Landroid/content/Context;Landroidx/appcompat/widget/ActionBarContextView;Lh/a$a;Z)V

    .line 16
    iget-object v4, v2, Lh/d;->i:Landroidx/appcompat/view/menu/e;

    .line 17
    invoke-virtual {v1, v2, v4}, Ld/k$c;->d(Lh/a;Landroid/view/Menu;)Z
    ...
    invoke-virtual {v1, v2}, Lg0/q;->a(F)Lg0/q;

    iput-object v1, p1, Ld/k;->s:Lg0/q;
    ...
    .line 18
    iget-object v3, v1, Lg0/q;->a:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {v1, v3, v2}, Lg0/q;->e(Landroid/view/View;Lg0/r;)V
