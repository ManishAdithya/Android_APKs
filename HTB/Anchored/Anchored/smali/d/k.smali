...
.method public constructor <init>(Landroid/content/Context;Landroid/view/Window;Ld/i;Ljava/lang/Object;)V
    ...
    iput-object v0, p0, Ld/k;->s:Lg0/q;
...
.method public final A(Z)Z
    ...
    invoke-direct {v11, p1}, Lw/a;-><init>(Landroid/app/Activity;)V
    ...
    invoke-interface {v2}, Landroidx/lifecycle/g;->a()Landroidx/lifecycle/d;
    ...
    .line 12
    iget-object v2, v2, Landroidx/lifecycle/h;->b:Landroidx/lifecycle/d$c;
...
.method public D(Landroidx/appcompat/view/menu/e;)V
    ...
    iget-object v0, p0, Ld/k;->l:Landroidx/appcompat/widget/e0;

    invoke-interface {v0}, Landroidx/appcompat/widget/e0;->j()V
...
.method public G(Landroid/view/KeyEvent;)Z
    ...
    iget-object v1, p0, Ld/k;->l:Landroidx/appcompat/widget/e0;

    if-eqz v1, :cond_c

    invoke-interface {v1}, Landroidx/appcompat/widget/e0;->f()Z
    ...
    invoke-interface {v1}, Landroidx/appcompat/widget/e0;->e()Z
    ...
    iget-object p1, p0, Ld/k;->l:Landroidx/appcompat/widget/e0;

    invoke-interface {p1}, Landroidx/appcompat/widget/e0;->a()Z
    ...
    .line 10
    iget-object v0, p1, Ld/v;->e:Landroidx/appcompat/widget/f0;

    if-eqz v0, :cond_15

    invoke-interface {v0}, Landroidx/appcompat/widget/f0;->m()Z

    move-result v0

    if-eqz v0, :cond_15

    iget-object p1, p1, Ld/v;->e:Landroidx/appcompat/widget/f0;

    invoke-interface {p1}, Landroidx/appcompat/widget/f0;->collapseActionView()V
...
.method public I()V
    ...
    iget-object v0, p0, Ld/k;->s:Lg0/q;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lg0/q;->b()V
...
.method public final J()V
    ...
    iput-object v1, p0, Ld/k;->l:Landroidx/appcompat/widget/e0;
    ...
    .line 2
    invoke-static {v0, v1}, Lg0/o$b;->d(Landroid/view/View;Lg0/k;)V
    ...
    .line 11
    iget-object v1, v1, Ld/v;->e:Landroidx/appcompat/widget/f0;
...
.method public final T(Ld/k$i;ILandroid/view/KeyEvent;I)Z
    ...
    iget-object p3, p0, Ld/k;->l:Landroidx/appcompat/widget/e0;
...
.method public final U(Ld/k$i;Landroid/view/KeyEvent;)Z
    ...
    iget-object v5, p0, Ld/k;->l:Landroidx/appcompat/widget/e0;

    if-eqz v5, :cond_6

    invoke-interface {v5}, Landroidx/appcompat/widget/e0;->d()V
    ...
    :cond_8
    iget-object v4, p0, Ld/k;->l:Landroidx/appcompat/widget/e0;
    ...
    invoke-interface {v4, v5, v7}, Landroidx/appcompat/widget/e0;->b(Landroid/view/Menu;Landroidx/appcompat/view/menu/i$a;)V
    ...
    invoke-interface {p1, v6, p2}, Landroidx/appcompat/widget/e0;->b(Landroid/view/Menu;Landroidx/appcompat/view/menu/i$a;)V
    ...
    iget-object p2, p0, Ld/k;->l:Landroidx/appcompat/widget/e0;

    if-eqz p2, :cond_14

    iget-object v0, p0, Ld/k;->m:Ld/k$b;

    invoke-interface {p2, v6, v0}, Landroidx/appcompat/widget/e0;->b(Landroid/view/Menu;Landroidx/appcompat/view/menu/i$a;)V
...
.method public final X(Lg0/u;Landroid/graphics/Rect;)I
    .locals 10
    ...
    invoke-static {v6}, Lg0/o$c;->a(Landroid/view/View;)Lg0/u;
    ...
    :cond_1
    invoke-static {v6}, Lg0/o$b;->c(Landroid/view/View;)Lg0/u;
    ...
    :goto_8
    invoke-static {v4, v6}, Lx/a;->a(Landroid/content/Context;I)I
...
.method public a(Landroidx/appcompat/view/menu/e;)V
    ...
    invoke-interface {p1}, Landroidx/appcompat/widget/e0;->c()Z
    ...
    iget-object v2, p0, Ld/k;->l:Landroidx/appcompat/widget/e0;

    invoke-interface {v2}, Landroidx/appcompat/widget/e0;->e()Z
...
.method public d(Landroid/content/Context;)Landroid/content/Context;
    ...
    .line 18
    sget-object v4, Ly/f;->a:Ljava/lang/Object;

    monitor-enter v4

    :try_start_3
    sget-boolean v5, Ly/f;->c:Z
    :try_end_3
    ...
    sput-object v5, Ly/f;->b:Ljava/lang/reflect/Method;
    ...
    :goto_4
    sput-boolean v0, Ly/f;->c:Z

    :cond_1f
    sget-object v0, Ly/f;->b:Ljava/lang/reflect/Method;
    :try_end_5
    ...
    sput-object v3, Ly/f;->b:Ljava/lang/reflect/Method;
...
.method public final onCreateView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 9
    invoke-direct {v1, v2, p4, v0}, Landroidx/appcompat/widget/n;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v1, v2, p4}, Landroidx/appcompat/widget/d0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    goto :goto_6

    .line 11
    :pswitch_6
    invoke-virtual {p1, v2, p4}, Ld/q;->d(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/r;
    ...
    .line 16
    :pswitch_a
    invoke-virtual {p1, v2, p4}, Ld/q;->e(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/b0;
    ...
    invoke-direct {v1, v2, p4}, Landroidx/appcompat/widget/s;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    :goto_7
    sget-object v1, Ld/q;->d:[Ljava/lang/String;
...
.method public r()V
    ...
    .line 3
    iput-boolean v0, v1, Ld/v;->u:Z

    iget-object v0, v1, Ld/v;->t:Lh/h;
...
.method public final y(Ljava/lang/CharSequence;)V
    ...
    .line 3
    iget-object v0, v0, Ld/v;->e:Landroidx/appcompat/widget/f0;
