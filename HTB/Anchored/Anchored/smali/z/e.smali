...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lz/e;->b:Lm/f;

    return-void
.end method

.method public static a(Landroid/content/Context;Ly/c$a;Landroid/content/res/Resources;IILy/e$a;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    .locals 6

    instance-of v0, p1, Ly/c$d;
    ...
    .line 1
    iget-object v0, p1, Ly/c$d;->d:Ljava/lang/String;
    ...
    .line 3
    invoke-virtual {p5, v0, p6}, Ly/e$a;->b(Landroid/graphics/Typeface;Landroid/os/Handler;)V
    ...
    .line 6
    :goto_3
    invoke-static {p6}, Ly/e$a;->c(Landroid/os/Handler;)Landroid/os/Handler;

    move-result-object p6

    new-instance v4, Lz/e$a;

    invoke-direct {v4, p5}, Lz/e$a;-><init>(Ly/e$a;)V

    .line 7
    iget-object p1, p1, Ly/c$d;->a:Ld0/e;
    ...
    .line 31
    :cond_d
    sget-object p7, Lz/e;->a:Lz/k;

    check-cast p1, Ly/c$b;

    invoke-virtual {p7, p0, p1, p2, p4}, Lz/k;->a(Landroid/content/Context;Ly/c$b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {p5, v2, p6}, Ly/e$a;->b(Landroid/graphics/Typeface;Landroid/os/Handler;)V

    goto :goto_5

    :cond_e
    invoke-virtual {p5, v1, p6}, Ly/e$a;->a(ILandroid/os/Handler;)V

    :cond_f
    :goto_5
    if-eqz v2, :cond_10

    sget-object p0, Lz/e;->b:Lm/f;

    invoke-static {p2, p3, p4}, Lz/e;->c(Landroid/content/res/Resources;II)Ljava/lang/String;
...
.method public static b(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual/range {v0 .. v5}, Lz/k;->d(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-static {p1, p2, p4}, Lz/e;->c(Landroid/content/res/Resources;II)Ljava/lang/String;

    move-result-object p1

    sget-object p2, Lz/e;->b:Lm/f;
