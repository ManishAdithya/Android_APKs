...
.method public static f(Ljava/lang/Object;Ljava/lang/String;IZ)Z
    ...
    invoke-static {}, Lz/f;->g()V

    :try_start_0
    sget-object v0, Lz/f;->d:Ljava/lang/reflect/Method;
...
.method public static g()V
    ...
    :goto_1
    sput-object v1, Lz/f;->c:Ljava/lang/reflect/Constructor;

    sput-object v2, Lz/f;->b:Ljava/lang/Class;

    sput-object v5, Lz/f;->d:Ljava/lang/reflect/Method;

    sput-object v0, Lz/f;->e:Ljava/lang/reflect/Method;
...
.method public a(Landroid/content/Context;Ly/c$b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    :try_start_0
    sget-object p4, Lz/f;->c:Ljava/lang/reflect/Constructor;
    ...
    invoke-static {p1}, Lz/l;->c(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_0
    :try_start_1
    iget v6, v4, Ly/c$c;->f:I

    .line 5
    invoke-static {v5, p3, v6}, Lz/l;->a(Ljava/io/File;Landroid/content/res/Resources;I)Z
    ...
    .line 6
    iget v7, v4, Ly/c$c;->b:I

    .line 7
    iget-boolean v4, v4, Ly/c$c;->c:Z

    .line 8
    invoke-static {p4, v6, v7, v4}, Lz/f;->f(Ljava/lang/Object;Ljava/lang/String;IZ)Z
    ...
    :try_start_3
    sget-object p1, Lz/f;->b:Ljava/lang/Class;
    ...
    sget-object p3, Lz/f;->e:Ljava/lang/reflect/Method;
...
.method public b(Landroid/content/Context;Landroid/os/CancellationSignal;[Ld0/l;I)Landroid/graphics/Typeface;
    ...
    .line 1
    :try_start_0
    iget-object p3, p3, Ld0/l;->a:Landroid/net/Uri;
    ...
    :try_start_5
    invoke-virtual {p0, p1, p3}, Lz/k;->c(Landroid/content/Context;Ljava/io/InputStream;)Landroid/graphics/Typeface;
