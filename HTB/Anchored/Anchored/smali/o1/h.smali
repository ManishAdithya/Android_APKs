...
.method public constructor <init>(Ljava/lang/CharSequence;Landroid/text/TextPaint;I)V
    ...
    iput-object p1, p0, Lo1/h;->a:Ljava/lang/CharSequence;

    iput-object p2, p0, Lo1/h;->b:Landroid/text/TextPaint;
    ...
    iput p1, p0, Lo1/h;->d:I

    sget-object p1, Landroid/text/Layout$Alignment;->ALIGN_NORMAL:Landroid/text/Layout$Alignment;

    iput-object p1, p0, Lo1/h;->e:Landroid/text/Layout$Alignment;
    ...
    iput p1, p0, Lo1/h;->g:F

    const/high16 p1, 0x3f800000    # 1.0f

    iput p1, p0, Lo1/h;->h:F
    ...
    iput-boolean p1, p0, Lo1/h;->j:Z

    const/4 p1, 0x0

    iput-object p1, p0, Lo1/h;->l:Landroid/text/TextUtils$TruncateAt;
...
.method public a()Landroid/text/StaticLayout;
    ...
    iget-object v0, v1, Lo1/h;->a:Ljava/lang/CharSequence;

    if-nez v0, :cond_0

    const-string v0, ""

    iput-object v0, v1, Lo1/h;->a:Ljava/lang/CharSequence;

    :cond_0
    iget v0, v1, Lo1/h;->c:I
    ...
    iget-object v3, v1, Lo1/h;->a:Ljava/lang/CharSequence;

    iget v4, v1, Lo1/h;->f:I

    const/4 v5, 0x1

    if-ne v4, v5, :cond_1

    iget-object v4, v1, Lo1/h;->b:Landroid/text/TextPaint;

    int-to-float v6, v0

    iget-object v7, v1, Lo1/h;->l:Landroid/text/TextUtils$TruncateAt;
    ...
    iget v6, v1, Lo1/h;->d:I

    invoke-static {v4, v6}, Ljava/lang/Math;->min(II)I

    move-result v4

    iput v4, v1, Lo1/h;->d:I
    ...
    iput-object v6, v1, Lo1/h;->e:Landroid/text/Layout$Alignment;

    :cond_2
    iget-object v6, v1, Lo1/h;->b:Landroid/text/TextPaint;
    ...
    iget-object v2, v1, Lo1/h;->e:Landroid/text/Layout$Alignment;
    ...
    iget-object v2, v1, Lo1/h;->l:Landroid/text/TextUtils$TruncateAt;
    ...
    :goto_2
    sput-object v4, Lo1/h;->p:Ljava/lang/Object;
    ...
    sput-object v4, Lo1/h;->o:Ljava/lang/reflect/Constructor;

    invoke-virtual {v4, v5}, Ljava/lang/reflect/Constructor;->setAccessible(Z)V

    sput-boolean v5, Lo1/h;->n:Z
    :try_end_0
    ...
    :goto_3
    :try_start_1
    sget-object v4, Lo1/h;->o:Ljava/lang/reflect/Constructor;
    ...
    iget-object v2, v1, Lo1/h;->b:Landroid/text/TextPaint;
    ...
    sget-object v2, Lo1/h;->p:Ljava/lang/Object;
    ...
    invoke-direct {v2, v0}, Lo1/h$a;-><init>(Ljava/lang/Throwable;)V
