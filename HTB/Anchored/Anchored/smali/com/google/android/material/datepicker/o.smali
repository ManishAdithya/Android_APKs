...
.method public static j0(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, v1, v0}, Lq1/b;->c(Landroid/content/Context;ILjava/lang/String;)I
...
.method public final H(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-static {p2, p3}, Lg0/o;->t(Landroid/view/View;Lg0/a;)V
...
.method public N()V
    ...
    iget-object v1, p0, Lcom/google/android/material/datepicker/o;->x0:Lt1/f;
    ...
    iget-object v4, p0, Lcom/google/android/material/datepicker/o;->x0:Lt1/f;
    ...
    invoke-direct {v2, v3, v1}, Lj1/a;-><init>(Landroid/app/Dialog;Landroid/graphics/Rect;)V
...
.method public final f0(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    invoke-static {v0, v1, v2}, Lq1/b;->c(Landroid/content/Context;ILjava/lang/String;)I
    ...
    .line 3
    invoke-static {v0, v3, v4, v5}, Lt1/i;->b(Landroid/content/Context;Landroid/util/AttributeSet;II)Lt1/i$b;

    move-result-object v3

    invoke-virtual {v3}, Lt1/i$b;->a()Lt1/i;
    ...
    .line 4
    iput-object v2, p0, Lcom/google/android/material/datepicker/o;->x0:Lt1/f;

    .line 5
    iget-object v3, v2, Lt1/f;->b:Lt1/f$b;

    new-instance v4, Ll1/a;

    invoke-direct {v4, v0}, Ll1/a;-><init>(Landroid/content/Context;)V

    iput-object v4, v3, Lt1/f$b;->b:Ll1/a;

    invoke-virtual {v2}, Lt1/f;->w()V

    .line 6
    iget-object v0, p0, Lcom/google/android/material/datepicker/o;->x0:Lt1/f;
