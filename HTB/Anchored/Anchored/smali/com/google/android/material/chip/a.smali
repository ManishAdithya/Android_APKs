...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 1
    invoke-static {p1, p2, p3, p4}, Lt1/i;->b(Landroid/content/Context;Landroid/util/AttributeSet;II)Lt1/i$b;
    ...
    invoke-direct {p0, p2}, Lt1/f;-><init>(Lt1/i;)V
    ...
    .line 3
    iget-object p2, p0, Lt1/f;->b:Lt1/f$b;

    new-instance p4, Ll1/a;

    invoke-direct {p4, p1}, Ll1/a;-><init>(Landroid/content/Context;)V

    iput-object p4, p2, Lt1/f$b;->b:Ll1/a;
    ...
    invoke-direct {p2, p0}, Lo1/i;-><init>(Lo1/i$b;)V

    iput-object p2, p0, Lcom/google/android/material/chip/a;->m0:Lo1/i;
    ...
    .line 5
    iget-object p2, p2, Lo1/i;->a:Landroid/text/TextPaint;
...
.method public final J([I[I)Z
    ...
    invoke-super {p0, p1}, Lt1/f;->onStateChange([I)Z
    ...
    :goto_0
    invoke-virtual {p0, v1}, Lt1/f;->e(I)I
    ...
    :goto_1
    invoke-virtual {p0, v3}, Lt1/f;->e(I)I
    ...
    .line 3
    :goto_2
    iget-object v5, p0, Lt1/f;->b:Lt1/f$b;

    iget-object v5, v5, Lt1/f$b;->d:Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, v0}, Lt1/f;->p(Landroid/content/res/ColorStateList;)V
    ...
    :cond_a
    iget-object v1, p0, Lcom/google/android/material/chip/a;->m0:Lo1/i;

    .line 5
    iget-object v1, v1, Lo1/i;->f:Lq1/f;

    if-eqz v1, :cond_b

    .line 6
    iget-object v1, v1, Lq1/f;->a:Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v0, v3}, Lk1/a;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public P(F)V
    ...
    .line 2
    invoke-virtual {v0, p1}, Lt1/i;->e(F)Lt1/i;
...
.method public Z(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 3
    invoke-static {v2}, Lr1/a;->a(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-super/range {p0 .. p1}, Lt1/f;->draw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v6, v0, v1}, Lt1/f;->c(Landroid/graphics/RectF;Landroid/graphics/Path;)V

    iget-object v2, v6, Lcom/google/android/material/chip/a;->h0:Landroid/graphics/Paint;

    iget-object v3, v6, Lcom/google/android/material/chip/a;->l0:Landroid/graphics/Path;

    invoke-virtual/range {p0 .. p0}, Lt1/f;->h()Landroid/graphics/RectF;

    move-result-object v9

    .line 13
    iget-object v0, v6, Lt1/f;->b:Lt1/f$b;

    iget-object v10, v0, Lt1/f$b;->a:Lt1/i;
    ...
    invoke-virtual/range {v0 .. v5}, Lt1/f;->g(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/Path;Lt1/i;Landroid/graphics/RectF;)V
    ...
    .line 19
    iget-object v3, v6, Lcom/google/android/material/chip/a;->m0:Lo1/i;

    .line 20
    iget-object v3, v3, Lo1/i;->a:Landroid/text/TextPaint;
    ...
    .line 25
    :cond_10
    iget-object v0, v6, Lcom/google/android/material/chip/a;->m0:Lo1/i;

    .line 26
    iget-object v2, v0, Lo1/i;->f:Lq1/f;

    if-eqz v2, :cond_11

    .line 27
    iget-object v0, v0, Lo1/i;->a:Landroid/text/TextPaint;
    ...
    .line 29
    iget-object v3, v0, Lo1/i;->f:Lq1/f;

    iget-object v4, v0, Lo1/i;->a:Landroid/text/TextPaint;

    iget-object v0, v0, Lo1/i;->b:Landroidx/activity/result/d;

    invoke-virtual {v3, v2, v4, v0}, Lq1/f;->e(Landroid/content/Context;Landroid/text/TextPaint;Landroidx/activity/result/d;)V
    ...
    invoke-virtual {v0, v1}, Lo1/i;->a(Ljava/lang/String;)F
    ...
    iget-object v4, v6, Lcom/google/android/material/chip/a;->m0:Lo1/i;

    .line 37
    iget-object v4, v4, Lo1/i;->a:Landroid/text/TextPaint;
...
.method public getIntrinsicWidth()I
    ...
    iget-object v0, p0, Lcom/google/android/material/chip/a;->m0:Lo1/i;
    ...
    invoke-virtual {v0, v2}, Lo1/i;->a(Ljava/lang/String;)F
...
.method public getOutline(Landroid/graphics/Outline;)V
    ...
    invoke-super {p0, p1}, Lt1/f;->getOutline(Landroid/graphics/Outline;)V
...
.method public isStateful()Z
    ...
    .line 2
    iget-object v0, v0, Lq1/f;->a:Landroid/content/res/ColorStateList;
...
.method public j0(Ljava/lang/CharSequence;)V
    ...
    iget-object p1, p0, Lcom/google/android/material/chip/a;->m0:Lo1/i;
...
.method public k0(Lq1/f;)V
    ...
    iput-object p1, v0, Lo1/i;->f:Lq1/f;

    if-eqz p1, :cond_1

    iget-object v2, v0, Lo1/i;->a:Landroid/text/TextPaint;

    iget-object v3, v0, Lo1/i;->b:Landroidx/activity/result/d;

    invoke-virtual {p1, v1, v2, v3}, Lq1/f;->f(Landroid/content/Context;Landroid/text/TextPaint;Landroidx/activity/result/d;)V

    iget-object v2, v0, Lo1/i;->e:Ljava/lang/ref/WeakReference;

    invoke-virtual {v2}, Ljava/lang/ref/WeakReference;->get()Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lo1/i$b;

    if-eqz v2, :cond_0

    iget-object v3, v0, Lo1/i;->a:Landroid/text/TextPaint;

    invoke-interface {v2}, Lo1/i$b;->getState()[I
    ...
    invoke-virtual {p1, v1, v2, v3}, Lq1/f;->e(Landroid/content/Context;Landroid/text/TextPaint;Landroidx/activity/result/d;)V

    const/4 p1, 0x1

    iput-boolean p1, v0, Lo1/i;->d:Z

    :cond_1
    iget-object p1, v0, Lo1/i;->e:Ljava/lang/ref/WeakReference;
    ...
    invoke-interface {p1}, Lo1/i$b;->getState()[I

    move-result-object v0

    invoke-interface {p1, v0}, Lo1/i$b;->onStateChange([I)Z
...
.method public setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p0, v0, p1}, Lk1/a;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
