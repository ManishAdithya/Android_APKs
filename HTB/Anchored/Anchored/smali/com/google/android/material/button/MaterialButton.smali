...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 1
    invoke-static {p1, p2, v1, v0}, Lx1/a;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;
    ...
    invoke-static/range {v2 .. v7}, Lo1/k;->d(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroid/content/res/TypedArray;
    ...
    invoke-static {v3, v5}, Lo1/n;->b(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v3, v2, v5}, Lq1/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v3, v2, v5}, Lq1/c;->c(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v8, p2, v1, v0}, Lt1/i;->b(Landroid/content/Context;Landroid/util/AttributeSet;II)Lt1/i$b;

    move-result-object p2

    invoke-virtual {p2}, Lt1/i$b;->a()Lt1/i;

    move-result-object p2

    new-instance v0, Ld1/a;

    invoke-direct {v0, p0, p2}, Ld1/a;-><init>(Lcom/google/android/material/button/MaterialButton;Lt1/i;)V

    iput-object v0, p0, Lcom/google/android/material/button/MaterialButton;->d:Ld1/a;
    ...
    iput p2, v0, Ld1/a;->g:I

    iget-object v1, v0, Ld1/a;->b:Lt1/i;

    int-to-float p2, p2

    invoke-virtual {v1, p2}, Lt1/i;->e(F)Lt1/i;

    move-result-object p2

    invoke-virtual {v0, p2}, Ld1/a;->e(Lt1/i;)V

    iput-boolean v5, v0, Ld1/a;->p:Z
    ...
    invoke-static {p2, v1}, Lo1/n;->b(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p2

    iput-object p2, v0, Ld1/a;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {p2, v2, v1}, Lq1/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object p2

    iput-object p2, v0, Ld1/a;->j:Landroid/content/res/ColorStateList;
    ...
    iput-object p2, v0, Ld1/a;->k:Landroid/content/res/ColorStateList;
    ...
    iput-object p2, v0, Ld1/a;->l:Landroid/content/res/ColorStateList;
    ...
    .line 7
    iput-boolean v5, v0, Ld1/a;->o:Z

    iget-object v6, v0, Ld1/a;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v6, v0, Ld1/a;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    :goto_0
    iget v6, v0, Ld1/a;->c:I

    add-int/2addr p2, v6

    iget v6, v0, Ld1/a;->e:I
    ...
    iget v0, v0, Ld1/a;->f:I

    add-int/2addr v4, v0

    .line 9
    invoke-virtual {p0, p2, v1, v3, v4}, Landroid/view/View;->setPaddingRelative(IIII)V
...
.method public a()Z
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->d:Ld1/a;

    if-eqz v0, :cond_0

    .line 1
    iget-boolean v0, v0, Ld1/a;->q:Z
...
.method public getRippleColor()Landroid/content/res/ColorStateList;
    ...
    .line 1
    iget-object v0, v0, Ld1/a;->l:Landroid/content/res/ColorStateList;
...
.method public getShapeAppearanceModel()Lt1/i;
    .locals 2
    ...
    .line 1
    iget-object v0, v0, Ld1/a;->b:Lt1/i;
...
.method public getStrokeColor()Landroid/content/res/ColorStateList;
    ...
    .line 1
    iget-object v0, v0, Ld1/a;->k:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    .line 1
    iget-object v0, v0, Ld1/a;->j:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    .line 1
    iget-object v0, v0, Ld1/a;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public onAttachedToWindow()V
    ...
    invoke-virtual {v0}, Ld1/a;->b()Lt1/f;

    move-result-object v0

    invoke-static {p0, v0}, Landroidx/savedstate/d;->j(Landroid/view/View;Lt1/f;)V
...
.method public onLayout(ZIIII)V
    ...
    iget-object p1, p0, Lcom/google/android/material/button/MaterialButton;->d:Ld1/a;
    ...
    .line 1
    iget-object p2, p1, Ld1/a;->m:Landroid/graphics/drawable/Drawable;

    if-eqz p2, :cond_0

    iget p3, p1, Ld1/a;->c:I

    iget v0, p1, Ld1/a;->e:I

    iget v1, p1, Ld1/a;->d:I

    sub-int/2addr p4, v1

    iget p1, p1, Ld1/a;->f:I
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 1
    iput-boolean v1, v0, Ld1/a;->o:Z

    iget-object v1, v0, Ld1/a;->a:Lcom/google/android/material/button/MaterialButton;

    iget-object v2, v0, Ld1/a;->j:Landroid/content/res/ColorStateList;
...
.method public setCornerRadius(I)V
    ...
    .line 1
    iget-boolean v1, v0, Ld1/a;->p:Z

    if-eqz v1, :cond_0

    iget v1, v0, Ld1/a;->g:I

    if-eq v1, p1, :cond_1

    :cond_0
    iput p1, v0, Ld1/a;->g:I

    const/4 v1, 0x1

    iput-boolean v1, v0, Ld1/a;->p:Z

    iget-object v1, v0, Ld1/a;->b:Lt1/i;

    int-to-float p1, p1

    invoke-virtual {v1, p1}, Lt1/i;->e(F)Lt1/i;

    move-result-object p1

    invoke-virtual {v0, p1}, Ld1/a;->e(Lt1/i;)V
...
.method public setElevation(F)V
    ...
    iget v2, v1, Lt1/f$b;->o:F

    cmpl-float v2, v2, p1

    if-eqz v2, :cond_0

    iput p1, v1, Lt1/f$b;->o:F

    invoke-virtual {v0}, Lt1/f;->w()V
...
.method public setInsetBottom(I)V
    ...
    .line 1
    iget v1, v0, Ld1/a;->e:I

    invoke-virtual {v0, v1, p1}, Ld1/a;->f(II)V
...
.method public setInsetTop(I)V
    ...
    .line 1
    iget v1, v0, Ld1/a;->f:I

    invoke-virtual {v0, p1, v1}, Ld1/a;->f(II)V
...
.method public setRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    .line 1
    iget-object v1, v0, Ld1/a;->l:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Ld1/a;->l:Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Ld1/a;->a:Lcom/google/android/material/button/MaterialButton;
    ...
    invoke-static {p1}, Lr1/a;->a(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method public setShouldDrawSurfaceColorStroke(Z)V
    ...
    .line 1
    iput-boolean p1, v0, Ld1/a;->n:Z

    invoke-virtual {v0}, Ld1/a;->h()V
...
.method public setStrokeColor(Landroid/content/res/ColorStateList;)V
    ...
    .line 1
    iget-object v1, v0, Ld1/a;->k:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Ld1/a;->k:Landroid/content/res/ColorStateList;
...
.method public setStrokeWidth(I)V
    ...
    .line 1
    iget v1, v0, Ld1/a;->h:I

    if-eq v1, p1, :cond_0

    iput p1, v0, Ld1/a;->h:I
...
.method public setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    .line 1
    iget-object v1, v0, Ld1/a;->j:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_1

    iput-object p1, v0, Ld1/a;->j:Landroid/content/res/ColorStateList;
    ...
    .line 2
    invoke-virtual {p1, v0}, Lt1/f;->setTintList(Landroid/content/res/ColorStateList;)V
...
.method public setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 1
    iget-object v1, v0, Ld1/a;->i:Landroid/graphics/PorterDuff$Mode;

    if-eq v1, p1, :cond_1

    iput-object p1, v0, Ld1/a;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object p1, v0, Ld1/a;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 2
    invoke-virtual {p1, v0}, Lt1/f;->setTintMode(Landroid/graphics/PorterDuff$Mode;)V
