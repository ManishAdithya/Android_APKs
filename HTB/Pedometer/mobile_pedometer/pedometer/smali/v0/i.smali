...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lv0/i;->y:[Ljava/lang/String;
...
.method public static J(Lv0/w;Lv0/w;)Lv0/f0;
    .locals 8
    ...
    iput-boolean v1, v0, Lv0/f0;->a:Z

    iput-boolean v1, v0, Lv0/f0;->b:Z
    ...
    iget-object v6, p0, Lv0/w;->a:Ljava/util/HashMap;
    ...
    iput-object v6, v0, Lv0/f0;->e:Landroid/view/ViewGroup;

    goto :goto_0

    :cond_0
    iput v4, v0, Lv0/f0;->c:I

    iput-object v3, v0, Lv0/f0;->e:Landroid/view/ViewGroup;

    :goto_0
    if-eqz p1, :cond_1

    iget-object v6, p1, Lv0/w;->a:Ljava/util/HashMap;
    ...
    iput-object v2, v0, Lv0/f0;->f:Landroid/view/ViewGroup;

    goto :goto_1

    :cond_1
    iput v4, v0, Lv0/f0;->d:I

    iput-object v3, v0, Lv0/f0;->f:Landroid/view/ViewGroup;
    ...
    iget p0, v0, Lv0/f0;->c:I

    iget p1, v0, Lv0/f0;->d:I

    if-ne p0, p1, :cond_2

    iget-object v3, v0, Lv0/f0;->e:Landroid/view/ViewGroup;

    iget-object v4, v0, Lv0/f0;->f:Landroid/view/ViewGroup;
    ...
    :cond_4
    iget-object p0, v0, Lv0/f0;->f:Landroid/view/ViewGroup;
    ...
    :cond_5
    iget-object p0, v0, Lv0/f0;->e:Landroid/view/ViewGroup;
    ...
    iget p0, v0, Lv0/f0;->d:I

    if-nez p0, :cond_7

    :goto_2
    iput-boolean v2, v0, Lv0/f0;->b:Z
...
.method public final H(Lv0/w;)V
    ...
    iget-object p0, p1, Lv0/w;->b:Landroid/view/View;
...
.method public final I(Landroid/view/View;FF)Landroid/animation/ObjectAnimator;
    ...
    invoke-direct {p3, p0, v1, p1}, Lv0/h;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {p0, p3}, Lv0/q;->a(Lv0/p;)V
...
.method public final d(Lv0/w;)V
    ...
    invoke-virtual {p0, p1}, Lv0/i;->H(Lv0/w;)V
...
.method public final g(Lv0/w;)V
    ...
    iget-object p1, p1, Lv0/w;->b:Landroid/view/View;
...
.method public final k(Landroid/view/ViewGroup;Lv0/w;Lv0/w;)Landroid/animation/Animator;
    .locals 20
    ...
    invoke-static/range {p2 .. p3}, Lv0/i;->J(Lv0/w;Lv0/w;)Lv0/f0;

    move-result-object v4

    iget-boolean v5, v4, Lv0/f0;->a:Z

    if-eqz v5, :cond_1e

    iget-object v5, v4, Lv0/f0;->e:Landroid/view/ViewGroup;

    if-nez v5, :cond_0

    iget-object v5, v4, Lv0/f0;->f:Landroid/view/ViewGroup;

    if-eqz v5, :cond_1e

    :cond_0
    iget-boolean v5, v4, Lv0/f0;->b:Z
    ...
    :cond_1
    iget-object v1, v3, Lv0/w;->b:Landroid/view/View;
    ...
    invoke-virtual {v0, v3, v11}, Lv0/q;->n(Landroid/view/View;Z)Lv0/w;

    move-result-object v4

    invoke-virtual {v0, v3, v11}, Lv0/q;->q(Landroid/view/View;Z)Lv0/w;

    move-result-object v3

    invoke-static {v4, v3}, Lv0/i;->J(Lv0/w;Lv0/w;)Lv0/f0;

    move-result-object v3

    iget-boolean v3, v3, Lv0/f0;->a:Z
    ...
    iget-object v2, v2, Lv0/w;->a:Ljava/util/HashMap;
    ...
    :goto_1
    invoke-virtual {v0, v1, v9, v10}, Lv0/i;->I(Landroid/view/View;FF)Landroid/animation/ObjectAnimator;
    ...
    :cond_6
    iget v4, v4, Lv0/f0;->d:I

    iget v5, v0, Lv0/i;->x:I
    ...
    iget-object v3, v3, Lv0/w;->b:Landroid/view/View;
    ...
    :goto_3
    iget-object v5, v2, Lv0/w;->b:Landroid/view/View;

    const v13, 0x7f08015f
    ...
    invoke-virtual {v0, v15, v7}, Lv0/q;->q(Landroid/view/View;Z)Lv0/w;

    move-result-object v6

    invoke-virtual {v0, v15, v7}, Lv0/q;->n(Landroid/view/View;Z)Lv0/w;

    move-result-object v13

    invoke-static {v6, v13}, Lv0/i;->J(Lv0/w;Lv0/w;)Lv0/f0;

    move-result-object v6

    iget-boolean v6, v6, Lv0/f0;->a:Z
    ...
    :goto_d
    iget-object v0, v0, Lv0/w;->a:Ljava/util/HashMap;
    ...
    :goto_e
    invoke-virtual {v6, v14, v10, v0}, Lv0/i;->I(Landroid/view/View;FF)Landroid/animation/ObjectAnimator;
    ...
    invoke-direct {v2, v6, v1, v14, v5}, Lv0/d0;-><init>(Lv0/i;Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-virtual {v6, v3, v10, v0}, Lv0/i;->I(Landroid/view/View;FF)Landroid/animation/ObjectAnimator;
    ...
    invoke-direct {v2, v3, v1}, Lv0/e0;-><init>(Landroid/view/View;I)V
    ...
    :goto_10
    invoke-virtual {v6, v2}, Lv0/q;->a(Lv0/p;)V
...
.method public final bridge synthetic p()[Ljava/lang/String;
    ...
    sget-object p0, Lv0/i;->y:[Ljava/lang/String;

    return-object p0
.end method

.method public final r(Lv0/w;Lv0/w;)Z
    .locals 2
    ...
    iget-object p0, p2, Lv0/w;->a:Ljava/util/HashMap;
    ...
    iget-object v1, p1, Lv0/w;->a:Ljava/util/HashMap;
    ...
    :cond_1
    invoke-static {p1, p2}, Lv0/i;->J(Lv0/w;Lv0/w;)Lv0/f0;

    move-result-object p0

    iget-boolean p1, p0, Lv0/f0;->a:Z

    if-eqz p1, :cond_3

    iget p1, p0, Lv0/f0;->c:I

    if-eqz p1, :cond_2

    iget p0, p0, Lv0/f0;->d:I
