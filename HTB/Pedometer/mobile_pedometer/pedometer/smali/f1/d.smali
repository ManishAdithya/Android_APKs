...
.field public static final q:Lo1/e;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lf1/d;->o:Landroid/graphics/Rect;
...
.method public constructor <init>(Lcom/google/android/material/chip/Chip;Lcom/google/android/material/chip/Chip;)V
    ...
    iput-object p1, p0, Lf1/d;->n:Lcom/google/android/material/chip/Chip;
    ...
    iput-object p1, p0, Lf1/d;->e:Landroid/graphics/Rect;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lf1/d;->f:Landroid/graphics/Rect;

    const/4 p1, 0x2

    new-array p1, p1, [I

    iput-object p1, p0, Lf1/d;->g:[I
    ...
    iput p1, p0, Lf1/d;->m:I

    if-eqz p2, :cond_1

    iput-object p2, p0, Lf1/d;->i:Landroid/view/View;
    ...
    iput-object p1, p0, Lf1/d;->h:Landroid/view/accessibility/AccessibilityManager;
    ...
    invoke-static {p2, p0}, Ld0/c0;->s(Landroid/view/View;I)V
...
.method public final b(Landroid/view/View;)Ld/n0;
    ...
    iget-object p1, p0, Lf1/d;->j:Lk0/a;

    if-nez p1, :cond_0

    new-instance p1, Lk0/a;

    invoke-direct {p1, p0}, Lk0/a;-><init>(Lf1/d;)V

    iput-object p1, p0, Lf1/d;->j:Lk0/a;

    :cond_0
    iget-object p0, p0, Lf1/d;->j:Lk0/a;
...
.method public final d(Landroid/view/View;Le0/h;)V
    ...
    invoke-virtual {p2, p0}, Le0/h;->h(Ljava/lang/CharSequence;)V
...
.method public final j(I)Z
    ...
    iget-object v2, p0, Lf1/d;->n:Lcom/google/android/material/chip/Chip;
    ...
    invoke-virtual {p0, p1, v1}, Lf1/d;->q(II)V
...
.method public final k(I)Le0/h;
    ...
    invoke-direct {v1, v0}, Le0/h;-><init>(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    sget-object v3, Lf1/d;->o:Landroid/graphics/Rect;
    ...
    iput v4, v1, Le0/h;->b:I

    iget-object v5, p0, Lf1/d;->i:Landroid/view/View;

    invoke-virtual {v0, v5}, Landroid/view/accessibility/AccessibilityNodeInfo;->setParent(Landroid/view/View;)V

    invoke-virtual {p0, p1, v1}, Lf1/d;->o(ILe0/h;)V

    invoke-virtual {v1}, Le0/h;->e()Ljava/lang/CharSequence;
    ...
    :cond_1
    :goto_0
    iget-object v6, p0, Lf1/d;->e:Landroid/graphics/Rect;

    invoke-virtual {v1, v6}, Le0/h;->d(Landroid/graphics/Rect;)V
    ...
    iput p1, v1, Le0/h;->c:I

    invoke-virtual {v0, v5, p1}, Landroid/view/accessibility/AccessibilityNodeInfo;->setSource(Landroid/view/View;I)V

    iget v7, p0, Lf1/d;->k:I
    ...
    invoke-virtual {v1, v8}, Le0/h;->a(I)V
    ...
    invoke-virtual {v1, v7}, Le0/h;->a(I)V

    :goto_1
    iget v7, p0, Lf1/d;->l:I
    ...
    invoke-virtual {v1, v2}, Le0/h;->a(I)V

    :cond_5
    :goto_3
    invoke-virtual {v0, p1}, Landroid/view/accessibility/AccessibilityNodeInfo;->setFocused(Z)V

    iget-object p1, p0, Lf1/d;->g:[I

    invoke-virtual {v5, p1}, Landroid/view/View;->getLocationOnScreen([I)V

    iget-object v7, p0, Lf1/d;->d:Landroid/graphics/Rect;
    ...
    invoke-virtual {v1, v7}, Le0/h;->d(Landroid/graphics/Rect;)V

    iget v8, v1, Le0/h;->b:I
    ...
    invoke-direct {v10, v8}, Le0/h;-><init>(Landroid/view/accessibility/AccessibilityNodeInfo;)V

    iget v8, v1, Le0/h;->b:I

    :goto_4
    iget-object v11, v10, Le0/h;->a:Landroid/view/accessibility/AccessibilityNodeInfo;

    if-eq v8, v4, :cond_6

    iput v4, v10, Le0/h;->b:I
    ...
    invoke-virtual {p0, v8, v10}, Lf1/d;->o(ILe0/h;)V

    invoke-virtual {v10, v6}, Le0/h;->d(Landroid/graphics/Rect;)V
    ...
    :cond_8
    iget-object p0, p0, Lf1/d;->f:Landroid/graphics/Rect;
    ...
    iget-object p0, v1, Le0/h;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
...
.method public final m(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {v0, v3}, Lf1/d;->l(Ljava/util/ArrayList;)V

    new-instance v4, Lj/k;

    invoke-direct {v4}, Lj/k;-><init>()V
    ...
    invoke-virtual {v0, v7}, Lf1/d;->k(I)Le0/h;
    ...
    invoke-virtual {v4, v8, v7}, Lj/k;->d(ILjava/lang/Object;)V
    ...
    :cond_1
    invoke-virtual {v4, v3, v6}, Lj/k;->c(ILjava/lang/Integer;)Ljava/lang/Object;
    ...
    :goto_1
    sget-object v8, Lf1/d;->p:Lo1/e;

    sget-object v9, Lf1/d;->q:Lo1/e;

    const/4 v11, 0x1

    iget-object v12, v0, Lf1/d;->i:Landroid/view/View;
    ...
    iget v5, v0, Lf1/d;->l:I

    const-string v10, "direction must be one of {FOCUS_UP, FOCUS_DOWN, FOCUS_LEFT, FOCUS_RIGHT}."

    if-eq v5, v7, :cond_4

    invoke-virtual {v0, v5}, Lf1/d;->n(I)Le0/h;

    move-result-object v2

    invoke-virtual {v2, v11}, Le0/h;->d(Landroid/graphics/Rect;)V
    ...
    iget-object v12, v4, Lj/k;->b:[Ljava/lang/Object;
    ...
    invoke-virtual {v12, v6}, Le0/h;->d(Landroid/graphics/Rect;)V

    invoke-static {v1, v11, v6}, Lx1/e;->n0(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_f
    invoke-static {v1, v11, v2}, Lx1/e;->n0(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_10
    invoke-static {v1, v11, v6, v2}, Lx1/e;->l(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_11
    invoke-static {v1, v11, v2, v6}, Lx1/e;->l(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_12
    invoke-static {v1, v11, v6}, Lx1/e;->w0(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v13

    invoke-static {v1, v11, v6}, Lx1/e;->z0(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
    ...
    invoke-static {v1, v11, v2}, Lx1/e;->w0(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v13

    invoke-static {v1, v11, v2}, Lx1/e;->z0(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
    ...
    iget-object v11, v4, Lj/k;->b:[Ljava/lang/Object;
    ...
    invoke-direct {v2, v5, v8}, Lk0/b;-><init>(ZLo1/e;)V
    ...
    iget-object v3, v4, Lj/k;->b:[Ljava/lang/Object;
    ...
    :goto_14
    iget-object v1, v4, Lj/k;->a:[I

    aget v7, v1, v10

    :goto_15
    invoke-virtual {v0, v7}, Lf1/d;->p(I)Z
...
.method public final n(I)Le0/h;
    ...
    iget-object p1, p0, Lf1/d;->i:Landroid/view/View;
    ...
    invoke-virtual {p0, v2}, Lf1/d;->l(Ljava/util/ArrayList;)V
    ...
    iget-object v4, v1, Le0/h;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    :cond_2
    invoke-virtual {p0, p1}, Lf1/d;->k(I)Le0/h;
...
.method public final o(ILe0/h;)V
    .locals 5
    ...
    :goto_0
    invoke-virtual {p2, p1}, Le0/h;->g(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, p1}, Le0/h;->b(Le0/g;)V
    ...
    :cond_2
    invoke-virtual {p2, v1}, Le0/h;->g(Ljava/lang/CharSequence;)V
...
.method public final p(I)Z
    ...
    iget-object v1, p0, Lf1/d;->n:Lcom/google/android/material/chip/Chip;
...
.method public final q(II)V
    ...
    iget-object v0, p0, Lf1/d;->h:Landroid/view/accessibility/AccessibilityManager;
    ...
    invoke-virtual {p0}, Le0/h;->e()Ljava/lang/CharSequence;
    ...
    invoke-static {p2, v0, p1}, Le0/m;->a(Landroid/view/accessibility/AccessibilityRecord;Landroid/view/View;I)V
